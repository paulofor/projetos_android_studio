...
public abstract class ProdutoListFragmentBase extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>{
	...
	public abstract void onItemSelected(int idItemLista, ProdutoListViewHolderBase vh);
	...
	*/
	...
	protected long mIdLojaVirtual;
	public final void setIdLojaVirtual(long id) {
		mIdLojaVirtual = id;
	}
	
	protected long mIdMarca;
	public final void setIdMarca(long id) {
		mIdMarca = id;
	}
