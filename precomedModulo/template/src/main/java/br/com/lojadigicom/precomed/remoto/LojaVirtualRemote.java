...
public class LojaVirtualRemote {
    ...
    public int listaSincronizadaDao(Context contexto, boolean delete) throws JSONException {
        ...
        try {
            ...
            if (delete) {
                contexto.getContentResolver().delete(LojaVirtualContract.buildDeleteAllRecreate(), null, null);
            }
            contexto.getContentResolver().bulkInsert(LojaVirtualContract.getContentUri(), vetor);
    ...
    private JSONObject JSonAtributos(Cursor c) throws JSONException {
        ...
        JSONObject json = new JSONObject();
        	json.put("IdLojaVirtual",c.getString(LojaVirtualContract.COL_ID_LOJA_VIRTUAL));
			json.put("NomeLojaVirtual",c.getString(LojaVirtualContract.COL_NOME_LOJA_VIRTUAL));
			json.put("UrlPrincipal",c.getString(LojaVirtualContract.COL_URL_PRINCIPAL));
		
        return json;
    }
     private JSONObject JSonAtributosSinc(Cursor c) throws JSONException {
        JSONObject json = JSonAtributos(c);
        json.put("OperacaoSinc",c.getString(LojaVirtualContract.COL_OPERACAO_SINC));
        return json;
    }
    ...
    private ContentValues ContentValuesAtributos(JSONObject obj) throws JSONException {
		...
		valores.put(LojaVirtualContract.COLUNA_ID_LOJA_VIRTUAL, obj.getString("IdLojaVirtual"));
		
		valores.put(LojaVirtualContract.COLUNA_NOME_LOJA_VIRTUAL, obj.getString("NomeLojaVirtual"));
		
		valores.put(LojaVirtualContract.COLUNA_URL_PRINCIPAL, obj.getString("UrlPrincipal"));
