...
public abstract class PrecoProdutoProvider {
	...
	public static final int PRECO_PRODUTO = 78300;
	public static final int PRECO_PRODUTO_ID = 78301;
	public static final int PRECO_PRODUTO_SINC = 78303;
	public static final int PRECO_PRODUTO_E_COMPLEMENTO = 78304;
	public static final int PRECO_PRODUTO_ID_E_COMPLEMENTO = 78305;
	//public static final int PRECO_PRODUTO_OPERACAO = 78302;
	
	// deletes
	public static final int PRECO_PRODUTO_DELETE_ALL_SINC = 78306;
	public static final int PRECO_PRODUTO_DELETE_RECREATE = 78307;
	public static final int PRECO_PRODUTO_DELETE_SINC = 78308;
	public static final int PRECO_PRODUTO_E_RETIRADA = 78309;
	
	private static final String sPorChaveSel = PrecoProdutoContract.TABLE_NAME + "." + PrecoProdutoContract.COLUNA_CHAVE + " = ? ";
	
	
	
	public static final int PRECO_PRODUTO_POR_PRODUTO_PERTENCEA = 78320;
	public static final int COM_PRODUTO = 78321;
