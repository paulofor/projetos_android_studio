...
public class ModeloProdutoRemote {
    ...
    public int listaSincronizadaDao(Context contexto, boolean delete) throws JSONException {
        ...
        try {
            ...
            if (delete) {
                contexto.getContentResolver().delete(ModeloProdutoContract.buildDeleteAllRecreate(), null, null);
            }
            contexto.getContentResolver().bulkInsert(ModeloProdutoContract.getContentUri(), vetor);
    ...
    private JSONObject JSonAtributos(Cursor c) throws JSONException {
        ...
        JSONObject json = new JSONObject();
        	json.put("IdModeloProduto",c.getString(ModeloProdutoContract.COL_ID_MODELO_PRODUTO));
			json.put("NomeModeloProduto",c.getString(ModeloProdutoContract.COL_NOME_MODELO_PRODUTO));
		
        return json;
    }
     private JSONObject JSonAtributosSinc(Cursor c) throws JSONException {
        JSONObject json = JSonAtributos(c);
        json.put("OperacaoSinc",c.getString(ModeloProdutoContract.COL_OPERACAO_SINC));
        return json;
    }
    ...
    private ContentValues ContentValuesAtributos(JSONObject obj) throws JSONException {
		...
		valores.put(ModeloProdutoContract.COLUNA_ID_MODELO_PRODUTO, obj.getString("IdModeloProduto"));
		
		valores.put(ModeloProdutoContract.COLUNA_NOME_MODELO_PRODUTO, obj.getString("NomeModeloProduto"));
