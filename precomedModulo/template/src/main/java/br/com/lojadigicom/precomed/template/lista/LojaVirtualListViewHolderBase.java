 ...
 */
public abstract class LojaVirtualListViewHolderBase extends RecyclerView.ViewHolder implements View.OnClickListener{

    //protected Cursor mCursor;
    protected List mLista;
    protected LojaVirtualListAdapterBase.LojaVirtualListAdapterOnClickHandler mClickHandler;
    protected ItemChoiceManager mICM = null;


	private LojaVirtual item;
	public void setItem(LojaVirtual dado) {
		item = dado;
	}
	public LojaVirtual getItem() {
		return item;
	}
    ...
    public void setOnClickHandler(LojaVirtualListAdapterBase.LojaVirtualListAdapterOnClickHandler valor){
        mClickHandler = valor;
    }

    public LojaVirtualListViewHolderBase(View itemView) {
        super(itemView);
