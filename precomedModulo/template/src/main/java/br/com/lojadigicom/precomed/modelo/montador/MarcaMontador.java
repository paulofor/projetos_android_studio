...
import br.com.lojadigicom.precomed.modelo.MarcaVo;
...
public class MarcaMontador implements MontadorDaoI {
	...
	private Marca principal = new MarcaVo();
	
	private boolean sinc = false;
	public MarcaMontador(boolean sinc) {
		this.sinc = sinc;
	}
	public MarcaMontador() {
		this.sinc = false;
	}
