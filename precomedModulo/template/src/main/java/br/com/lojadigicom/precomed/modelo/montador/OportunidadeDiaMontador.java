...
import br.com.lojadigicom.precomed.modelo.OportunidadeDiaVo;
...
public class OportunidadeDiaMontador implements MontadorDaoI {
	...
	private OportunidadeDia principal = new OportunidadeDiaVo();
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		...
		item = (OportunidadeDia) entrada;
		item.setIdOportunidadeDia(getInt(c,pos++));
