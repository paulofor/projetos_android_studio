...
import br.com.lojadigicom.precomed.modelo.ModeloProdutoProdutoVo;
...
public class ModeloProdutoProdutoMontador implements MontadorDaoI {
	...
	private ModeloProdutoProduto principal = new ModeloProdutoProdutoVo();
	
	private boolean sinc = false;
	public ModeloProdutoProdutoMontador(boolean sinc) {
		this.sinc = sinc;
	}
	public ModeloProdutoProdutoMontador() {
		this.sinc = false;
	}
	...
	public DCIObjetoDominio getItem(Cursor c) {
		...
		objeto = new ModeloProdutoProdutoVo();
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		...
		item = (ModeloProdutoProduto) entrada;
		item.setIdModeloProdutoProduto(getInt(c,pos++));
