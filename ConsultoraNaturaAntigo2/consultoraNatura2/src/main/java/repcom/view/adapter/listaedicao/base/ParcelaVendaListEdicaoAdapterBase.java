...
public abstract class ParcelaVendaListEdicaoAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public ParcelaVendaListEdicaoAdapterBase(List<ParcelaVenda> lista, IQuadroListaEdicao origem, Context context ) {
...
*/
	...
	protected int getLayout() {
		return R.layout.item_parcela_venda;
	}
