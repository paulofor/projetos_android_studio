...
public abstract class ClienteListEdicaoAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public ClienteListEdicaoAdapterBase(List<Cliente> lista, IQuadroListaEdicao origem, Context context ) {
