...
public abstract class LinhaProdutoListUsoAdapterBase extends BaseAdapter {
	...
	public LinhaProdutoListUsoAdapterBase(List<LinhaProduto> lista, DigicomContexto context ) {
		this.context = context;
		this.lista = lista;
		setEdicao(); // Forcando para fazer edicao - alterar se for necessario depois.
	}
	
	public void setListaNova(List<LinhaProduto> listaNova) {
	...
	protected ResourceObj getLayoutItem() {
		return new ResourceObj(R.layout.item_linha_produto,"R.layout.item_linha_produto");
	}
	/*
	@Override
