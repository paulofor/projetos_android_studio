...
public abstract class LinhaProdutoListAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public LinhaProdutoListAdapterBase(List<LinhaProduto> lista, Context context ) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View saida = LayoutInflater.from(context).inflate(R.layout.item_linha_produto, null);
	...
	protected void montaItemLista(int posicao, LinhaProduto item, View saida) {
