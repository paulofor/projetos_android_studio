...
public abstract class PagamentoFornecedorListEdicaoAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public PagamentoFornecedorListEdicaoAdapterBase(List<PagamentoFornecedor> lista, IQuadroListaEdicao origem, Context context ) {
...
*/
	...
	protected int getLayout() {
		return R.layout.item_pagamento_fornecedor;
	}
