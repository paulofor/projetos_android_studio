...
public abstract class EstoqueListAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public EstoqueListAdapterBase(List<Estoque> lista, Context context ) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View saida = LayoutInflater.from(context).inflate(R.layout.item_estoque, null);
	...
	protected void montaItemLista(int posicao, Estoque item, View saida) {
