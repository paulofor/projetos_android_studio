...
public abstract class ContatoClienteListAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public ContatoClienteListAdapterBase(List<ContatoCliente> lista, Context context ) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View saida = LayoutInflater.from(context).inflate(R.layout.item_contato_cliente, null);
