...
import repcom.view.DispositivoUsuarioView;
import br.com.digicom.layout.ItemLista;
import br.com.digicom.quadro.IQuadroListaEdicao;
import br.com.digicom.quadro.IFragment;
import br.com.digicom.quadro.BaseListFragment;
import repcom.tela.quadro.base.DispositivoUsuarioQuadroListaBase;

public abstract class DispositivoUsuarioListEdicaoAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public DispositivoUsuarioListEdicaoAdapterBase(List<DispositivoUsuario> lista, IQuadroListaEdicao origem, Context context ) {
...
*/
	...
	protected int getLayout() {
		return R.layout.item_dispositivo_usuario;
	}
