...
public abstract class CategoriaProdutoProdutoListEdicaoAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public CategoriaProdutoProdutoListEdicaoAdapterBase(List<CategoriaProdutoProduto> lista, IQuadroListaEdicao origem, Context context ) {
...
*/
	...
	protected int getLayout() {
		return R.layout.item_categoria_produto_produto;
	}
