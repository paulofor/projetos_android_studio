...
public abstract class PedidoFornecedorListEdicaoAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public PedidoFornecedorListEdicaoAdapterBase(List<PedidoFornecedor> lista, IQuadroListaEdicao origem, Context context ) {
...
*/
	...
	protected int getLayout() {
		return R.layout.item_pedido_fornecedor;
	}
