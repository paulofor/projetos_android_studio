...
public abstract class VendaListEdicaoAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public VendaListEdicaoAdapterBase(List<Venda> lista, IQuadroListaEdicao origem, Context context ) {
