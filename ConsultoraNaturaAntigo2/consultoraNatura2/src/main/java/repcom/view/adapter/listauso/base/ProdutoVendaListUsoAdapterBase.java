...
import repcom.view.ProdutoVendaView;
import br.com.digicom.layout.ItemLista;
import br.com.digicom.quadro.IQuadroLista;
import br.com.digicom.quadro.IFragment;
import br.com.digicom.activity.DigicomContexto;
import br.com.digicom.layout.ResourceObj;
import repcom.tela.quadro.base.ProdutoVendaQuadroListaBase;

public abstract class ProdutoVendaListUsoAdapterBase extends BaseAdapter {
	...
	public ProdutoVendaListUsoAdapterBase(List<ProdutoVenda> lista, DigicomContexto context ) {
		this.context = context;
		this.lista = lista;
		setEdicao(); // Forcando para fazer edicao - alterar se for necessario depois.
	}
	
	public void setListaNova(List<ProdutoVenda> listaNova) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ProdutoVenda item = lista.get(position);
		...
		if (!(saida instanceof ItemLista))
			throw new RuntimeException("Alterar layout raiz de item_produto_venda.xml para br.com.digicom.layout.ItemLista");
	...
	protected void montaItemLista(int position, ProdutoVenda item, View saida) {
		throw new UnsupportedOperationException("Fazer override de montaItemLista em "  + this.getClass().getSimpleName() + " ou verificar se nao esta sendo chamada via super. Arquivo de visao padrao eh: R.layout.item_produto_venda");
	}
	protected ResourceObj getLayoutItem() {
		return new ResourceObj(R.layout.item_produto_venda,"R.layout.item_produto_venda");
	}
	/*
	@Override
	public boolean onTouch(View view, MotionEvent avent) {
	 	ItemLista objeto = (ItemLista) view;
		ProdutoVenda item = (ProdutoVenda) objeto.getItem();
