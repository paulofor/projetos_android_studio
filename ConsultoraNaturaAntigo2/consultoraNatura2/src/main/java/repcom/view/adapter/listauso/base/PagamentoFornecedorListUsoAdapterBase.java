...
public abstract class PagamentoFornecedorListUsoAdapterBase extends BaseAdapter {
	...
	public PagamentoFornecedorListUsoAdapterBase(List<PagamentoFornecedor> lista, DigicomContexto context ) {
		this.context = context;
		this.lista = lista;
		setEdicao(); // Forcando para fazer edicao - alterar se for necessario depois.
	}
	
	public void setListaNova(List<PagamentoFornecedor> listaNova) {
	...
	protected void montaItemLista(int position, PagamentoFornecedor item, View saida) {
	...
	protected ResourceObj getLayoutItem() {
		return new ResourceObj(R.layout.item_pagamento_fornecedor,"R.layout.item_pagamento_fornecedor");
	}
	/*
	@Override
