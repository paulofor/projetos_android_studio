...
public abstract class ClienteInteresseCategoriaListAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public ClienteInteresseCategoriaListAdapterBase(List<ClienteInteresseCategoria> lista, Context context ) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View saida = LayoutInflater.from(context).inflate(R.layout.item_cliente_interesse_categoria, null);
