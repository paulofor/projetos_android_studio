...
public abstract class CategoriaProdutoListUsoAdapterBase extends BaseAdapter {
	...
	public CategoriaProdutoListUsoAdapterBase(List<CategoriaProduto> lista, DigicomContexto context ) {
		this.context = context;
		this.lista = lista;
		setEdicao(); // Forcando para fazer edicao - alterar se for necessario depois.
	}
	
	public void setListaNova(List<CategoriaProduto> listaNova) {
	...
	protected void montaItemLista(int position, CategoriaProduto item, View saida) {
	...
	protected ResourceObj getLayoutItem() {
		return new ResourceObj(R.layout.item_categoria_produto,"R.layout.item_categoria_produto");
	}
	/*
	@Override
