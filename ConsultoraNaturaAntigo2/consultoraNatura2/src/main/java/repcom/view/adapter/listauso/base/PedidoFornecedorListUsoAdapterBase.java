...
public abstract class PedidoFornecedorListUsoAdapterBase extends BaseAdapter {
	...
	public PedidoFornecedorListUsoAdapterBase(List<PedidoFornecedor> lista, DigicomContexto context ) {
		this.context = context;
		this.lista = lista;
		setEdicao(); // Forcando para fazer edicao - alterar se for necessario depois.
	}
	
	public void setListaNova(List<PedidoFornecedor> listaNova) {
	...
	protected void montaItemLista(int position, PedidoFornecedor item, View saida) {
	...
	protected ResourceObj getLayoutItem() {
		return new ResourceObj(R.layout.item_pedido_fornecedor,"R.layout.item_pedido_fornecedor");
	}
	/*
	@Override
