...
public abstract class ParcelaVendaListUsoAdapterBase extends BaseAdapter {
	...
	public ParcelaVendaListUsoAdapterBase(List<ParcelaVenda> lista, DigicomContexto context ) {
		this.context = context;
		this.lista = lista;
		setEdicao(); // Forcando para fazer edicao - alterar se for necessario depois.
	}
	
	public void setListaNova(List<ParcelaVenda> listaNova) {
	...
	protected void montaItemLista(int position, ParcelaVenda item, View saida) {
	...
	protected ResourceObj getLayoutItem() {
		return new ResourceObj(R.layout.item_parcela_venda,"R.layout.item_parcela_venda");
	}
	/*
	@Override
