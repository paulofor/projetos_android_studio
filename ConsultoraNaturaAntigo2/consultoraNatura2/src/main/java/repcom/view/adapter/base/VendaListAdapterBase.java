...
public abstract class VendaListAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public VendaListAdapterBase(List<Venda> lista, Context context ) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View saida = LayoutInflater.from(context).inflate(R.layout.item_venda, null);
	...
	protected void montaItemLista(int posicao, Venda item, View saida) {
