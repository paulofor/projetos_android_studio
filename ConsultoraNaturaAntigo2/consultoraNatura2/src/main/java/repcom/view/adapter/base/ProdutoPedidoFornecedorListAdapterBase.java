...
public abstract class ProdutoPedidoFornecedorListAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public ProdutoPedidoFornecedorListAdapterBase(List<ProdutoPedidoFornecedor> lista, Context context ) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View saida = LayoutInflater.from(context).inflate(R.layout.item_produto_pedido_fornecedor, null);
	...
	protected void montaItemLista(int posicao, ProdutoPedidoFornecedor item, View saida) {
