...
public abstract class ClienteListUsoAdapterBase extends BaseAdapter {
	...
	public ClienteListUsoAdapterBase(List<Cliente> lista, DigicomContexto context ) {
		this.context = context;
		this.lista = lista;
		setEdicao(); // Forcando para fazer edicao - alterar se for necessario depois.
	}
	
	public void setListaNova(List<Cliente> listaNova) {
	...
	protected void montaItemLista(int position, Cliente item, View saida) {
	...
	protected ResourceObj getLayoutItem() {
		return new ResourceObj(R.layout.item_cliente,"R.layout.item_cliente");
	}
	/*
	@Override
