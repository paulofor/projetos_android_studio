...
public abstract class ClienteInteresseCategoriaListEdicaoAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public ClienteInteresseCategoriaListEdicaoAdapterBase(List<ClienteInteresseCategoria> lista, IQuadroListaEdicao origem, Context context ) {
...
*/
	...
	protected int getLayout() {
		return R.layout.item_cliente_interesse_categoria;
	}
