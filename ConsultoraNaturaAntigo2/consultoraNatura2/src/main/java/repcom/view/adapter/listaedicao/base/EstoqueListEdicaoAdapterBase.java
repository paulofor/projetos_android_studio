...
public abstract class EstoqueListEdicaoAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public EstoqueListEdicaoAdapterBase(List<Estoque> lista, IQuadroListaEdicao origem, Context context ) {
