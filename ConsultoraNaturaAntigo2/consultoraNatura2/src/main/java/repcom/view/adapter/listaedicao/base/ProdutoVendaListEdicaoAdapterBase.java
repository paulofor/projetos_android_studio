...
public abstract class ProdutoVendaListEdicaoAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public ProdutoVendaListEdicaoAdapterBase(List<ProdutoVenda> lista, IQuadroListaEdicao origem, Context context ) {
...
*/
	...
	protected int getLayout() {
		return R.layout.item_produto_venda;
	}
