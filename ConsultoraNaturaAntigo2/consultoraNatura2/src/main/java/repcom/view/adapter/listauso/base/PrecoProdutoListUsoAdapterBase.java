...
public abstract class PrecoProdutoListUsoAdapterBase extends BaseAdapter {
	...
	public PrecoProdutoListUsoAdapterBase(List<PrecoProduto> lista, DigicomContexto context ) {
		this.context = context;
		this.lista = lista;
		setEdicao(); // Forcando para fazer edicao - alterar se for necessario depois.
	}
	
	public void setListaNova(List<PrecoProduto> listaNova) {
	...
	protected ResourceObj getLayoutItem() {
		return new ResourceObj(R.layout.item_preco_produto,"R.layout.item_preco_produto");
	}
	/*
	@Override
