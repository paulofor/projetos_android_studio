...
public abstract class MesAnoListEdicaoAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public MesAnoListEdicaoAdapterBase(List<MesAno> lista, IQuadroListaEdicao origem, Context context ) {
