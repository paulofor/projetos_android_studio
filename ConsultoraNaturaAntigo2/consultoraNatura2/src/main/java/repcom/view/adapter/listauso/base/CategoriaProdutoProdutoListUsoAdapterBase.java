...
import repcom.view.CategoriaProdutoProdutoView;
import br.com.digicom.layout.ItemLista;
import br.com.digicom.quadro.IQuadroLista;
import br.com.digicom.quadro.IFragment;
import br.com.digicom.activity.DigicomContexto;
import br.com.digicom.layout.ResourceObj;
import repcom.tela.quadro.base.CategoriaProdutoProdutoQuadroListaBase;

public abstract class CategoriaProdutoProdutoListUsoAdapterBase extends BaseAdapter {
	
	private DigicomContexto context;
	private List<CategoriaProdutoProduto> lista;
	...
	public CategoriaProdutoProdutoListUsoAdapterBase(List<CategoriaProdutoProduto> lista, DigicomContexto context ) {
		this.context = context;
		this.lista = lista;
		setEdicao(); // Forcando para fazer edicao - alterar se for necessario depois.
	}
	
	public void setListaNova(List<CategoriaProdutoProduto> listaNova) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		CategoriaProdutoProduto item = lista.get(position);
		...
		if (!(saida instanceof ItemLista))
			throw new RuntimeException("Alterar layout raiz de item_categoria_produto_produto.xml para br.com.digicom.layout.ItemLista");
	...
	protected void montaItemLista(int position, CategoriaProdutoProduto item, View saida) {
		throw new UnsupportedOperationException("Fazer override de montaItemLista em "  + this.getClass().getSimpleName() + " ou verificar se nao esta sendo chamada via super. Arquivo de visao padrao eh: R.layout.item_categoria_produto_produto");
	}
	protected ResourceObj getLayoutItem() {
		return new ResourceObj(R.layout.item_categoria_produto_produto,"R.layout.item_categoria_produto_produto");
	}
	/*
	@Override
	public boolean onTouch(View view, MotionEvent avent) {
	 	ItemLista objeto = (ItemLista) view;
		CategoriaProdutoProduto item = (CategoriaProdutoProduto) objeto.getItem();
