...
import repcom.view.PrecoProdutoView;
import br.com.digicom.layout.ItemLista;
import br.com.digicom.quadro.IQuadroListaEdicao;
import br.com.digicom.quadro.IFragment;
import repcom.tela.quadro.base.PrecoProdutoQuadroListaBase;

public abstract class PrecoProdutoListAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public PrecoProdutoListAdapterBase(List<PrecoProduto> lista, Context context ) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View saida = LayoutInflater.from(context).inflate(R.layout.item_preco_produto, null);
	...
	protected void montaItemLista(int posicao, PrecoProduto item, View saida) {
