...
public abstract class ProdutoPedidoFornecedorListUsoAdapterBase extends BaseAdapter {
	...
	public ProdutoPedidoFornecedorListUsoAdapterBase(List<ProdutoPedidoFornecedor> lista, DigicomContexto context ) {
		this.context = context;
		this.lista = lista;
		setEdicao(); // Forcando para fazer edicao - alterar se for necessario depois.
	}
	
	public void setListaNova(List<ProdutoPedidoFornecedor> listaNova) {
	...
	protected ResourceObj getLayoutItem() {
		return new ResourceObj(R.layout.item_produto_pedido_fornecedor,"R.layout.item_produto_pedido_fornecedor");
	}
	/*
	@Override
