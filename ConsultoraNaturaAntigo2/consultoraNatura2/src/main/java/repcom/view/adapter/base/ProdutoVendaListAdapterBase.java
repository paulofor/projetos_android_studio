...
public abstract class ProdutoVendaListAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public ProdutoVendaListAdapterBase(List<ProdutoVenda> lista, Context context ) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View saida = LayoutInflater.from(context).inflate(R.layout.item_produto_venda, null);
	...
	protected void montaItemLista(int posicao, ProdutoVenda item, View saida) {
