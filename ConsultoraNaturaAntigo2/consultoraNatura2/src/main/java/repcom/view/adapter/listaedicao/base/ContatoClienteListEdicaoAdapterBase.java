...
public abstract class ContatoClienteListEdicaoAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public ContatoClienteListEdicaoAdapterBase(List<ContatoCliente> lista, IQuadroListaEdicao origem, Context context ) {
...
*/
	...
	protected int getLayout() {
		return R.layout.item_contato_cliente;
	}
