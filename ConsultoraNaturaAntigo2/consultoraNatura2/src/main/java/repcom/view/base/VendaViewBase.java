...
// classes de UI
public abstract class VendaViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public VendaViewBase(Context context, Venda item) {
		throw new UnsupportedOperationException("Usar o construtor novo de VendaView");
	}
	@Override
	...
	public VendaViewBase(Venda item) {
		super();
		this.item = item;
	...
	protected int getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_venda ou similar");
	}
