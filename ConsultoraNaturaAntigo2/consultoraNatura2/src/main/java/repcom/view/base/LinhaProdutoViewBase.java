...
// classes de UI
public abstract class LinhaProdutoViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public LinhaProdutoViewBase(Context context, LinhaProduto item) {
		throw new UnsupportedOperationException("Usar o construtor novo de LinhaProdutoView");
	}
	@Override
	...
	public LinhaProdutoViewBase(LinhaProduto item) {
		super();
		this.item = item;
	...
	protected int getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_linha_produto ou similar");
	}
