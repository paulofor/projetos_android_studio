...
// classes de UI
public abstract class ContatoClienteViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public ContatoClienteViewBase(Context context, ContatoCliente item) {
		throw new UnsupportedOperationException("Usar o construtor novo de ContatoClienteView");
	}
	@Override
	...
	public ContatoClienteViewBase(ContatoCliente item) {
		super();
		this.item = item;
	...
	protected int getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_contato_cliente ou similar");
	}
