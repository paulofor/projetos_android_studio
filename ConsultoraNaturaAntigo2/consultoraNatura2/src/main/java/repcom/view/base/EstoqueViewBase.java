...
// classes de UI
public abstract class EstoqueViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public EstoqueViewBase(Context context, Estoque item) {
		throw new UnsupportedOperationException("Usar o construtor novo de EstoqueView");
	}
	@Override
	...
	public EstoqueViewBase(Estoque item) {
		super();
		this.item = item;
	...
	protected int getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_estoque ou similar");
	}
