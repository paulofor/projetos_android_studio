...
// classes de UI
public abstract class ParcelaVendaViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public ParcelaVendaViewBase(Context context, ParcelaVenda item) {
		throw new UnsupportedOperationException("Usar o construtor novo de ParcelaVendaView");
	}
	@Override
	...
	public ParcelaVendaViewBase(ParcelaVenda item) {
		super();
		this.item = item;
	...
	protected int getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_parcela_venda ou similar");
	}
