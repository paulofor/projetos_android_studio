...
// classes de UI
public abstract class MesAnoViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public MesAnoViewBase(Context context, MesAno item) {
		throw new UnsupportedOperationException("Usar o construtor novo de MesAnoView");
	}
	@Override
	...
	public MesAnoViewBase(MesAno item) {
		super();
		this.item = item;
	...
	protected int getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_mesano ou similar");
	}
