...
// classes de UI
public abstract class PedidoFornecedorViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public PedidoFornecedorViewBase(Context context, PedidoFornecedor item) {
		throw new UnsupportedOperationException("Usar o construtor novo de PedidoFornecedorView");
	}
	@Override
	...
	public PedidoFornecedorViewBase(PedidoFornecedor item) {
		super();
		this.item = item;
	...
	protected int getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_pedido_fornecedor ou similar");
	}
