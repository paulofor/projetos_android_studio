...
// classes de UI
public abstract class ClienteInteresseCategoriaViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public ClienteInteresseCategoriaViewBase(Context context, ClienteInteresseCategoria item) {
		throw new UnsupportedOperationException("Usar o construtor novo de ClienteInteresseCategoriaView");
	}
	@Override
	...
	public ClienteInteresseCategoriaViewBase(ClienteInteresseCategoria item) {
		super();
		this.item = item;
	...
	protected int getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_cliente_interesse_categoria ou similar");
	}
