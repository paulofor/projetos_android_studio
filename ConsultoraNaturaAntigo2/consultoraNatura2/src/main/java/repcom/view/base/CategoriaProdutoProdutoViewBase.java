...
// classes de UI
public abstract class CategoriaProdutoProdutoViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public CategoriaProdutoProdutoViewBase(Context context, CategoriaProdutoProduto item) {
		throw new UnsupportedOperationException("Usar o construtor novo de CategoriaProdutoProdutoView");
	}
	@Override
	...
	public CategoriaProdutoProdutoViewBase(CategoriaProdutoProduto item) {
		super();
		this.item = item;
	...
	protected int getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_categoria_produto_produto ou similar");
	}
