...
// classes de UI
public abstract class ClienteViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public ClienteViewBase(Context context, Cliente item) {
		throw new UnsupportedOperationException("Usar o construtor novo de ClienteView");
	}
	@Override
	...
	public ClienteViewBase(Cliente item) {
		super();
		this.item = item;
	...
	protected int getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_cliente ou similar");
	}
