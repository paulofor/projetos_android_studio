...
// classes de UI
public abstract class PagamentoFornecedorViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public PagamentoFornecedorViewBase(Context context, PagamentoFornecedor item) {
		throw new UnsupportedOperationException("Usar o construtor novo de PagamentoFornecedorView");
	}
	@Override
	...
	public PagamentoFornecedorViewBase(PagamentoFornecedor item) {
		super();
		this.item = item;
	...
	protected int getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_pagamento_fornecedor ou similar");
	}
