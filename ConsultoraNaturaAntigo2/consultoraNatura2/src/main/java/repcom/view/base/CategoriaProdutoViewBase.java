...
// classes de UI
public abstract class CategoriaProdutoViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public CategoriaProdutoViewBase(Context context, CategoriaProduto item) {
		throw new UnsupportedOperationException("Usar o construtor novo de CategoriaProdutoView");
	}
	@Override
	...
	public CategoriaProdutoViewBase(CategoriaProduto item) {
		super();
		this.item = item;
	...
	protected int getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_categoria_produto ou similar");
	}
