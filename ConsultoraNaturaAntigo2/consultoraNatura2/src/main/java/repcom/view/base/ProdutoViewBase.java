...
// classes de UI
public abstract class ProdutoViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public ProdutoViewBase(Context context, Produto item) {
		throw new UnsupportedOperationException("Usar o construtor novo de ProdutoView");
	}
	@Override
	...
	public ProdutoViewBase(Produto item) {
		super();
		this.item = item;
	...
	protected int getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_produto ou similar");
	}
