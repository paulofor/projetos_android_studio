...
// classes de UI
public abstract class ProdutoPedidoFornecedorViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public ProdutoPedidoFornecedorViewBase(Context context, ProdutoPedidoFornecedor item) {
		throw new UnsupportedOperationException("Usar o construtor novo de ProdutoPedidoFornecedorView");
	}
	@Override
	...
	public ProdutoPedidoFornecedorViewBase(ProdutoPedidoFornecedor item) {
		super();
		this.item = item;
	...
	protected int getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_produto_pedido_fornecedor ou similar");
	}
