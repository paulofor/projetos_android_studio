...
public class PagamentoFornecedorMontador extends MontadorDaoBase implements MontadorDaoI{
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		...
		item = (PagamentoFornecedor) entrada;item.setIdPagamentoFornecedor(getInt(c,pos++));
		if (sinc) {
