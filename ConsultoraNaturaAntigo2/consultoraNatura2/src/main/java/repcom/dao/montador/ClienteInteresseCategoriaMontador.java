...
public class ClienteInteresseCategoriaMontador extends MontadorDaoBase implements MontadorDaoI{
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		...
		item = (ClienteInteresseCategoria) entrada;item.setIdClienteInteresseCategoria(getInt(c,pos++));
