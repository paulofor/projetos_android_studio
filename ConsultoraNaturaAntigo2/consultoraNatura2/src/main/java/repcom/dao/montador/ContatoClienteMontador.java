...
public class ContatoClienteMontador extends MontadorDaoBase implements MontadorDaoI{
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		...
		item = (ContatoCliente) entrada;item.setIdContatoCliente(getInt(c,pos++));
		item.setDataContato(getTimestampData(c,pos++));
