...
public class CategoriaProdutoProdutoMontador extends MontadorDaoBase implements MontadorDaoI{
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		...
		item = (CategoriaProdutoProduto) entrada;item.setIdCategoriaProdutoProduto(getInt(c,pos++));
