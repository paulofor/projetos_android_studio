...
public class CategoriaProdutoMontador extends MontadorDaoBase implements MontadorDaoI{
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		...
		item = (CategoriaProduto) entrada;item.setIdCategoriaProduto(getInt(c,pos++));
