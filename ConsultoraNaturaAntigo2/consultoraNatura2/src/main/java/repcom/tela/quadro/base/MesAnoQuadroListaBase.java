...
public abstract class MesAnoQuadroListaBase extends BaseListFragment implements IQuadroListaEdicao {

	public final static String ITEM_CLICK = "MesAnoItemClick";

	MesAnoListAdapter adapt = null;
	private Button btnCriaItem = null;
	
	MesAnoServico servico = null;
	...
	protected IFragmentEdicao criaQuadroTrata() {
		throw new UnsupportedOperationException("Fazer override de criaQuadroTrata em MesAnoQuadroLista retornando new MesAnoQuadroTrata ou verificar se nao esta sendo chamada via super");
	}
	...
	protected MesAnoListAdapter getAdapter(List<MesAno> lista,DigicomContexto dContexto) {
		return new MesAnoListAdapter(lista,dContexto.getContext());
	}
