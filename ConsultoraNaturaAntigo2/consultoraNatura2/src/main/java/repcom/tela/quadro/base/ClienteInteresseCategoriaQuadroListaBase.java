...
public abstract class ClienteInteresseCategoriaQuadroListaBase extends BaseListFragment implements IQuadroListaEdicao {

	public final static String ITEM_CLICK = "ClienteInteresseCategoriaItemClick";

	ClienteInteresseCategoriaListAdapter adapt = null;
	private Button btnCriaItem = null;
	
	ClienteInteresseCategoriaServico servico = null;
	...
	public final void chamaCriaItem() {
		IFragmentEdicao quadro = criaQuadroTrata();
		//ClienteInteresseCategoria nova = servico.inicializaItemTela(getContext());
		ClienteInteresseCategoria nova = FabricaVo.criaClienteInteresseCategoria();
	...
	protected IFragmentEdicao criaQuadroTrata() {
		throw new UnsupportedOperationException("Fazer override de criaQuadroTrata em ClienteInteresseCategoriaQuadroLista retornando new ClienteInteresseCategoriaQuadroTrata ou verificar se nao esta sendo chamada via super");
	}
	...
	protected ClienteInteresseCategoriaListAdapter getAdapter(List<ClienteInteresseCategoria> lista,DigicomContexto dContexto) {
		return new ClienteInteresseCategoriaListAdapter(lista,dContexto.getContext());
	}
	
	protected List<ClienteInteresseCategoria> getListaCorrente(Context contexto,ClienteInteresseCategoriaServico servico) {
		List<ClienteInteresseCategoria> saida = servico.getAllTela(contexto);
		return saida;
	}
