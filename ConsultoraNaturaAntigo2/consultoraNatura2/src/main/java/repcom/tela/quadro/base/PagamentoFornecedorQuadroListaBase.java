...
public abstract class PagamentoFornecedorQuadroListaBase extends BaseListFragment implements IQuadroListaEdicao {

	public final static String ITEM_CLICK = "PagamentoFornecedorItemClick";

	PagamentoFornecedorListAdapter adapt = null;
	private Button btnCriaItem = null;
	
	PagamentoFornecedorServico servico = null;
	...
	protected IFragmentEdicao criaQuadroTrata() {
		throw new UnsupportedOperationException("Fazer override de criaQuadroTrata em PagamentoFornecedorQuadroLista retornando new PagamentoFornecedorQuadroTrata ou verificar se nao esta sendo chamada via super");
	}
	...
	protected PagamentoFornecedorListAdapter getAdapter(List<PagamentoFornecedor> lista,DigicomContexto dContexto) {
		return new PagamentoFornecedorListAdapter(lista,dContexto.getContext());
	}
