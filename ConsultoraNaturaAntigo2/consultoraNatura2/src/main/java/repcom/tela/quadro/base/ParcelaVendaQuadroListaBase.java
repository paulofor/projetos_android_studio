...
public abstract class ParcelaVendaQuadroListaBase extends BaseListFragment implements IQuadroListaEdicao {

	public final static String ITEM_CLICK = "ParcelaVendaItemClick";

	ParcelaVendaListAdapter adapt = null;
	private Button btnCriaItem = null;
	
	ParcelaVendaServico servico = null;
	...
	protected IFragmentEdicao criaQuadroTrata() {
		throw new UnsupportedOperationException("Fazer override de criaQuadroTrata em ParcelaVendaQuadroLista retornando new ParcelaVendaQuadroTrata ou verificar se nao esta sendo chamada via super");
	}
	...
	private void preencheLista() {
        ...
        List<ParcelaVenda> lista = getListaCorrente(dContexto.getContext(),servico);
	...
	protected ParcelaVendaListAdapter getAdapter(List<ParcelaVenda> lista,DigicomContexto dContexto) {
		return new ParcelaVendaListAdapter(lista,dContexto.getContext());
	}
