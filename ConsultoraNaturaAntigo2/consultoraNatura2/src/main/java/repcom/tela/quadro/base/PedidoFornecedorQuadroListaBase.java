...
public abstract class PedidoFornecedorQuadroListaBase extends BaseListFragment implements IQuadroListaEdicao {

	public final static String ITEM_CLICK = "PedidoFornecedorItemClick";

	PedidoFornecedorListAdapter adapt = null;
	private Button btnCriaItem = null;
	
	PedidoFornecedorServico servico = null;
	...
	protected IFragmentEdicao criaQuadroTrata() {
		throw new UnsupportedOperationException("Fazer override de criaQuadroTrata em PedidoFornecedorQuadroLista retornando new PedidoFornecedorQuadroTrata ou verificar se nao esta sendo chamada via super");
	}
	...
	protected PedidoFornecedorListAdapter getAdapter(List<PedidoFornecedor> lista,DigicomContexto dContexto) {
		return new PedidoFornecedorListAdapter(lista,dContexto.getContext());
	}
