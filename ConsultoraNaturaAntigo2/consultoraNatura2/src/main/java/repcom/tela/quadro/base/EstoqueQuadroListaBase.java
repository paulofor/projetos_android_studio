...
public abstract class EstoqueQuadroListaBase extends BaseListFragment implements IQuadroListaEdicao {

	public final static String ITEM_CLICK = "EstoqueItemClick";

	EstoqueListAdapter adapt = null;
	private Button btnCriaItem = null;
	
	EstoqueServico servico = null;
	...
	protected IFragmentEdicao criaQuadroTrata() {
		throw new UnsupportedOperationException("Fazer override de criaQuadroTrata em EstoqueQuadroLista retornando new EstoqueQuadroTrata ou verificar se nao esta sendo chamada via super");
	}
	...
	protected EstoqueListAdapter getAdapter(List<Estoque> lista,DigicomContexto dContexto) {
		return new EstoqueListAdapter(lista,dContexto.getContext());
	}
