...
import repcom.view.adapter.listauso.MesAnoListUsoAdapter;
...
public abstract class MesAnoListaUsoBase extends BaseListFragment implements IQuadroLista {

	public final static String ITEM_CLICK = "MesAnoItemClick";

	private MesAnoListUsoAdapterBase adapt = null;
	...
	protected void atualizaLista(List<MesAno> listaNova) {
	...
	*/
	...
	private void preencheLista() {
        ...
        List<MesAno> lista = getListaCorrente(dContexto.getContext(),servico);
        // Pode ser necessario um adapter customizado (diferenciar o editar e usar)
        adapt =  getAdapter(lista, dContexto);
        DCLog.d(DCLog.SERVICO_QUADRO_LISTA, this, "getListaCorrente : List<MesAno> -> " + lista.size() + " itens (Adapter:" + adapt.getClass().getName() + ")");
        adapt.setRaiz(this);
        setListAdapter(adapt);
	}
	
	protected MesAnoListUsoAdapterBase getAdapter(List<MesAno> lista,DigicomContexto dContexto) {
		return new MesAnoListUsoAdapter(lista,dContexto);
	}
