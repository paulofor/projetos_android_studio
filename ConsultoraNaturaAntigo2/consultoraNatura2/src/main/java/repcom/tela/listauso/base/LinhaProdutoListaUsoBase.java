...
import repcom.view.adapter.listauso.LinhaProdutoListUsoAdapter;
...
public abstract class LinhaProdutoListaUsoBase extends BaseListFragment implements IQuadroLista {

	public final static String ITEM_CLICK = "LinhaProdutoItemClick";

	private LinhaProdutoListUsoAdapterBase adapt = null;
	...
	protected void atualizaLista(List<LinhaProduto> listaNova) {
	...
	*/
	...
	private void preencheLista() {
        ...
        DCLog.d(DCLog.SERVICO_QUADRO_LISTA, this, "getListaCorrente : List<LinhaProduto> -> " + lista.size() + " itens (Adapter:" + adapt.getClass().getName() + ")");
        adapt.setRaiz(this);
        setListAdapter(adapt);
	}
	
	protected LinhaProdutoListUsoAdapterBase getAdapter(List<LinhaProduto> lista,DigicomContexto dContexto) {
		return new LinhaProdutoListUsoAdapter(lista,dContexto);
	}
