...
import repcom.view.adapter.listauso.ContatoClienteListUsoAdapter;
...
public abstract class ContatoClienteListaUsoBase extends BaseListFragment implements IQuadroLista {

	public final static String ITEM_CLICK = "ContatoClienteItemClick";

	private ContatoClienteListUsoAdapterBase adapt = null;
	private ContatoClienteServico servico = null;
	
		
	protected ContatoClienteServico getServico() {
		return servico;
	}
	...
	protected void atualizaLista(List<ContatoCliente> listaNova) {
	...
	*/
	...
	private void preencheLista() {
        ...
        DCLog.d(DCLog.SERVICO_QUADRO_LISTA, this, "getListaCorrente : List<ContatoCliente> -> " + lista.size() + " itens (Adapter:" + adapt.getClass().getName() + ")");
        adapt.setRaiz(this);
        setListAdapter(adapt);
	}
	
	protected ContatoClienteListUsoAdapterBase getAdapter(List<ContatoCliente> lista,DigicomContexto dContexto) {
		return new ContatoClienteListUsoAdapter(lista,dContexto);
	}
