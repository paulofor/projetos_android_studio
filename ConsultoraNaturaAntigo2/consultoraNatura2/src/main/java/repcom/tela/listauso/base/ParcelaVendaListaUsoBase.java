...
import repcom.view.adapter.listauso.ParcelaVendaListUsoAdapter;
...
public abstract class ParcelaVendaListaUsoBase extends BaseListFragment implements IQuadroLista {

	public final static String ITEM_CLICK = "ParcelaVendaItemClick";

	private ParcelaVendaListUsoAdapterBase adapt = null;
	...
	protected void atualizaLista(List<ParcelaVenda> listaNova) {
	...
	*/
	...
	private void preencheLista() {
        ...
        DCLog.d(DCLog.SERVICO_QUADRO_LISTA, this, "getListaCorrente : List<ParcelaVenda> -> " + lista.size() + " itens (Adapter:" + adapt.getClass().getName() + ")");
        adapt.setRaiz(this);
        setListAdapter(adapt);
	}
	
	protected ParcelaVendaListUsoAdapterBase getAdapter(List<ParcelaVenda> lista,DigicomContexto dContexto) {
		return new ParcelaVendaListUsoAdapter(lista,dContexto);
	}
