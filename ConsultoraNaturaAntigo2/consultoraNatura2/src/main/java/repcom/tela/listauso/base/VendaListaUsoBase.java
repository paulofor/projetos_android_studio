...
import repcom.view.adapter.listauso.VendaListUsoAdapter;
...
public abstract class VendaListaUsoBase extends BaseListFragment implements IQuadroLista {

	public final static String ITEM_CLICK = "VendaItemClick";

	private VendaListUsoAdapterBase adapt = null;
	...
	protected void atualizaLista(List<Venda> listaNova) {
	...
	*/
	...
	private void preencheLista() {
        ...
        DCLog.d(DCLog.SERVICO_QUADRO_LISTA, this, "getListaCorrente : List<Venda> -> " + lista.size() + " itens (Adapter:" + adapt.getClass().getName() + ")");
        adapt.setRaiz(this);
        setListAdapter(adapt);
	}
	
	protected VendaListUsoAdapterBase getAdapter(List<Venda> lista,DigicomContexto dContexto) {
		return new VendaListUsoAdapter(lista,dContexto);
	}
