...
import repcom.view.adapter.listauso.CategoriaProdutoListUsoAdapter;
...
public abstract class CategoriaProdutoListaUsoBase extends BaseListFragment implements IQuadroLista {

	public final static String ITEM_CLICK = "CategoriaProdutoItemClick";

	private CategoriaProdutoListUsoAdapterBase adapt = null;
	private CategoriaProdutoServico servico = null;
	
		
	protected CategoriaProdutoServico getServico() {
		return servico;
	}
	...
	protected void atualizaLista(List<CategoriaProduto> listaNova) {
	...
	*/
	...
	private void preencheLista() {
        ...
        DCLog.d(DCLog.SERVICO_QUADRO_LISTA, this, "getListaCorrente : List<CategoriaProduto> -> " + lista.size() + " itens (Adapter:" + adapt.getClass().getName() + ")");
        adapt.setRaiz(this);
        setListAdapter(adapt);
	}
	
	protected CategoriaProdutoListUsoAdapterBase getAdapter(List<CategoriaProduto> lista,DigicomContexto dContexto) {
		return new CategoriaProdutoListUsoAdapter(lista,dContexto);
	}
