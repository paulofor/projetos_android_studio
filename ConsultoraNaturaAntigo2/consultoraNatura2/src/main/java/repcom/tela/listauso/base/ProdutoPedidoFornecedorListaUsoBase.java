...
import repcom.view.adapter.listauso.ProdutoPedidoFornecedorListUsoAdapter;
...
public abstract class ProdutoPedidoFornecedorListaUsoBase extends BaseListFragment implements IQuadroLista {

	public final static String ITEM_CLICK = "ProdutoPedidoFornecedorItemClick";

	private ProdutoPedidoFornecedorListUsoAdapterBase adapt = null;
	...
	protected void atualizaLista(List<ProdutoPedidoFornecedor> listaNova) {
	...
	*/
	...
	private void preencheLista() {
        ...
        DCLog.d(DCLog.SERVICO_QUADRO_LISTA, this, "getListaCorrente : List<ProdutoPedidoFornecedor> -> " + lista.size() + " itens (Adapter:" + adapt.getClass().getName() + ")");
        adapt.setRaiz(this);
        setListAdapter(adapt);
	}
	
	protected ProdutoPedidoFornecedorListUsoAdapterBase getAdapter(List<ProdutoPedidoFornecedor> lista,DigicomContexto dContexto) {
		return new ProdutoPedidoFornecedorListUsoAdapter(lista,dContexto);
	}
	
	protected List<ProdutoPedidoFornecedor> getListaCorrente(Context contexto,ProdutoPedidoFornecedorServico servico) {
		
		throw new UnsupportedOperationException("Fazer override de getListaCorrente em ProdutoPedidoFornecedorListaUso, trata-se de classe de relacionamento");
