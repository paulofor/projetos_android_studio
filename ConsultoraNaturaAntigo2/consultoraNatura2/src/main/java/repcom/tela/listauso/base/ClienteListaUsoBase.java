...
import repcom.view.adapter.listauso.ClienteListUsoAdapter;
...
public abstract class ClienteListaUsoBase extends BaseListFragment implements IQuadroLista {

	public final static String ITEM_CLICK = "ClienteItemClick";

	private ClienteListUsoAdapterBase adapt = null;
	...
	protected void atualizaLista(List<Cliente> listaNova) {
	...
	*/
	...
	private void preencheLista() {
        ...
        DCLog.d(DCLog.SERVICO_QUADRO_LISTA, this, "getListaCorrente : List<Cliente> -> " + lista.size() + " itens (Adapter:" + adapt.getClass().getName() + ")");
        adapt.setRaiz(this);
        setListAdapter(adapt);
	}
	
	protected ClienteListUsoAdapterBase getAdapter(List<Cliente> lista,DigicomContexto dContexto) {
		return new ClienteListUsoAdapter(lista,dContexto);
	}
