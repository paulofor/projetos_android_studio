...
import repcom.view.adapter.listauso.EstoqueListUsoAdapter;
...
public abstract class EstoqueListaUsoBase extends BaseListFragment implements IQuadroLista {

	public final static String ITEM_CLICK = "EstoqueItemClick";

	private EstoqueListUsoAdapterBase adapt = null;
	...
	protected void atualizaLista(List<Estoque> listaNova) {
	...
	*/
	...
	private void preencheLista() {
        ...
        List<Estoque> lista = getListaCorrente(dContexto.getContext(),servico);
        // Pode ser necessario um adapter customizado (diferenciar o editar e usar)
        adapt =  getAdapter(lista, dContexto);
        DCLog.d(DCLog.SERVICO_QUADRO_LISTA, this, "getListaCorrente : List<Estoque> -> " + lista.size() + " itens (Adapter:" + adapt.getClass().getName() + ")");
        adapt.setRaiz(this);
        setListAdapter(adapt);
	}
	
	protected EstoqueListUsoAdapterBase getAdapter(List<Estoque> lista,DigicomContexto dContexto) {
		return new EstoqueListUsoAdapter(lista,dContexto);
	}
