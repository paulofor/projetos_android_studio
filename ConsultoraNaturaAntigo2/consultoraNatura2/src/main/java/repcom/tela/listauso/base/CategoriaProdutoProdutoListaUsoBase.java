...
import repcom.view.adapter.listauso.CategoriaProdutoProdutoListUsoAdapter;
...
public abstract class CategoriaProdutoProdutoListaUsoBase extends BaseListFragment implements IQuadroLista {

	public final static String ITEM_CLICK = "CategoriaProdutoProdutoItemClick";

	private CategoriaProdutoProdutoListUsoAdapterBase adapt = null;
	...
	protected void atualizaLista(List<CategoriaProdutoProduto> listaNova) {
	...
	*/
	...
	private void preencheLista() {
        ...
        DCLog.d(DCLog.SERVICO_QUADRO_LISTA, this, "getListaCorrente : List<CategoriaProdutoProduto> -> " + lista.size() + " itens (Adapter:" + adapt.getClass().getName() + ")");
        adapt.setRaiz(this);
        setListAdapter(adapt);
	}
	
	protected CategoriaProdutoProdutoListUsoAdapterBase getAdapter(List<CategoriaProdutoProduto> lista,DigicomContexto dContexto) {
		return new CategoriaProdutoProdutoListUsoAdapter(lista,dContexto);
	}
	
	protected List<CategoriaProdutoProduto> getListaCorrente(Context contexto,CategoriaProdutoProdutoServico servico) {
		
		throw new UnsupportedOperationException("Fazer override de getListaCorrente em CategoriaProdutoProdutoListaUso, trata-se de classe de relacionamento");
