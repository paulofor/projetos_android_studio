...
import repcom.view.adapter.listaedicao.CategoriaProdutoListEdicaoAdapter;
...
public abstract class CategoriaProdutoListaEdicaoBase extends BaseListFragment implements IQuadroListaEdicao  
	{

	public final static String ITEM_CLICK = "CategoriaProdutoItemClick";

	private CategoriaProdutoListEdicaoAdapter adapt = null;
	private List<CategoriaProduto> lista = null;
	...
	public final void chamaCriaItem() {
		...
		nova = (CategoriaProduto) ((ServicoLocal)servico).atribuiUsuario(nova);
	...
	*/
	...
	protected IFragmentEdicao criaQuadroTrata() {
		throw new UnsupportedOperationException("Fazer override de criaQuadroTrata em CategoriaProdutoListaEdicao retornando new CategoriaProdutoQuadroTrata ou verificar se nao esta sendo chamada via super");
	}
	...
	private CategoriaProdutoListEdicaoAdapter getAdapter(List<CategoriaProduto> lista,DigicomContexto dContexto) {
		return new CategoriaProdutoListEdicaoAdapter(lista,this,dContexto.getContext());
	}
	...
	private CategoriaProduto insereObjetoPrincipal(CategoriaProduto item) {
