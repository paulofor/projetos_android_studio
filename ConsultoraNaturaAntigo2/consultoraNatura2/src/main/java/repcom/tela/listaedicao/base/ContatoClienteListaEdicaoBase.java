...
import repcom.view.adapter.listaedicao.ContatoClienteListEdicaoAdapter;
...
public abstract class ContatoClienteListaEdicaoBase extends BaseListFragment implements IQuadroListaEdicao  
	{

	public final static String ITEM_CLICK = "ContatoClienteItemClick";

	private ContatoClienteListEdicaoAdapter adapt = null;
	private List<ContatoCliente> lista = null;
	...
	public final void chamaCriaItem() {
		...
		nova = (ContatoCliente) ((ServicoLocal)servico).atribuiUsuario(nova);
	...
	*/
	...
	protected IFragmentEdicao criaQuadroTrata() {
		throw new UnsupportedOperationException("Fazer override de criaQuadroTrata em ContatoClienteListaEdicao retornando new ContatoClienteQuadroTrata ou verificar se nao esta sendo chamada via super");
	}
	...
	private ContatoClienteListEdicaoAdapter getAdapter(List<ContatoCliente> lista,DigicomContexto dContexto) {
		return new ContatoClienteListEdicaoAdapter(lista,this,dContexto.getContext());
	}
	...
	private ContatoCliente insereObjetoPrincipal(ContatoCliente item) {
	...
	protected List<ContatoCliente> getListaCorrente(Context contexto, ContatoClienteServico servico) {
		...
		if (cliente!=null) {
			listaSaida = servico.getPorReferenteACliente(contexto, cliente.getId());
		}
