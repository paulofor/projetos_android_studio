...
import repcom.view.adapter.ProdutoPedidoFornecedorListAdapter;
import repcom.view.adapter.listaedicao.ProdutoPedidoFornecedorListEdicaoAdapter;
...
public abstract class ProdutoPedidoFornecedorListaEdicaoBase extends BaseListFragment implements IQuadroListaEdicao  
	, DialogListListener {

	public final static String ITEM_CLICK = "ProdutoPedidoFornecedorItemClick";

	private ProdutoPedidoFornecedorListEdicaoAdapter adapt = null;
	private List<ProdutoPedidoFornecedor> lista = null;
	private Button btnCriaItem = null;
	
	private boolean salvaPreliminar = false;
	
	private ProdutoPedidoFornecedorServico servico = null;
	...
	protected ProdutoPedidoFornecedorServico getServico() {
		return servico;
	}
	
	@Override
	protected final void inicializaItensTelaBase() {
		btnCriaItem = (Button) getTela().findViewById(R.id.btnCriaProdutoPedidoFornecedor);
	}
	@Override
	...
	protected final void inicializaServicosBase() {
		servico = FabricaServico.getInstancia().getProdutoPedidoFornecedorServico(FabricaServico.TIPO_SQLITE);
	...
	protected ResourceObj getLayoutTela() {
		ResourceObj recurso = new ResourceObj(R.layout.lista_produto_pedido_fornecedor,"R.layout.lista_produto_pedido_fornecedor");
		return recurso;
	}
	...
	public final void chamaCriaItem() {
		...
		dialog.show(getActivity().getSupportFragmentManager(), "ListaProdutoPedidoFornecedorDialog");
	}
	...
	protected DialogListFragment criaDialog() {
		throw new UnsupportedOperationException("Fazer override de criaDialog em ProdutoPedidoFornecedorListaEdicao com return new ProdutoPedidoFornecedorQuadroTrata extends DialogListFragment");
	}
	...
	/*
	protected ProdutoPedidoFornecedor criaNova() {
		return servico.inicializaItemTela(getContext());
		//throw new UnsupportedOperationException("Fazer override de criaNova em ProdutoPedidoFornecedorQuadroLista retornando new ProdutoPedidoFornecedor com inicializa??o de listas internas se necessario");
	...
	*/
	...
	protected IFragmentEdicao criaQuadroTrata() {
		throw new UnsupportedOperationException("Fazer override de criaQuadroTrata em ProdutoPedidoFornecedorListaEdicao retornando new ProdutoPedidoFornecedorQuadroTrata ou verificar se nao esta sendo chamada via super");
	}
	...
	private void preencheLista() {
        ...
        ProdutoPedidoFornecedorServico servico = FabricaServico.getInstancia().getProdutoPedidoFornecedorServico(FabricaServico.TIPO_SQLITE);
        DigicomContexto dContexto = getContext();
        lista = getListaCorrente(dContexto.getContext(),servico);
        DCLog.d(DCLog.SERVICO_QUADRO_LISTA, this, "preencheLista : List<ProdutoPedidoFornecedor> -> " + lista.size() + " itens");
	...
	private ProdutoPedidoFornecedorListEdicaoAdapter getAdapter(List<ProdutoPedidoFornecedor> lista,DigicomContexto dContexto) {
		return new ProdutoPedidoFornecedorListEdicaoAdapter(lista,this,dContexto.getContext());
	}
	...
	protected PedidoFornecedor item1 = null;
	protected Produto item2 = null;
	public void setPedidoFornecedor(PedidoFornecedor valor) {
		item1 = valor;
	}
	public void setProduto(Produto valor) {
		item2 = valor;
	}
	protected List<ProdutoPedidoFornecedor> getListaCorrente(Context contexto, ProdutoPedidoFornecedorServico servico) {
		List<ProdutoPedidoFornecedor> listaSaida = null;
		if (item1==null && item2==null) {
			throw new QuadroException(this,"Precisa setar um dos objetos");
		}
		if (item1!=null) {
			listaSaida = servico.getPorAssociadaPedidoFornecedor(contexto, item1.getId());
		}
		if (item2!=null) {
			listaSaida = servico.getPorAssociadaProduto(contexto, item2.getId());
		}
		return listaSaida;
	}
	...
	private ProdutoPedidoFornecedor insereObjetoPrincipal(ProdutoPedidoFornecedor item) {
		return item;
	}
