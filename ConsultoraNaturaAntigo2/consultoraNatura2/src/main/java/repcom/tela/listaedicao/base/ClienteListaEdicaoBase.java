...
import repcom.view.adapter.listaedicao.ClienteListEdicaoAdapter;
...
public abstract class ClienteListaEdicaoBase extends BaseListFragment implements IQuadroListaEdicao  
	{

	public final static String ITEM_CLICK = "ClienteItemClick";

	private ClienteListEdicaoAdapter adapt = null;
	...
	protected ClienteServico getServico() {
		return servico;
	}
	...
	public final void chamaCriaItem() {
		...
		nova = (Cliente) ((ServicoLocal)servico).atribuiUsuario(nova);
	...
	*/
	...
	protected IFragmentEdicao criaQuadroTrata() {
		throw new UnsupportedOperationException("Fazer override de criaQuadroTrata em ClienteListaEdicao retornando new ClienteQuadroTrata ou verificar se nao esta sendo chamada via super");
	}
	...
	private ClienteListEdicaoAdapter getAdapter(List<Cliente> lista,DigicomContexto dContexto) {
		return new ClienteListEdicaoAdapter(lista,this,dContexto.getContext());
	}
	...
	private Cliente insereObjetoPrincipal(Cliente item) {
