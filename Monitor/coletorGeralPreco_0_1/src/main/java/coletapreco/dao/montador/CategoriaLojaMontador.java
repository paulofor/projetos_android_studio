...
public class CategoriaLojaMontador extends MontadorDaoBase implements MontadorDaoI{
	...
	public CategoriaLojaMontador(boolean sinc) {
		this.sinc = sinc;
	}
	public CategoriaLojaMontador() {
		this.sinc = false;
	}
