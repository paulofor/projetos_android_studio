...
public class ModeloProdutoProdutoMontador extends MontadorDaoBase implements MontadorDaoI{
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		...
		item = (ModeloProdutoProduto) entrada;item.setIdModeloProdutoProduto(getInt(c,pos++));
