...
public class PalavraProdutoMontador extends MontadorDaoBase implements MontadorDaoI{
	...
	public PalavraProdutoMontador(boolean sinc) {
		this.sinc = sinc;
	}
	public PalavraProdutoMontador() {
		this.sinc = false;
	}
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		...
		item = (PalavraProduto) entrada;item.setIdPalavraProduto(getInt(c,pos++));
		item.setIdPalavraRa(getInt(c,pos++));
