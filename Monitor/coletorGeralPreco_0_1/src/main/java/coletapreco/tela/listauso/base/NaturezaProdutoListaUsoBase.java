...
import coletapreco.view.adapter.listauso.NaturezaProdutoListUsoAdapter;
...
public abstract class NaturezaProdutoListaUsoBase extends BaseListFragment implements IQuadroLista {

	public final static String ITEM_CLICK = "NaturezaProdutoItemClick";

	private NaturezaProdutoListUsoAdapterBase adapt = null;
	...
	protected void atualizaLista(List<NaturezaProduto> listaNova) {
	...
	*/
	...
	private void preencheLista() {
        ...
        DCLog.d(DCLog.SERVICO_QUADRO_LISTA, this, "getListaCorrente : List<NaturezaProduto> -> " + lista.size() + " itens (Adapter:" + adapt.getClass().getName() + ")");
        adapt.setRaiz(this);
        setListAdapter(adapt);
	}
	
	protected NaturezaProdutoListUsoAdapterBase getAdapter(List<NaturezaProduto> lista,DigicomContexto dContexto) {
		return new NaturezaProdutoListUsoAdapter(lista,dContexto);
	}
