...
import coletapreco.view.adapter.listauso.LojaVirtualListUsoAdapter;
...
public abstract class LojaVirtualListaUsoBase extends BaseListFragment implements IQuadroLista {

	public final static String ITEM_CLICK = "LojaVirtualItemClick";

	private LojaVirtualListUsoAdapterBase adapt = null;
	...
	protected void atualizaLista(List<LojaVirtual> listaNova) {
	...
	*/
	...
	private void preencheLista() {
        ...
        DCLog.d(DCLog.SERVICO_QUADRO_LISTA, this, "getListaCorrente : List<LojaVirtual> -> " + lista.size() + " itens (Adapter:" + adapt.getClass().getName() + ")");
        adapt.setRaiz(this);
        setListAdapter(adapt);
	}
	
	protected LojaVirtualListUsoAdapterBase getAdapter(List<LojaVirtual> lista,DigicomContexto dContexto) {
		return new LojaVirtualListUsoAdapter(lista,dContexto);
	}
