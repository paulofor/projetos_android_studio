...
import coletapreco.view.adapter.listauso.ModeloProdutoProdutoListUsoAdapter;
...
public abstract class ModeloProdutoProdutoListaUsoBase extends BaseListFragment implements IQuadroLista {

	public final static String ITEM_CLICK = "ModeloProdutoProdutoItemClick";

	private ModeloProdutoProdutoListUsoAdapterBase adapt = null;
	...
	protected void atualizaLista(List<ModeloProdutoProduto> listaNova) {
	...
	*/
	...
	private void preencheLista() {
        ...
        DCLog.d(DCLog.SERVICO_QUADRO_LISTA, this, "getListaCorrente : List<ModeloProdutoProduto> -> " + lista.size() + " itens (Adapter:" + adapt.getClass().getName() + ")");
        adapt.setRaiz(this);
        setListAdapter(adapt);
	}
	
	protected ModeloProdutoProdutoListUsoAdapterBase getAdapter(List<ModeloProdutoProduto> lista,DigicomContexto dContexto) {
		return new ModeloProdutoProdutoListUsoAdapter(lista,dContexto);
	}
	
	protected List<ModeloProdutoProduto> getListaCorrente(Context contexto,ModeloProdutoProdutoServico servico) {
		
		throw new UnsupportedOperationException("Fazer override de getListaCorrente em ModeloProdutoProdutoListaUso, trata-se de classe de relacionamento");
