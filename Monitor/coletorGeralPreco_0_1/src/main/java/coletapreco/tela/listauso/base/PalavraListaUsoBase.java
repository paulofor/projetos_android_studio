...
import coletapreco.view.adapter.listauso.PalavraListUsoAdapter;
...
public abstract class PalavraListaUsoBase extends BaseListFragment implements IQuadroLista {

	public final static String ITEM_CLICK = "PalavraItemClick";

	private PalavraListUsoAdapterBase adapt = null;
	...
	protected void atualizaLista(List<Palavra> listaNova) {
	...
	*/
	...
	private void preencheLista() {
        ...
        DCLog.d(DCLog.SERVICO_QUADRO_LISTA, this, "getListaCorrente : List<Palavra> -> " + lista.size() + " itens (Adapter:" + adapt.getClass().getName() + ")");
        adapt.setRaiz(this);
        setListAdapter(adapt);
	}
	
	protected PalavraListUsoAdapterBase getAdapter(List<Palavra> lista,DigicomContexto dContexto) {
		return new PalavraListUsoAdapter(lista,dContexto);
	}
