...
import coletapreco.view.adapter.listauso.MarcaListUsoAdapter;
...
public abstract class MarcaListaUsoBase extends BaseListFragment implements IQuadroLista {

	public final static String ITEM_CLICK = "MarcaItemClick";

	private MarcaListUsoAdapterBase adapt = null;
	...
	protected void atualizaLista(List<Marca> listaNova) {
	...
	*/
	...
	private void preencheLista() {
        ...
        List<Marca> lista = getListaCorrente(dContexto.getContext(),servico);
        // Pode ser necessario um adapter customizado (diferenciar o editar e usar)
        adapt =  getAdapter(lista, dContexto);
        DCLog.d(DCLog.SERVICO_QUADRO_LISTA, this, "getListaCorrente : List<Marca> -> " + lista.size() + " itens (Adapter:" + adapt.getClass().getName() + ")");
        adapt.setRaiz(this);
        setListAdapter(adapt);
	}
	
	protected MarcaListUsoAdapterBase getAdapter(List<Marca> lista,DigicomContexto dContexto) {
		return new MarcaListUsoAdapter(lista,dContexto);
	}
