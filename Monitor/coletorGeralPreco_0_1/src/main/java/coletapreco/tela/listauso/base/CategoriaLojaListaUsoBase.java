...
import coletapreco.view.adapter.listauso.CategoriaLojaListUsoAdapter;
...
public abstract class CategoriaLojaListaUsoBase extends BaseListFragment implements IQuadroLista {

	public final static String ITEM_CLICK = "CategoriaLojaItemClick";

	private CategoriaLojaListUsoAdapterBase adapt = null;
	private CategoriaLojaServico servico = null;
		
	protected CategoriaLojaServico getServico() {
		return servico;
	}
	...
	protected void atualizaLista(List<CategoriaLoja> listaNova) {
	...
	*/
	...
	private void preencheLista() {
        ...
        DCLog.d(DCLog.SERVICO_QUADRO_LISTA, this, "getListaCorrente : List<CategoriaLoja> -> " + lista.size() + " itens (Adapter:" + adapt.getClass().getName() + ")");
        adapt.setRaiz(this);
        setListAdapter(adapt);
	}
	
	protected CategoriaLojaListUsoAdapterBase getAdapter(List<CategoriaLoja> lista,DigicomContexto dContexto) {
		return new CategoriaLojaListUsoAdapter(lista,dContexto);
	}
