...
import coletapreco.view.adapter.listauso.UsuarioPesquisaListUsoAdapter;
...
public abstract class UsuarioPesquisaListaUsoBase extends BaseListFragment implements IQuadroLista {

	public final static String ITEM_CLICK = "UsuarioPesquisaItemClick";

	private UsuarioPesquisaListUsoAdapterBase adapt = null;
	...
	protected void atualizaLista(List<UsuarioPesquisa> listaNova) {
	...
	*/
	...
	private void preencheLista() {
        ...
        DCLog.d(DCLog.SERVICO_QUADRO_LISTA, this, "getListaCorrente : List<UsuarioPesquisa> -> " + lista.size() + " itens (Adapter:" + adapt.getClass().getName() + ")");
        adapt.setRaiz(this);
        setListAdapter(adapt);
	}
	
	protected UsuarioPesquisaListUsoAdapterBase getAdapter(List<UsuarioPesquisa> lista,DigicomContexto dContexto) {
		return new UsuarioPesquisaListUsoAdapter(lista,dContexto);
	}
