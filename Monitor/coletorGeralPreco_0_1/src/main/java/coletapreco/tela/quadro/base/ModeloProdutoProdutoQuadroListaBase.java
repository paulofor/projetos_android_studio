...
public abstract class ModeloProdutoProdutoQuadroListaBase extends BaseListFragment implements IQuadroListaEdicao {

	public final static String ITEM_CLICK = "ModeloProdutoProdutoItemClick";

	ModeloProdutoProdutoListAdapter adapt = null;
	private Button btnCriaItem = null;
	
	ModeloProdutoProdutoServico servico = null;
	...
	public final void chamaCriaItem() {
		IFragmentEdicao quadro = criaQuadroTrata();
		//ModeloProdutoProduto nova = servico.inicializaItemTela(getContext());
		ModeloProdutoProduto nova = FabricaVo.criaModeloProdutoProduto();
	...
	protected IFragmentEdicao criaQuadroTrata() {
		throw new UnsupportedOperationException("Fazer override de criaQuadroTrata em ModeloProdutoProdutoQuadroLista retornando new ModeloProdutoProdutoQuadroTrata ou verificar se nao esta sendo chamada via super");
	}
	...
	private void preencheLista() {
        ...
        List<ModeloProdutoProduto> lista = getListaCorrente(dContexto.getContext(),servico);
	...
	protected ModeloProdutoProdutoListAdapter getAdapter(List<ModeloProdutoProduto> lista,DigicomContexto dContexto) {
		return new ModeloProdutoProdutoListAdapter(lista,dContexto.getContext());
	}
	
	protected List<ModeloProdutoProduto> getListaCorrente(Context contexto,ModeloProdutoProdutoServico servico) {
		List<ModeloProdutoProduto> saida = servico.getAllTela(contexto);
		return saida;
	}
