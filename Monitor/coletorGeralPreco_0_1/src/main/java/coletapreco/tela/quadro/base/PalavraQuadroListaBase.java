...
public abstract class PalavraQuadroListaBase extends BaseListFragment implements IQuadroListaEdicao {

	public final static String ITEM_CLICK = "PalavraItemClick";

	PalavraListAdapter adapt = null;
	private Button btnCriaItem = null;
	
	PalavraServico servico = null;
	...
	protected IFragmentEdicao criaQuadroTrata() {
		throw new UnsupportedOperationException("Fazer override de criaQuadroTrata em PalavraQuadroLista retornando new PalavraQuadroTrata ou verificar se nao esta sendo chamada via super");
	}
	...
	private void preencheLista() {
        ...
        List<Palavra> lista = getListaCorrente(dContexto.getContext(),servico);
	...
	protected PalavraListAdapter getAdapter(List<Palavra> lista,DigicomContexto dContexto) {
		return new PalavraListAdapter(lista,dContexto.getContext());
	}
