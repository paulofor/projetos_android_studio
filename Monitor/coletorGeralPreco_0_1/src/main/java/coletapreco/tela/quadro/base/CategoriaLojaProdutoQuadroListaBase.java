...
public abstract class CategoriaLojaProdutoQuadroListaBase extends BaseListFragment implements IQuadroListaEdicao {

	public final static String ITEM_CLICK = "CategoriaLojaProdutoItemClick";

	CategoriaLojaProdutoListAdapter adapt = null;
	private Button btnCriaItem = null;
	
	CategoriaLojaProdutoServico servico = null;
	...
	protected IFragmentEdicao criaQuadroTrata() {
		throw new UnsupportedOperationException("Fazer override de criaQuadroTrata em CategoriaLojaProdutoQuadroLista retornando new CategoriaLojaProdutoQuadroTrata ou verificar se nao esta sendo chamada via super");
	}
	...
	protected CategoriaLojaProdutoListAdapter getAdapter(List<CategoriaLojaProduto> lista,DigicomContexto dContexto) {
		return new CategoriaLojaProdutoListAdapter(lista,dContexto.getContext());
	}
	
	protected List<CategoriaLojaProduto> getListaCorrente(Context contexto,CategoriaLojaProdutoServico servico) {
		List<CategoriaLojaProduto> saida = servico.getAllTela(contexto);
		return saida;
	}
