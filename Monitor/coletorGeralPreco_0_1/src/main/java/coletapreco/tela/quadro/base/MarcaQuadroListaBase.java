...
public abstract class MarcaQuadroListaBase extends BaseListFragment implements IQuadroListaEdicao {

	public final static String ITEM_CLICK = "MarcaItemClick";

	MarcaListAdapter adapt = null;
	private Button btnCriaItem = null;
	
	MarcaServico servico = null;
	...
	protected IFragmentEdicao criaQuadroTrata() {
		throw new UnsupportedOperationException("Fazer override de criaQuadroTrata em MarcaQuadroLista retornando new MarcaQuadroTrata ou verificar se nao esta sendo chamada via super");
	}
	...
	protected MarcaListAdapter getAdapter(List<Marca> lista,DigicomContexto dContexto) {
		return new MarcaListAdapter(lista,dContexto.getContext());
	}
