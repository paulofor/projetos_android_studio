...
public abstract class ModeloProdutoQuadroListaBase extends BaseListFragment implements IQuadroListaEdicao {

	public final static String ITEM_CLICK = "ModeloProdutoItemClick";

	ModeloProdutoListAdapter adapt = null;
	private Button btnCriaItem = null;
	
	ModeloProdutoServico servico = null;
	...
	protected IFragmentEdicao criaQuadroTrata() {
		throw new UnsupportedOperationException("Fazer override de criaQuadroTrata em ModeloProdutoQuadroLista retornando new ModeloProdutoQuadroTrata ou verificar se nao esta sendo chamada via super");
	}
	...
	protected ModeloProdutoListAdapter getAdapter(List<ModeloProduto> lista,DigicomContexto dContexto) {
		return new ModeloProdutoListAdapter(lista,dContexto.getContext());
	}
