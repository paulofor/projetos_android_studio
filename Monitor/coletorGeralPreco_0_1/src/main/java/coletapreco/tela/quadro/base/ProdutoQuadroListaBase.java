...
public abstract class ProdutoQuadroListaBase extends BaseListFragment implements IQuadroListaEdicao {

	public final static String ITEM_CLICK = "ProdutoItemClick";

	ProdutoListAdapter adapt = null;
	...
	protected IFragmentEdicao criaQuadroTrata() {
		throw new UnsupportedOperationException("Fazer override de criaQuadroTrata em ProdutoQuadroLista retornando new ProdutoQuadroTrata ou verificar se nao esta sendo chamada via super");
	}
	...
	protected ProdutoListAdapter getAdapter(List<Produto> lista,DigicomContexto dContexto) {
		return new ProdutoListAdapter(lista,dContexto.getContext());
	}
