...
public abstract class UsuarioPesquisaQuadroListaBase extends BaseListFragment implements IQuadroListaEdicao {

	public final static String ITEM_CLICK = "UsuarioPesquisaItemClick";

	UsuarioPesquisaListAdapter adapt = null;
	private Button btnCriaItem = null;
	
	UsuarioPesquisaServico servico = null;
	...
	protected IFragmentEdicao criaQuadroTrata() {
		throw new UnsupportedOperationException("Fazer override de criaQuadroTrata em UsuarioPesquisaQuadroLista retornando new UsuarioPesquisaQuadroTrata ou verificar se nao esta sendo chamada via super");
	}
	...
	private void preencheLista() {
        ...
        List<UsuarioPesquisa> lista = getListaCorrente(dContexto.getContext(),servico);
	...
	protected UsuarioPesquisaListAdapter getAdapter(List<UsuarioPesquisa> lista,DigicomContexto dContexto) {
		return new UsuarioPesquisaListAdapter(lista,dContexto.getContext());
	}
