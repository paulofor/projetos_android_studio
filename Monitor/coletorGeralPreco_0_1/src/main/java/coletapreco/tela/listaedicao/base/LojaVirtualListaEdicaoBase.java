...
import coletapreco.view.adapter.listaedicao.LojaVirtualListEdicaoAdapter;
...
public abstract class LojaVirtualListaEdicaoBase extends BaseListFragment implements IQuadroListaEdicao  
	{

	public final static String ITEM_CLICK = "LojaVirtualItemClick";

	private LojaVirtualListEdicaoAdapter adapt = null;
	private List<LojaVirtual> lista = null;
	private Button btnCriaItem = null;
	
	private boolean salvaPreliminar = false;
	
	private LojaVirtualServico servico = null;
	...
	protected LojaVirtualServico getServico() {
		return servico;
	}
	...
	public final void chamaCriaItem() {
		...
		nova = (LojaVirtual) ((ServicoLocal)servico).atribuiUsuario(nova);
	...
	*/
	...
	protected IFragmentEdicao criaQuadroTrata() {
		throw new UnsupportedOperationException("Fazer override de criaQuadroTrata em LojaVirtualListaEdicao retornando new LojaVirtualQuadroTrata ou verificar se nao esta sendo chamada via super");
	}
	...
	private LojaVirtualListEdicaoAdapter getAdapter(List<LojaVirtual> lista,DigicomContexto dContexto) {
		return new LojaVirtualListEdicaoAdapter(lista,this,dContexto.getContext());
	}
	...
	private LojaVirtual insereObjetoPrincipal(LojaVirtual item) {
