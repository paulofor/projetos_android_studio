...
public abstract class OportunidadeDiaQuadroTrataBase extends BaseDialogFragment implements IFragmentEdicao {
	...
	protected OportunidadeDiaAgregadoI getItem() {
		return (OportunidadeDiaAgregadoI) item;
	}

	
	
	public void setItem(DCIObjetoDominio item) {
		this.item = (OportunidadeDia) item;
	...
	protected void setOnOk(View tela) {
		Button btn = (Button) tela.findViewById(R.id.btnOkTrataOportunidadeDia);
		btn.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				if (!alteracao && !insercao) {
					throw new UnsupportedOperationException("Nao foi selecionado nem alteracao nem insercao para OportunidadeDiaQuadroTrata");
				} else {
					if (item==null) {
						throw new UnsupportedOperationException("Item com valor null em OportunidadeDiaQuadroTrataBase");
					}
	...
	//	throw new RuntimeException("Implementar validaCamposTela de OportunidadeDiaQuadroTrataBase");
	//}
	...
	protected final void alteraItem(OportunidadeDia valor) {
		OportunidadeDiaServico exibicaoSrv = FabricaServico.getInstancia().getOportunidadeDiaServico(FabricaServico.TIPO_SQLITE);
		//View saida = LayoutInflater.from(getActivity()).inflate(R.layout.trata_oportunidade_dia, null);
	...
	// outro quadro
	protected final void insereItem(OportunidadeDia valor) {
		OportunidadeDiaServico exibicaoSrv = FabricaServico.getInstancia().getOportunidadeDiaServico(FabricaServico.TIPO_SQLITE);
		//View saida = LayoutInflater.from(getActivity()).inflate(R.layout.trata_oportunidade_dia, null);
		transfereTelaParaVo(valor);
	...
	protected void transfereTelaParaVo(OportunidadeDia vo)  {
		throw new UnsupportedOperationException("Fazer override de transfereTelaParaVo em OportunidadeDiaQuadroTrata ou verificar se nao esta sendo chamada via super");
	}
	protected void transfereVoParaTela(final OportunidadeDia vo)  {
		throw new UnsupportedOperationException("Fazer override de transfereVoParaTela em OportunidadeDiaQuadroTrata ou verificar se nao esta sendo chamada via super");
	}
	...
	protected ResourceObj getLayoutTela() {
		ResourceObj recurso = new ResourceObj(R.layout.trata_oportunidade_dia,"R.layout.trata_oportunidade_dia");
		return recurso;
	}
	...
	protected final void inicializaItensTelaBase() {
		if (item==null) {
			...
			item = FabricaVo.criaOportunidadeDia();
