...
public abstract class LojaVirtualQuadroTrataBase extends BaseDialogFragment implements IFragmentEdicao {
	...
	protected LojaVirtualAgregadoI getItem() {
		return (LojaVirtualAgregadoI) item;
	}

	
	
	public void setItem(DCIObjetoDominio item) {
		this.item = (LojaVirtual) item;
	...
	protected void setOnOk(View tela) {
		Button btn = (Button) tela.findViewById(R.id.btnOkTrataLojaVirtual);
		btn.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				if (!alteracao && !insercao) {
					throw new UnsupportedOperationException("Nao foi selecionado nem alteracao nem insercao para LojaVirtualQuadroTrata");
				} else {
					if (item==null) {
						throw new UnsupportedOperationException("Item com valor null em LojaVirtualQuadroTrataBase");
					}
	...
	//	throw new RuntimeException("Implementar validaCamposTela de LojaVirtualQuadroTrataBase");
	//}
	...
	protected final void alteraItem(LojaVirtual valor) {
		LojaVirtualServico exibicaoSrv = FabricaServico.getInstancia().getLojaVirtualServico(FabricaServico.TIPO_SQLITE);
		//View saida = LayoutInflater.from(getActivity()).inflate(R.layout.trata_loja_virtual, null);
	...
	// outro quadro
	protected final void insereItem(LojaVirtual valor) {
		LojaVirtualServico exibicaoSrv = FabricaServico.getInstancia().getLojaVirtualServico(FabricaServico.TIPO_SQLITE);
		//View saida = LayoutInflater.from(getActivity()).inflate(R.layout.trata_loja_virtual, null);
		transfereTelaParaVo(valor);
	...
	protected void transfereTelaParaVo(LojaVirtual vo)  {
		throw new UnsupportedOperationException("Fazer override de transfereTelaParaVo em LojaVirtualQuadroTrata ou verificar se nao esta sendo chamada via super");
	}
	protected void transfereVoParaTela(final LojaVirtual vo)  {
		throw new UnsupportedOperationException("Fazer override de transfereVoParaTela em LojaVirtualQuadroTrata ou verificar se nao esta sendo chamada via super");
	}
	...
	protected ResourceObj getLayoutTela() {
		ResourceObj recurso = new ResourceObj(R.layout.trata_loja_virtual,"R.layout.trata_loja_virtual");
		return recurso;
	}
	...
	protected final void inicializaItensTelaBase() {
		if (item==null) {
			...
			item = FabricaVo.criaLojaVirtual();
