...
// classes de UI
public abstract class UsuarioPesquisaViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public UsuarioPesquisaViewBase(Context context, UsuarioPesquisa item) {
		throw new UnsupportedOperationException("Usar o construtor novo de UsuarioPesquisaView");
	}
	@Override
	...
	public UsuarioPesquisaViewBase(UsuarioPesquisa item) {
		super();
		this.item = item;
	...
	protected int getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_usuario_pesquisa ou similar");
	}
