...
// classes de UI
public abstract class LojaVirtualViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public LojaVirtualViewBase(Context context, LojaVirtual item) {
		throw new UnsupportedOperationException("Usar o construtor novo de LojaVirtualView");
	}
	@Override
	...
	public LojaVirtualViewBase(LojaVirtual item) {
		super();
		this.item = item;
	...
	protected int getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_loja_virtual ou similar");
	}
