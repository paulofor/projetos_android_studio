...
// classes de UI
public abstract class CategoriaLojaProdutoViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public CategoriaLojaProdutoViewBase(Context context, CategoriaLojaProduto item) {
		throw new UnsupportedOperationException("Usar o construtor novo de CategoriaLojaProdutoView");
	}
	@Override
	...
	private CategoriaLojaProduto item;
	
	protected CategoriaLojaProduto getItem() {
	...
	public CategoriaLojaProdutoViewBase(CategoriaLojaProduto item) {
		super();
		this.item = item;
	...
	protected int getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_categoria_loja_produto ou similar");
	}
