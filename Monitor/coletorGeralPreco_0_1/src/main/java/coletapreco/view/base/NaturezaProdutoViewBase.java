...
// classes de UI
public abstract class NaturezaProdutoViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public NaturezaProdutoViewBase(Context context, NaturezaProduto item) {
		throw new UnsupportedOperationException("Usar o construtor novo de NaturezaProdutoView");
	}
	@Override
	...
	public NaturezaProdutoViewBase(NaturezaProduto item) {
		super();
		this.item = item;
	...
	protected int getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_natureza_produto ou similar");
	}
