...
// classes de UI
public abstract class CategoriaLojaViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public CategoriaLojaViewBase(Context context, CategoriaLoja item) {
		throw new UnsupportedOperationException("Usar o construtor novo de CategoriaLojaView");
	}
	@Override
	...
	private CategoriaLoja item;
	
	protected CategoriaLoja getItem() {
	...
	public CategoriaLojaViewBase(CategoriaLoja item) {
		super();
		this.item = item;
	...
	protected int getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_categoria_loja ou similar");
	}
