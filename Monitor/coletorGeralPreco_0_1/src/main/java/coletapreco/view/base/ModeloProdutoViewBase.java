...
// classes de UI
public abstract class ModeloProdutoViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public ModeloProdutoViewBase(Context context, ModeloProduto item) {
		throw new UnsupportedOperationException("Usar o construtor novo de ModeloProdutoView");
	}
	@Override
	...
	public ModeloProdutoViewBase(ModeloProduto item) {
		super();
		this.item = item;
	...
	protected int getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_modelo_produto ou similar");
	}
