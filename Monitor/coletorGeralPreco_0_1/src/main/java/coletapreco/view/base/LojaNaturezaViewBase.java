...
// classes de UI
public abstract class LojaNaturezaViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public LojaNaturezaViewBase(Context context, LojaNatureza item) {
		throw new UnsupportedOperationException("Usar o construtor novo de LojaNaturezaView");
	}
	@Override
	...
	private LojaNatureza item;
	
	protected LojaNatureza getItem() {
	...
	public LojaNaturezaViewBase(LojaNatureza item) {
		super();
		this.item = item;
	...
	protected int getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_loja_natureza ou similar");
	}
