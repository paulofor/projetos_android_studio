...
// classes de UI
public abstract class PalavraViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public PalavraViewBase(Context context, Palavra item) {
		throw new UnsupportedOperationException("Usar o construtor novo de PalavraView");
	}
	@Override
	...
	private Palavra item;
	
	protected Palavra getItem() {
	...
	public PalavraViewBase(Palavra item) {
		super();
		this.item = item;
	...
	protected int getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_palavra ou similar");
	}
