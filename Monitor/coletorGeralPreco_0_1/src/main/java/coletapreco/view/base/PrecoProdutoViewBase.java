...
// classes de UI
public abstract class PrecoProdutoViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public PrecoProdutoViewBase(Context context, PrecoProduto item) {
		throw new UnsupportedOperationException("Usar o construtor novo de PrecoProdutoView");
	}
	@Override
	...
	public PrecoProdutoViewBase(PrecoProduto item) {
		super();
		this.item = item;
	...
	protected int getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_preco_produto ou similar");
	}
