...
// classes de UI
public abstract class OportunidadeDiaViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public OportunidadeDiaViewBase(Context context, OportunidadeDia item) {
		throw new UnsupportedOperationException("Usar o construtor novo de OportunidadeDiaView");
	}
	@Override
	...
	public OportunidadeDiaViewBase(OportunidadeDia item) {
		super();
		this.item = item;
	...
	protected int getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_oportunidade_dia ou similar");
	}
