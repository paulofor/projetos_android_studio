...
// classes de UI
public abstract class PalavraProdutoViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public PalavraProdutoViewBase(Context context, PalavraProduto item) {
		throw new UnsupportedOperationException("Usar o construtor novo de PalavraProdutoView");
	}
	@Override
	...
	private PalavraProduto item;
	
	protected PalavraProduto getItem() {
	...
	public PalavraProdutoViewBase(PalavraProduto item) {
		super();
		this.item = item;
	...
	protected int getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_palavra_produto ou similar");
	}
