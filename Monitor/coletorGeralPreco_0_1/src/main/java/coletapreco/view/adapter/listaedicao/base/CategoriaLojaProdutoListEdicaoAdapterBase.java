...
public abstract class CategoriaLojaProdutoListEdicaoAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public CategoriaLojaProdutoListEdicaoAdapterBase(List<CategoriaLojaProduto> lista, IQuadroListaEdicao origem, Context context ) {
...
*/
	...
	protected int getLayout() {
		return R.layout.item_categoria_loja_produto;
	}
