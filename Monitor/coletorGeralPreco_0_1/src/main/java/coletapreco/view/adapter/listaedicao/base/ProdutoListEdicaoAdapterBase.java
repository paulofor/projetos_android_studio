...
public abstract class ProdutoListEdicaoAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public ProdutoListEdicaoAdapterBase(List<Produto> lista, IQuadroListaEdicao origem, Context context ) {
