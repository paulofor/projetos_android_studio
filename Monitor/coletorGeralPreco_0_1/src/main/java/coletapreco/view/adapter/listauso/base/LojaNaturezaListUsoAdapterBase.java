...
import coletapreco.view.LojaNaturezaView;
import br.com.digicom.layout.ItemLista;
import br.com.digicom.quadro.IQuadroLista;
import br.com.digicom.quadro.IFragment;
import br.com.digicom.activity.DigicomContexto;
import br.com.digicom.layout.ResourceObj;
import coletapreco.tela.quadro.base.LojaNaturezaQuadroListaBase;

public abstract class LojaNaturezaListUsoAdapterBase extends BaseAdapter {
	
	private DigicomContexto context;
	private List<LojaNatureza> lista;
	...
	public LojaNaturezaListUsoAdapterBase(List<LojaNatureza> lista, DigicomContexto context ) {
		this.context = context;
		this.lista = lista;
		setEdicao(); // Forcando para fazer edicao - alterar se for necessario depois.
	}
	
	public void setListaNova(List<LojaNatureza> listaNova) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		LojaNatureza item = lista.get(position);
		...
		if (!(saida instanceof ItemLista))
			throw new RuntimeException("Alterar layout raiz de item_loja_natureza.xml para br.com.digicom.layout.ItemLista");
	...
	protected void montaItemLista(int position, LojaNatureza item, View saida) {
		throw new UnsupportedOperationException("Fazer override de montaItemLista em "  + this.getClass().getSimpleName() + " ou verificar se nao esta sendo chamada via super. Arquivo de visao padrao eh: R.layout.item_loja_natureza");
	}
	protected ResourceObj getLayoutItem() {
		return new ResourceObj(R.layout.item_loja_natureza,"R.layout.item_loja_natureza");
	}
	/*
	@Override
	public boolean onTouch(View view, MotionEvent avent) {
	 	ItemLista objeto = (ItemLista) view;
		LojaNatureza item = (LojaNatureza) objeto.getItem();
