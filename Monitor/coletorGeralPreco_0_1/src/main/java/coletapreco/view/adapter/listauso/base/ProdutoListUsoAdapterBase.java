...
import coletapreco.view.ProdutoView;
import br.com.digicom.layout.ItemLista;
import br.com.digicom.quadro.IQuadroLista;
import br.com.digicom.quadro.IFragment;
import br.com.digicom.activity.DigicomContexto;
import br.com.digicom.layout.ResourceObj;
import coletapreco.tela.quadro.base.ProdutoQuadroListaBase;

public abstract class ProdutoListUsoAdapterBase extends BaseAdapter {
	...
	public ProdutoListUsoAdapterBase(List<Produto> lista, DigicomContexto context ) {
		this.context = context;
		this.lista = lista;
		setEdicao(); // Forcando para fazer edicao - alterar se for necessario depois.
	}
	
	public void setListaNova(List<Produto> listaNova) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (!(saida instanceof ItemLista))
			throw new RuntimeException("Alterar layout raiz de item_produto.xml para br.com.digicom.layout.ItemLista");
	...
	protected void montaItemLista(int position, Produto item, View saida) {
		throw new UnsupportedOperationException("Fazer override de montaItemLista em "  + this.getClass().getSimpleName() + " ou verificar se nao esta sendo chamada via super. Arquivo de visao padrao eh: R.layout.item_produto");
	}
	protected ResourceObj getLayoutItem() {
		return new ResourceObj(R.layout.item_produto,"R.layout.item_produto");
	}
	/*
	@Override
	public boolean onTouch(View view, MotionEvent avent) {
	 	ItemLista objeto = (ItemLista) view;
		Produto item = (Produto) objeto.getItem();
