...
public abstract class OportunidadeDiaListAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public OportunidadeDiaListAdapterBase(List<OportunidadeDia> lista, Context context ) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View saida = LayoutInflater.from(context).inflate(R.layout.item_oportunidade_dia, null);
