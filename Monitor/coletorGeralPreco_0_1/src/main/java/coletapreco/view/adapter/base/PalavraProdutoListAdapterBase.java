...
public abstract class PalavraProdutoListAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public PalavraProdutoListAdapterBase(List<PalavraProduto> lista, Context context ) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View saida = LayoutInflater.from(context).inflate(R.layout.item_palavra_produto, null);
	...
	protected void montaItemLista(int posicao, PalavraProduto item, View saida) {
