...
public abstract class LojaVirtualListAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public LojaVirtualListAdapterBase(List<LojaVirtual> lista, Context context ) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View saida = LayoutInflater.from(context).inflate(R.layout.item_loja_virtual, null);
	...
	protected void montaItemLista(int posicao, LojaVirtual item, View saida) {
