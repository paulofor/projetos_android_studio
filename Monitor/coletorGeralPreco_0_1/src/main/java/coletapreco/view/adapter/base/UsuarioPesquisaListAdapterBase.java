...
public abstract class UsuarioPesquisaListAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public UsuarioPesquisaListAdapterBase(List<UsuarioPesquisa> lista, Context context ) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View saida = LayoutInflater.from(context).inflate(R.layout.item_usuario_pesquisa, null);
	...
	protected void montaItemLista(int posicao, UsuarioPesquisa item, View saida) {
