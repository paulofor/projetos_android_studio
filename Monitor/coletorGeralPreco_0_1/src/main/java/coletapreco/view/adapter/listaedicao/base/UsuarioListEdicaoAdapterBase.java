...
public abstract class UsuarioListEdicaoAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public UsuarioListEdicaoAdapterBase(List<Usuario> lista, IQuadroListaEdicao origem, Context context ) {
