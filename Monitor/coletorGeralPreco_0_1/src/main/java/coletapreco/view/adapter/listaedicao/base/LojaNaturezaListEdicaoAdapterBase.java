...
public abstract class LojaNaturezaListEdicaoAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public LojaNaturezaListEdicaoAdapterBase(List<LojaNatureza> lista, IQuadroListaEdicao origem, Context context ) {
...
*/
	...
	protected int getLayout() {
		return R.layout.item_loja_natureza;
	}
