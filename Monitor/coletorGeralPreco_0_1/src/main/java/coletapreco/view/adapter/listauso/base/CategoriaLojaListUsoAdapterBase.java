...
public abstract class CategoriaLojaListUsoAdapterBase extends BaseAdapter {
	...
	public CategoriaLojaListUsoAdapterBase(List<CategoriaLoja> lista, DigicomContexto context ) {
		this.context = context;
		this.lista = lista;
		setEdicao(); // Forcando para fazer edicao - alterar se for necessario depois.
	}
	
	public void setListaNova(List<CategoriaLoja> listaNova) {
	...
	protected void montaItemLista(int position, CategoriaLoja item, View saida) {
	...
	protected ResourceObj getLayoutItem() {
		return new ResourceObj(R.layout.item_categoria_loja,"R.layout.item_categoria_loja");
	}
	/*
	@Override
