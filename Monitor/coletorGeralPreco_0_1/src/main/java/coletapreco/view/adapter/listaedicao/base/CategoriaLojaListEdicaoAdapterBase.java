...
public abstract class CategoriaLojaListEdicaoAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public CategoriaLojaListEdicaoAdapterBase(List<CategoriaLoja> lista, IQuadroListaEdicao origem, Context context ) {
...
*/
	...
	protected int getLayout() {
		return R.layout.item_categoria_loja;
	}
