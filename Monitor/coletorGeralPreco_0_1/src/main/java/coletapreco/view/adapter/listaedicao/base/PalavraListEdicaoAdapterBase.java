...
public abstract class PalavraListEdicaoAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public PalavraListEdicaoAdapterBase(List<Palavra> lista, IQuadroListaEdicao origem, Context context ) {
