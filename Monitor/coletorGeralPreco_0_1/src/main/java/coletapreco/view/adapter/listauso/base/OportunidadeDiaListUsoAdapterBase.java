...
public abstract class OportunidadeDiaListUsoAdapterBase extends BaseAdapter {
	...
	public OportunidadeDiaListUsoAdapterBase(List<OportunidadeDia> lista, DigicomContexto context ) {
		this.context = context;
		this.lista = lista;
		setEdicao(); // Forcando para fazer edicao - alterar se for necessario depois.
	}
	
	public void setListaNova(List<OportunidadeDia> listaNova) {
