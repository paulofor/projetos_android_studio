...
public abstract class PalavraProdutoListEdicaoAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public PalavraProdutoListEdicaoAdapterBase(List<PalavraProduto> lista, IQuadroListaEdicao origem, Context context ) {
...
*/
	...
	protected int getLayout() {
		return R.layout.item_palavra_produto;
	}
