...
public abstract class PalavraListAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public PalavraListAdapterBase(List<Palavra> lista, Context context ) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View saida = LayoutInflater.from(context).inflate(R.layout.item_palavra, null);
	...
	protected void montaItemLista(int posicao, Palavra item, View saida) {
