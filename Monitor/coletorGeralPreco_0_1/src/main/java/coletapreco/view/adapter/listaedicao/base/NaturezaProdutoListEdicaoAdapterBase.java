...
public abstract class NaturezaProdutoListEdicaoAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public NaturezaProdutoListEdicaoAdapterBase(List<NaturezaProduto> lista, IQuadroListaEdicao origem, Context context ) {
