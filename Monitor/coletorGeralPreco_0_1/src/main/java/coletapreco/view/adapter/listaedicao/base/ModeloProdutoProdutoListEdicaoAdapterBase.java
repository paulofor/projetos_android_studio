...
public abstract class ModeloProdutoProdutoListEdicaoAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public ModeloProdutoProdutoListEdicaoAdapterBase(List<ModeloProdutoProduto> lista, IQuadroListaEdicao origem, Context context ) {
...
*/
	...
	protected int getLayout() {
		return R.layout.item_modelo_produto_produto;
	}
