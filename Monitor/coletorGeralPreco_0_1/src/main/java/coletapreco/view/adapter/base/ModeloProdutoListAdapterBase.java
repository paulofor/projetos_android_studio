...
public abstract class ModeloProdutoListAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public ModeloProdutoListAdapterBase(List<ModeloProduto> lista, Context context ) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View saida = LayoutInflater.from(context).inflate(R.layout.item_modelo_produto, null);
	...
	protected void montaItemLista(int posicao, ModeloProduto item, View saida) {
