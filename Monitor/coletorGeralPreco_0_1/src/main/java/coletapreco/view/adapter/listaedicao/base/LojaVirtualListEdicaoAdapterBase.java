...
public abstract class LojaVirtualListEdicaoAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public LojaVirtualListEdicaoAdapterBase(List<LojaVirtual> lista, IQuadroListaEdicao origem, Context context ) {
...
*/
	...
	protected int getLayout() {
		return R.layout.item_loja_virtual;
	}
