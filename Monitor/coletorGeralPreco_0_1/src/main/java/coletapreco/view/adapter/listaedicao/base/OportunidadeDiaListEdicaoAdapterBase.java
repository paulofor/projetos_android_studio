...
import coletapreco.view.OportunidadeDiaView;
import br.com.digicom.layout.ItemLista;
import br.com.digicom.quadro.IQuadroListaEdicao;
import br.com.digicom.quadro.IFragment;
import br.com.digicom.quadro.BaseListFragment;
import coletapreco.tela.quadro.base.OportunidadeDiaQuadroListaBase;

public abstract class OportunidadeDiaListEdicaoAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	
	private Context context;
	private List<OportunidadeDia> lista;
	...
	public OportunidadeDiaListEdicaoAdapterBase(List<OportunidadeDia> lista, IQuadroListaEdicao origem, Context context ) {
...
*/
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		OportunidadeDia item = lista.get(position);
		
		View saida = LayoutInflater.from(context).inflate(getLayout(), null);
		if (!(saida instanceof ItemLista))
			throw new RuntimeException("Alterar layout raiz de item_oportunidade_dia.xml para br.com.digicom.layout.ItemLista");
	...
	protected int getLayout() {
		return R.layout.item_oportunidade_dia;
	}
	
	protected void montaItemLista(int position, OportunidadeDia item, View saida) {
		throw new UnsupportedOperationException("Fazer override de montaItemLista em "  + this.getClass().getSimpleName() + " ou verificar se nao esta sendo chamada via super. Arquivo de visao padrao eh: R.layout.item_oportunidade_dia");
	}
	
	@Override
	public boolean onTouch(View view, MotionEvent avent) {
	 	ItemLista objeto = (ItemLista) view;
		OportunidadeDia item = (OportunidadeDia) objeto.getItem();
