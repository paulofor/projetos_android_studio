...
public abstract class ModeloProdutoListEdicaoAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public ModeloProdutoListEdicaoAdapterBase(List<ModeloProduto> lista, IQuadroListaEdicao origem, Context context ) {
...
*/
	...
	protected int getLayout() {
		return R.layout.item_modelo_produto;
	}
