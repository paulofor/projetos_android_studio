...
import coletapreco.view.UsuarioView;
import br.com.digicom.layout.ItemLista;
import br.com.digicom.quadro.IQuadroLista;
import br.com.digicom.quadro.IFragment;
import br.com.digicom.activity.DigicomContexto;
import br.com.digicom.layout.ResourceObj;
import coletapreco.tela.quadro.base.UsuarioQuadroListaBase;

public abstract class UsuarioListUsoAdapterBase extends BaseAdapter {
	...
	public UsuarioListUsoAdapterBase(List<Usuario> lista, DigicomContexto context ) {
		this.context = context;
		this.lista = lista;
		setEdicao(); // Forcando para fazer edicao - alterar se for necessario depois.
	}
	
	public void setListaNova(List<Usuario> listaNova) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (!(saida instanceof ItemLista))
			throw new RuntimeException("Alterar layout raiz de item_usuario.xml para br.com.digicom.layout.ItemLista");
	...
	protected void montaItemLista(int position, Usuario item, View saida) {
		throw new UnsupportedOperationException("Fazer override de montaItemLista em "  + this.getClass().getSimpleName() + " ou verificar se nao esta sendo chamada via super. Arquivo de visao padrao eh: R.layout.item_usuario");
	}
	protected ResourceObj getLayoutItem() {
		return new ResourceObj(R.layout.item_usuario,"R.layout.item_usuario");
	}
	/*
	@Override
	public boolean onTouch(View view, MotionEvent avent) {
	 	ItemLista objeto = (ItemLista) view;
		Usuario item = (Usuario) objeto.getItem();
