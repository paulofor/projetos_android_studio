...
public abstract class LojaNaturezaListAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public LojaNaturezaListAdapterBase(List<LojaNatureza> lista, Context context ) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View saida = LayoutInflater.from(context).inflate(R.layout.item_loja_natureza, null);
	...
	protected void montaItemLista(int posicao, LojaNatureza item, View saida) {
