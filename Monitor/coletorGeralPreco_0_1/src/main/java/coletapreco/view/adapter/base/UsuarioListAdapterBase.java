...
public abstract class UsuarioListAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public UsuarioListAdapterBase(List<Usuario> lista, Context context ) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View saida = LayoutInflater.from(context).inflate(R.layout.item_usuario, null);
	...
	protected void montaItemLista(int posicao, Usuario item, View saida) {
