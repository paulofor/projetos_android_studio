...
public abstract class CategoriaLojaProdutoListUsoAdapterBase extends BaseAdapter {
	...
	public CategoriaLojaProdutoListUsoAdapterBase(List<CategoriaLojaProduto> lista, DigicomContexto context ) {
		this.context = context;
		this.lista = lista;
		setEdicao(); // Forcando para fazer edicao - alterar se for necessario depois.
	}
	
	public void setListaNova(List<CategoriaLojaProduto> listaNova) {
	...
	protected void montaItemLista(int position, CategoriaLojaProduto item, View saida) {
	...
	protected ResourceObj getLayoutItem() {
		return new ResourceObj(R.layout.item_categoria_loja_produto,"R.layout.item_categoria_loja_produto");
	}
	/*
	@Override
