...
import coletapreco.view.MarcaView;
import br.com.digicom.layout.ItemLista;
import br.com.digicom.quadro.IQuadroLista;
import br.com.digicom.quadro.IFragment;
import br.com.digicom.activity.DigicomContexto;
import br.com.digicom.layout.ResourceObj;
import coletapreco.tela.quadro.base.MarcaQuadroListaBase;

public abstract class MarcaListUsoAdapterBase extends BaseAdapter {
	...
	public MarcaListUsoAdapterBase(List<Marca> lista, DigicomContexto context ) {
		this.context = context;
		this.lista = lista;
		setEdicao(); // Forcando para fazer edicao - alterar se for necessario depois.
	}
	
	public void setListaNova(List<Marca> listaNova) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (!(saida instanceof ItemLista))
			throw new RuntimeException("Alterar layout raiz de item_marca.xml para br.com.digicom.layout.ItemLista");
	...
	protected void montaItemLista(int position, Marca item, View saida) {
		throw new UnsupportedOperationException("Fazer override de montaItemLista em "  + this.getClass().getSimpleName() + " ou verificar se nao esta sendo chamada via super. Arquivo de visao padrao eh: R.layout.item_marca");
	}
	protected ResourceObj getLayoutItem() {
		return new ResourceObj(R.layout.item_marca,"R.layout.item_marca");
	}
	/*
	@Override
	public boolean onTouch(View view, MotionEvent avent) {
	 	ItemLista objeto = (ItemLista) view;
		Marca item = (Marca) objeto.getItem();
