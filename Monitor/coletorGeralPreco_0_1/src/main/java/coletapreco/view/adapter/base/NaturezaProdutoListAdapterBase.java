...
public abstract class NaturezaProdutoListAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public NaturezaProdutoListAdapterBase(List<NaturezaProduto> lista, Context context ) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View saida = LayoutInflater.from(context).inflate(R.layout.item_natureza_produto, null);
	...
	protected void montaItemLista(int posicao, NaturezaProduto item, View saida) {
