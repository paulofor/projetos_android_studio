...
public abstract class MarcaListAdapterBase extends BaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public MarcaListAdapterBase(List<Marca> lista, Context context ) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View saida = LayoutInflater.from(context).inflate(R.layout.item_marca, null);
	...
	protected void montaItemLista(int posicao, Marca item, View saida) {
