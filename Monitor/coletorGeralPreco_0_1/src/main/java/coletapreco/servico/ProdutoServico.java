...
import coletapreco.servico.filtro.ProdutoFiltro;
import br.com.digicom.video.DigicomVideoView;
//import coletapreco.dao.base.ProdutoDBHelper;
...
*/
	...
	public abstract List<Produto> getPorLidoEmLojaVirtual(Context contexto, long id);
	public abstract List<Produto> getPorLidoEmLojaVirtual(Context contexto, long id, int qtde);
	public abstract List<Produto> getPorLidoEmLojaVirtual(long id);
	public abstract List<Produto> getPorLidoEmLojaVirtual(long id, int qtde);
	
	public abstract List<Produto> getPorPossuiMarca(Context contexto, long id);
	public abstract List<Produto> getPorPossuiMarca(Context contexto, long id, int qtde);
	public abstract List<Produto> getPorPossuiMarca(long id);
	public abstract List<Produto> getPorPossuiMarca(long id, int qtde);
