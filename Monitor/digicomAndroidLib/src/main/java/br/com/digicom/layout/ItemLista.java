...
public class ItemLista extends LinearLayout implements IItemLista{
	...
	private void setup() {
		...
		//this.setMinimumHeight(android.R.attr.listPreferredItemHeight);
		
	}
	
	public static DCIObjetoDominio getItem(View view) {
		View parent = (View)view.getParent();
		while (parent!=null && !(parent instanceof IItemLista)) {
			parent = (View) parent.getParent();
		}
		if (parent!=null) {
			return ((IItemLista)parent).getItem();
		} else {
			return null;
		}
	}
