...
public abstract class BillingBaseActivity extends AppCompatActivity implements IabBroadcastReceiver.IabBroadcastListener {
    ...
    static final String SKU_PRODUTO = "produto_simples_01";

    // Debug tag, for logging
    protected static final String TAG = "ProcessaBilling";

    private boolean assinatura1 = false;
    ...
    boolean possuiAssinatura = false;
    ...
    public void comprarAssinatura() {
        ...
        String payload = "";
        mHelper.launchSubscriptionPurchaseFlow(this, SKU_ASSINATURA, RC_REQUEST, mPurchaseFinishedListener, payload);

        //Log.d(TAG, "Iniciando compra para inscricao.");
        //try {
    ...
    IabHelper.QueryInventoryFinishedListener mGotInventoryListener = new IabHelper.QueryInventoryFinishedListener() {
        public void onQueryInventoryFinished(IabResult result, Inventory inventory) {
            ...
            Log.d(TAG,"compraAssinatura = null: " + (compraAssinatura==null));
            assinatura1 = compraAssinatura != null;
    ...
    protected boolean getAssinatura1() {
        return this.assinatura1;
    }
    ...
    void complain(String message) {
        ...
        //alert("A compra não foi concluída tente novamente.");
        alert(getResources().getString(R.string.compra_nao_realizada));
    }
