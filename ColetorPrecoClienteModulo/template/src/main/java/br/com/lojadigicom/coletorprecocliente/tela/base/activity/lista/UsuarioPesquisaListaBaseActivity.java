...
public abstract class UsuarioPesquisaListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (879 * 10) + 1;
    ...
    protected abstract void trataLista(List<UsuarioPesquisa> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<UsuarioPesquisa> converteLista(Cursor data) {
