 ...
 */
public abstract class InteresseProdutoListAdapterBase extends RecyclerView.Adapter<InteresseProdutoListViewHolderBase>{

    //protected Cursor mCursor;
    protected List<InteresseProduto> mLista;
    private Context mContext;
    private InteresseProdutoListAdapterOnClickHandler mClickHandler;
    private View mEmptyView;
    private ItemChoiceManager mICM = null;
    protected ResourceObj resourceObj = getLayoutItemResource();

    public InteresseProdutoListAdapterBase(Context context, InteresseProdutoListAdapterOnClickHandler dh, View emptyView, int choiceMode) {
        mContext = context;
        mClickHandler = dh;
    ...
    @Override
    public final InteresseProdutoListViewHolderBase onCreateViewHolder(ViewGroup parent, int viewType) {
        if ( parent instanceof RecyclerView ) {
            ...
            InteresseProdutoListViewHolderBase saida = getViewHolder(view);
    ...
    protected abstract InteresseProdutoListViewHolderBase getViewHolder(View v);
    ...
    public final void swapCursor(List<InteresseProduto> novaLista) {
        //mCursor = newCursor;
        mLista = novaLista;
    ...
    public static interface InteresseProdutoListAdapterOnClickHandler {
        void onClick(int id, InteresseProdutoListViewHolderBase vh);
    }
    
    
    @Override
    public void onBindViewHolder(InteresseProdutoListViewHolderBase holder, int position) {
        InteresseProduto obj = mLista.get(position);
        holder.setItem(obj);
        onBindViewHolderDC(obj,holder,position);
    }

    protected abstract void onBindViewHolderDC(InteresseProduto item,InteresseProdutoListViewHolderBase holder, int position);
