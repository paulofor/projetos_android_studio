...
import br.com.lojadigicom.coletorprecocliente.servico.base.OportunidadeDiaServico;
import br.com.lojadigicom.coletorprecocliente.servico.base.FabricaServico;
import br.com.lojadigicom.coletorprecocliente.modelo.OportunidadeDiaVo;
import br.com.lojadigicom.coletorprecocliente.framework.log.DCLog;

public abstract class OportunidadeDiaFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private OportunidadeDia item = null;
	
	protected OportunidadeDiaServico srv = FabricaServico.getInstancia().getOportunidadeDiaServico();
    ...
    protected abstract void copiaTelaParaVo(OportunidadeDia item);
