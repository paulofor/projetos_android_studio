...
import br.com.lojadigicom.coletorprecocliente.servico.base.PalavraChavePesquisaServico;
import br.com.lojadigicom.coletorprecocliente.servico.base.FabricaServico;
import br.com.lojadigicom.coletorprecocliente.modelo.PalavraChavePesquisaVo;
import br.com.lojadigicom.coletorprecocliente.framework.log.DCLog;

public abstract class PalavraChavePesquisaFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private PalavraChavePesquisa item = null;
	
	protected PalavraChavePesquisaServico srv = FabricaServico.getInstancia().getPalavraChavePesquisaServico();
	...
	private void enviaDados() {
		...
		if (item==null) {
            // Insercao
            item = new PalavraChavePesquisaVo();
    ...
    protected abstract void copiaTelaParaVo(PalavraChavePesquisa item);
