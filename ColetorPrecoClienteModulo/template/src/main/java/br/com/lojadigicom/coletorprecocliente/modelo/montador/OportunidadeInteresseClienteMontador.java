...
public class OportunidadeInteresseClienteMontador implements MontadorDaoI {
	...
	private OportunidadeInteresseCliente principal = new OportunidadeInteresseClienteVo();
	
	private boolean sinc = false;
	public OportunidadeInteresseClienteMontador(boolean sinc) {
		this.sinc = sinc;
	}
	public OportunidadeInteresseClienteMontador() {
		this.sinc = false;
	}
	...
	public DCIObjetoDominio getItem(Cursor c) {
		...
		objeto = new OportunidadeInteresseClienteVo();
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		OportunidadeInteresseCliente item = null;
		item = (OportunidadeInteresseCliente) entrada;
		item.setIdOportunidadeInteresseCliente(getInt(c,pos++));
