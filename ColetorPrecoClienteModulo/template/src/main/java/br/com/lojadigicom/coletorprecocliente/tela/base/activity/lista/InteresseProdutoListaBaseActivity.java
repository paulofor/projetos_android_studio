...
public abstract class InteresseProdutoListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (883 * 10) + 1;
    ...
    protected abstract void trataLista(List<InteresseProduto> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<InteresseProduto> converteLista(Cursor data) {
