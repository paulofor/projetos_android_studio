...
public abstract class AppProdutoListFragmentBase extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>{

    private RecyclerView mRecyclerView;
    private AppProdutoListAdapterBase mAdapter;

    private int mPosition = RecyclerView.NO_POSITION;
    private int mChoiceMode;
    private static final String SELECTED_KEY = "selected_position";
    private static final int FORECAST_LOADER = 900;
	...
	public AppProdutoListFragmentBase() {
    }


	private final void onItemSelected(int idItemLista, AppProdutoListViewHolderBase vh) {
        ...
        intent.putExtra(Constantes.APP_PRODUTO_ID,idItemLista);
        if (idItemLista==0) {
    ...
    protected abstract void montaAminacao(AppProdutoListViewHolderBase vh, ArrayList<Pair<View,String>> lista);
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = getListAdapter(this.getActivity(), new AppProdutoListAdapterBase.AppProdutoListAdapterOnClickHandler() {
            @Override
            public void onClick(int idItemLista, AppProdutoListViewHolderBase vh) {
    ...
    protected abstract AppProdutoListAdapterBase getListAdapter(FragmentActivity activity, AppProdutoListAdapterBase.AppProdutoListAdapterOnClickHandler onClickHandler, View emptyView, int mChoiceMode);

	/*
 	public void registraPosicao(AppProdutoListViewHolderBase vh) {
        SharedPreferences pref = getActivity().getSharedPreferences("br.com.lojadigicom.coletorprecocliente", Context.MODE_PRIVATE);
        SharedPreferences.Editor edt = pref.edit();
        edt.putInt(Constantes.APP_PRODUTO_POSICAO, vh.getAdapterPosition());
        edt.commit();
    }
    private void recuperaPosicao() {
        SharedPreferences pref = getActivity().getSharedPreferences("br.com.lojadigicom.coletorprecocliente", Context.MODE_PRIVATE);
        mPosition = pref.getInt(Constantes.APP_PRODUTO_POSICAO,RecyclerView.NO_POSITION);
    }
	*/
    ...
    public final void onLoadFinished(Loader<Cursor> loader, Cursor data) {
    	...
    	DCLog.d(DCLog.OPERACAO_DB_TELA,this,"Lista AppProduto " + lista.size() + " itens");
	...
	protected MontadorDaoI getMontador() {
        return AppProdutoContract.getMontador();
    }

    protected final List<AppProduto> converteLista(Cursor data) {
