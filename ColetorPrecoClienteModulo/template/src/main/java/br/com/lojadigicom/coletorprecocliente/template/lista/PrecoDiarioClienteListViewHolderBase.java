 ...
 */
public abstract class PrecoDiarioClienteListViewHolderBase extends RecyclerView.ViewHolder implements View.OnClickListener{

    //protected Cursor mCursor;
    protected List mLista;
    protected PrecoDiarioClienteListAdapterBase.PrecoDiarioClienteListAdapterOnClickHandler mClickHandler;
    protected ItemChoiceManager mICM = null;


	private PrecoDiarioCliente item;
	public void setItem(PrecoDiarioCliente dado) {
		item = dado;
	}
	public PrecoDiarioCliente getItem() {
		return item;
	}
    ...
    public void setOnClickHandler(PrecoDiarioClienteListAdapterBase.PrecoDiarioClienteListAdapterOnClickHandler valor){
        mClickHandler = valor;
    }

    public PrecoDiarioClienteListViewHolderBase(View itemView) {
        super(itemView);
