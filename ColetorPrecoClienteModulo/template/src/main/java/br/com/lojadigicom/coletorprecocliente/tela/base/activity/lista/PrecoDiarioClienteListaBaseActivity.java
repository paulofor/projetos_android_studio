...
public abstract class PrecoDiarioClienteListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (864 * 10) + 1;
    ...
    protected abstract void trataLista(List<PrecoDiarioCliente> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<PrecoDiarioCliente> converteLista(Cursor data) {
