...
import br.com.lojadigicom.coletorprecocliente.servico.base.UsuarioPesquisaServico;
...
public abstract class UsuarioPesquisaFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private UsuarioPesquisa item = null;
	
	protected UsuarioPesquisaServico srv = FabricaServico.getInstancia().getUsuarioPesquisaServico();
    ...
    protected abstract void copiaTelaParaVo(UsuarioPesquisa item);
