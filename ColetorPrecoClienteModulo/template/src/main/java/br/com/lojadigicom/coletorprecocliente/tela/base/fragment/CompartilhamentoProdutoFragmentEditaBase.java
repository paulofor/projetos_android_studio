...
public abstract class CompartilhamentoProdutoFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private CompartilhamentoProduto item = null;
	
	protected CompartilhamentoProdutoServico srv = FabricaServico.getInstancia().getCompartilhamentoProdutoServico();
	
	protected CompartilhamentoProduto getItem() {
		return item;
	}
	public void setItem(CompartilhamentoProduto valor) {
		item = valor;
	}
	...
	private void enviaDados() {
		...
		if (item==null) {
            // Insercao
            item = new CompartilhamentoProdutoVo();
    ...
    protected abstract void copiaTelaParaVo(CompartilhamentoProduto item);
