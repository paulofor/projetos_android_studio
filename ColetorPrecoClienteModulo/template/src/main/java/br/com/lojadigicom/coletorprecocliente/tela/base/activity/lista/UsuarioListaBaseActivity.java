...
public abstract class UsuarioListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (876 * 10) + 1;
    ...
    protected abstract void trataLista(List<Usuario> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<Usuario> converteLista(Cursor data) {
