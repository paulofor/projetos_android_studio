...
public final class DispositivoUsuarioContract implements BaseColumns {
    ...
    public static final int COL_DATA_CRIACAO = 6;
    public static final String COLUNA_DATA_ULTIMO_ACESSO = "data_ultimo_acesso";
    public static final int COL_DATA_ULTIMO_ACESSO = 7;
    public static final String COLUNA_TOKEN_GCM_MONITOR = "token_gcm_monitor";
    public static final int COL_TOKEN_GCM_MONITOR = 8;
    public static final String COLUNA_MICRO_SD = "micro_sd";
    public static final int COL_MICRO_SD = 9;
    public static final String COLUNA_DATA_CHAMADA = "data_chamada";
    public static final int COL_DATA_CHAMADA = 10;
    public static final String COLUNA_TEM_MUDANCA = "tem_mudanca";
    public static final int COL_TEM_MUDANCA = 11;
    public static final String COLUNA_ATIVO = "ativo";
    public static final int COL_ATIVO = 12;
    public static final String COLUNA_ID_USUARIO_RA = "id_usuario_ra";
    public static final int COL_ID_USUARIO_RA = 13;
	
    public static final String COLUNA_ID_APP_PRODUTO_U = "id_app_produto_u";
    public static final int COL_ID_APP_PRODUTO_U = 14;
 	...
 	public static final int COL_OPERACAO_SINC = 15;
	...
	public static final String[] COLS = new String[] { 
        	...
        	, TABLE_NAME + "." +COLUNA_DATA_ULTIMO_ACESSO
        	, TABLE_NAME + "." +COLUNA_TOKEN_GCM_MONITOR
        	, TABLE_NAME + "." +COLUNA_MICRO_SD
        	, TABLE_NAME + "." +COLUNA_DATA_CHAMADA
        	, TABLE_NAME + "." +COLUNA_TEM_MUDANCA
    ...
    public static final String[] COLS_SINC = new String[] { 
        	...
        	, TABLE_NAME_SINC + "." +COLUNA_DATA_ULTIMO_ACESSO
        	, TABLE_NAME_SINC + "." +COLUNA_TOKEN_GCM_MONITOR
        	, TABLE_NAME_SINC + "." +COLUNA_MICRO_SD
        	, TABLE_NAME_SINC + "." +COLUNA_DATA_CHAMADA
        	, TABLE_NAME_SINC + "." +COLUNA_TEM_MUDANCA
	...
	public static String camposOrdenadosSinc() 
	{
		...
		+ " ,dispositivo_usuario_sinc.data_criacao " 
		+ " ,dispositivo_usuario_sinc.data_ultimo_acesso " 
		+ " ,dispositivo_usuario_sinc.token_gcm_monitor " 
		+ " ,dispositivo_usuario_sinc.micro_sd " 
		+ " ,dispositivo_usuario_sinc.data_chamada " 
		+ " ,dispositivo_usuario_sinc.tem_mudanca " 
		+ " ,dispositivo_usuario_sinc.ativo " 
