...
public abstract class InteresseProdutoDetalheBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>, Transition.TransitionListener {

	String titulo = null;
    private static final int DETAIL_LOADER = 883 * 10;
    ...
    protected Uri completaUri(Uri uri) {
        ...
        uri = InteresseProdutoContract.adiciona<Objeto><Relacionamento>(uri);
        return uri;
    } 
	*/
	...
	@Override
    protected MontadorDaoI completaMontador(MontadorDaoComposite montadorDao) {
        return InteresseProdutoContract.adicionaMontador<Objeto><Relacionamento>(montadorDao);
    }
	*/
