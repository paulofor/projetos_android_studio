...
public abstract class OportunidadeDiaListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (863 * 10) + 1;
    ...
    protected abstract void trataLista(List<OportunidadeDia> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<OportunidadeDia> converteLista(Cursor data) {
