...
import br.com.lojadigicom.coletorprecocliente.servico.base.UsuarioServico;
...
public abstract class UsuarioFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private Usuario item = null;
	
	protected UsuarioServico srv = FabricaServico.getInstancia().getUsuarioServico();
    ...
    protected abstract void copiaTelaParaVo(Usuario item);
