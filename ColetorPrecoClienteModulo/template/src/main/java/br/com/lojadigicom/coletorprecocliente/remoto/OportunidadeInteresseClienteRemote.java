...
public class OportunidadeInteresseClienteRemote {
    ...
    private String getUrl(String metodo) {
        String objeto = "OportunidadeInteresseCliente";
    ...
    public int listaSincronizadaDao(Context contexto, boolean delete) throws JSONException {
        ...
        try {
            ...
            if (delete) {
                contexto.getContentResolver().delete(OportunidadeInteresseClienteContract.buildDeleteAllRecreate(), null, null);
            }
            contexto.getContentResolver().bulkInsert(OportunidadeInteresseClienteContract.getContentUri(), vetor);
  	...
  	public int listaSincronizadaDaoAtualizaPorId(Context contexto, boolean delete, String codigoAplicacao) throws JSONException {
        ...
        try {
            ...
            for (int x = 0 ; x < lista.length() ; x++) {
                ...
                ContentValues valor = this.ContentValuesAtributos(item);
                //vetor[x] = valor;
                String where = "id_oportunidade_interesse_cliente=" + valor.getAsString("id_oportunidade_interesse_cliente");
                contexto.getContentResolver().update(OportunidadeInteresseClienteContract.buildAtualiza(),valor,where,null);
            }
    ...
    private JSONObject JSonAtributos(Cursor c) throws JSONException {
		...
		json.put("IdOportunidadeInteresseCliente",c.getString(OportunidadeInteresseClienteContract.COL_ID_OPORTUNIDADE_INTERESSE_CLIENTE));
		
			
		
		json.put("IdUsuarioS",c.getString(OportunidadeInteresseClienteContract.COL_ID_USUARIO_S));
     ...
     private JSONObject JSonAtributosSinc(Cursor c) throws JSONException {
        ...
        json.put("OperacaoSinc",c.getString(OportunidadeInteresseClienteContract.COL_OPERACAO_SINC));
        return json;
    }
    ...
    private ContentValues ContentValuesAtributos(JSONObject obj) throws JSONException {
		...
		valores.put(OportunidadeInteresseClienteContract.COLUNA_ID_OPORTUNIDADE_INTERESSE_CLIENTE, obj.getString("IdOportunidadeInteresseCliente"));
		
		valores.put(OportunidadeInteresseClienteContract.COLUNA_ID_USUARIO_S, obj.getString("IdUsuarioS"));
