...
public class DispositivoUsuarioDbHelper {
	...
	protected static String getSqlCreate(){
        ...
        + " , " + DispositivoUsuarioContract.COLUNA_TOKEN_GCM_MONITOR + " TEXT "
        + " , " + DispositivoUsuarioContract.COLUNA_MICRO_SD + " INTEGER "
        + " , " + DispositivoUsuarioContract.COLUNA_DATA_CHAMADA + " INTEGER "
        + " , " + DispositivoUsuarioContract.COLUNA_TEM_MUDANCA + " NUMERIC "
        + " , " + DispositivoUsuarioContract.COLUNA_ATIVO + " NUMERIC "
