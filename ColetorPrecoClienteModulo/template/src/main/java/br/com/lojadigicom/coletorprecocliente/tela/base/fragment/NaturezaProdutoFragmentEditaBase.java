...
import br.com.lojadigicom.coletorprecocliente.servico.base.NaturezaProdutoServico;
...
public abstract class NaturezaProdutoFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private NaturezaProduto item = null;
	
	protected NaturezaProdutoServico srv = FabricaServico.getInstancia().getNaturezaProdutoServico();
    ...
    protected abstract void copiaTelaParaVo(NaturezaProduto item);
