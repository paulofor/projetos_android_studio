...
import br.com.lojadigicom.coletorprecocliente.servico.base.OportunidadeInteresseClienteServico;
import br.com.lojadigicom.coletorprecocliente.servico.base.FabricaServico;
import br.com.lojadigicom.coletorprecocliente.modelo.OportunidadeInteresseClienteVo;
import br.com.lojadigicom.coletorprecocliente.framework.log.DCLog;

public abstract class OportunidadeInteresseClienteFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private OportunidadeInteresseCliente item = null;
	
	protected OportunidadeInteresseClienteServico srv = FabricaServico.getInstancia().getOportunidadeInteresseClienteServico();
	
	protected OportunidadeInteresseCliente getItem() {
		return item;
	}
	public void setItem(OportunidadeInteresseCliente valor) {
		item = valor;
	}
	...
	private void enviaDados() {
		...
		if (item==null) {
            // Insercao
            item = new OportunidadeInteresseClienteVo();
    ...
    protected abstract void copiaTelaParaVo(OportunidadeInteresseCliente item);
