...
public class PrecoDiarioClienteMontador implements MontadorDaoI {
	...
	private PrecoDiarioCliente principal = new PrecoDiarioClienteVo();
	
	private boolean sinc = false;
	public PrecoDiarioClienteMontador(boolean sinc) {
		this.sinc = sinc;
	}
	public PrecoDiarioClienteMontador() {
		this.sinc = false;
	}
	...
	public DCIObjetoDominio getItem(Cursor c) {
		...
		objeto = new PrecoDiarioClienteVo();
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		PrecoDiarioCliente item = null;
		item = (PrecoDiarioCliente) entrada;
		item.setIdPrecoDiarioClientte(getInt(c,pos++));
		item.setDataHora(getTimestampDataHora(c,pos++));
		item.setPrecoVenda(getFloat(c,pos++));
		item.setIdProdutoClientePa(getInt(c,pos++));
