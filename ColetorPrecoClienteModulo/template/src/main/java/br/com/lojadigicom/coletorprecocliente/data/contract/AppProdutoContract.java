...
public final class AppProdutoContract implements BaseColumns {
	...
	public static MontadorDaoI adicionaMontadorNaturezaProdutoAtendeLista (MontadorDaoI montador) {
		((MontadorDaoComposite)montador).adicionaMontador(NaturezaProdutoContract.getMontador(), "NaturezaProduto_Atende");
		return montador;
	}
	...
	public static MontadorDaoI adicionaMontadorDispositivoUsuarioUsadoPorLista (MontadorDaoI montador) {
		((MontadorDaoComposite)montador).adicionaMontador(DispositivoUsuarioContract.getMontador(), "DispositivoUsuario_UsadoPor");
		return montador;
	}
