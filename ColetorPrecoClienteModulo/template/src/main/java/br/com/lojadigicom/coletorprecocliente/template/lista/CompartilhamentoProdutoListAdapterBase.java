 ...
 */
public abstract class CompartilhamentoProdutoListAdapterBase extends RecyclerView.Adapter<CompartilhamentoProdutoListViewHolderBase>{

    //protected Cursor mCursor;
    protected List<CompartilhamentoProduto> mLista;
    private Context mContext;
    private CompartilhamentoProdutoListAdapterOnClickHandler mClickHandler;
    private View mEmptyView;
    private ItemChoiceManager mICM = null;
    protected ResourceObj resourceObj = getLayoutItemResource();

    public CompartilhamentoProdutoListAdapterBase(Context context, CompartilhamentoProdutoListAdapterOnClickHandler dh, View emptyView, int choiceMode) {
        mContext = context;
        mClickHandler = dh;
    ...
    @Override
    public final CompartilhamentoProdutoListViewHolderBase onCreateViewHolder(ViewGroup parent, int viewType) {
        if ( parent instanceof RecyclerView ) {
            ...
            CompartilhamentoProdutoListViewHolderBase saida = getViewHolder(view);
    ...
    protected abstract CompartilhamentoProdutoListViewHolderBase getViewHolder(View v);
    ...
    public final void swapCursor(List<CompartilhamentoProduto> novaLista) {
        //mCursor = newCursor;
        mLista = novaLista;
    ...
    public static interface CompartilhamentoProdutoListAdapterOnClickHandler {
        void onClick(int id, CompartilhamentoProdutoListViewHolderBase vh);
    }
    
    
    @Override
    public void onBindViewHolder(CompartilhamentoProdutoListViewHolderBase holder, int position) {
        CompartilhamentoProduto obj = mLista.get(position);
        holder.setItem(obj);
        onBindViewHolderDC(obj,holder,position);
    }

    protected abstract void onBindViewHolderDC(CompartilhamentoProduto item,CompartilhamentoProdutoListViewHolderBase holder, int position);
