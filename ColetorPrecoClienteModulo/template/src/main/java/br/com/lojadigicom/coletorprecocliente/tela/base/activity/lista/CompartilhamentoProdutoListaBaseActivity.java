...
public abstract class CompartilhamentoProdutoListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (911 * 10) + 1;
    ...
    protected abstract void trataLista(List<CompartilhamentoProduto> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<CompartilhamentoProduto> converteLista(Cursor data) {
