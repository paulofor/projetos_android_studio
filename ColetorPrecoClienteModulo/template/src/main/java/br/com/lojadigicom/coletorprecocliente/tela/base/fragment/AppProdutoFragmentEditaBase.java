...
import br.com.lojadigicom.coletorprecocliente.servico.base.AppProdutoServico;
...
public abstract class AppProdutoFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private AppProduto item = null;
	
	protected AppProdutoServico srv = FabricaServico.getInstancia().getAppProdutoServico();
    ...
    protected abstract void copiaTelaParaVo(AppProduto item);
