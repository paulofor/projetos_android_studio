...
public final class ProdutoClienteContract implements BaseColumns {
    ...
    public static final String[] COLS_SINC = new String[] { 
        	...
        	, TABLE_NAME_SINC + "." +COLUNA_DETALHE
	...
	public static MontadorDaoI adicionaMontadorInteresseProdutoPossuiLista (MontadorDaoI montador) {
		((MontadorDaoComposite)montador).adicionaMontador(InteresseProdutoContract.getMontador(), "InteresseProduto_Possui");
		return montador;
	}
 	
	public static String innerJoinPrecoDiarioCliente_Possui() {
		return " inner join " + PrecoDiarioClienteContract.TABLE_NAME + " on " + PrecoDiarioClienteContract.TABLE_NAME + ".id_produto_cliente_pa = " + TABLE_NAME + "." + COLUNA_CHAVE + " ";  
	}
	public static String innerJoinSincPrecoDiarioCliente_Possui() {
		return " inner join " + PrecoDiarioClienteContract.TABLE_NAME_SINC + " on " + PrecoDiarioClienteContract.TABLE_NAME_SINC + ".id_produto_cliente_pa = " + TABLE_NAME_SINC + "." + COLUNA_CHAVE + " ";  
	}
	public static String outerJoinPrecoDiarioCliente_Possui() {
		return " left outer join " + PrecoDiarioClienteContract.TABLE_NAME + " on " + PrecoDiarioClienteContract.TABLE_NAME + ".id_produto_cliente_pa = " + TABLE_NAME + "." + COLUNA_CHAVE + " "; 
	}
	public static String outerJoinSincPrecoDiarioCliente_Possui() {
		return " left outer join " + PrecoDiarioClienteContract.TABLE_NAME_SINC + " on " + PrecoDiarioClienteContract.TABLE_NAME_SINC + ".id_produto_cliente_pa = " + TABLE_NAME_SINC + "." + COLUNA_CHAVE + " ";   
	}
	public static MontadorDaoI adicionaMontadorPrecoDiarioClientePossuiLista (MontadorDaoI montador) {
		((MontadorDaoComposite)montador).adicionaMontador(PrecoDiarioClienteContract.getMontador(), "PrecoDiarioCliente_Possui");
		return montador;
	}
	...
	public static String camposOrdenadosSinc() 
	{
		...
		+ " ,produto_cliente_sinc.url " 
		+ " ,produto_cliente_sinc.detalhe " 
		+ " ,produto_cliente_sinc.id_natureza_produto_ra " 
		+ " ,produto_cliente_sinc.id_usuario_s " 
	...
	public static Uri buildAllComPrecoDiarioClientePossui() {
		Uri saida = getContentUri();
		saida = saida.buildUpon().appendPath(ProdutoClienteContract.COM_COMPLEMENTO).build();
		saida = saida.buildUpon().appendPath("ComPrecoDiarioClientePossui").build();
		return saida;
	}	
	public static Uri buildAllSemPrecoDiarioClientePossui() {
		Uri saida = getContentUri();
		saida = saida.buildUpon().appendPath(ProdutoClienteContract.COM_RETIRADA).build();
		saida = saida.buildUpon().appendPath("SemPrecoDiarioClientePossui").build();
		return saida;
	}	
