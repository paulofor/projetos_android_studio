...
public abstract class OportunidadeInteresseClienteListFragmentBase extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>{

    private RecyclerView mRecyclerView;
    private OportunidadeInteresseClienteListAdapterBase mAdapter;

    private int mPosition = RecyclerView.NO_POSITION;
    private int mChoiceMode;
    private static final String SELECTED_KEY = "selected_position";
    private static final int FORECAST_LOADER = 910;
	...
	public OportunidadeInteresseClienteListFragmentBase() {
    }


	private final void onItemSelected(int idItemLista, OportunidadeInteresseClienteListViewHolderBase vh) {
        ...
        intent.putExtra(Constantes.OPORTUNIDADE_INTERESSE_CLIENTE_ID,idItemLista);
        if (idItemLista==0) {
    ...
    protected abstract void montaAminacao(OportunidadeInteresseClienteListViewHolderBase vh, ArrayList<Pair<View,String>> lista);
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = getListAdapter(this.getActivity(), new OportunidadeInteresseClienteListAdapterBase.OportunidadeInteresseClienteListAdapterOnClickHandler() {
            @Override
            public void onClick(int idItemLista, OportunidadeInteresseClienteListViewHolderBase vh) {
    ...
    protected abstract OportunidadeInteresseClienteListAdapterBase getListAdapter(FragmentActivity activity, OportunidadeInteresseClienteListAdapterBase.OportunidadeInteresseClienteListAdapterOnClickHandler onClickHandler, View emptyView, int mChoiceMode);

	/*
 	public void registraPosicao(OportunidadeInteresseClienteListViewHolderBase vh) {
        SharedPreferences pref = getActivity().getSharedPreferences("br.com.lojadigicom.coletorprecocliente", Context.MODE_PRIVATE);
        SharedPreferences.Editor edt = pref.edit();
        edt.putInt(Constantes.OPORTUNIDADE_INTERESSE_CLIENTE_POSICAO, vh.getAdapterPosition());
        edt.commit();
    }
    private void recuperaPosicao() {
        SharedPreferences pref = getActivity().getSharedPreferences("br.com.lojadigicom.coletorprecocliente", Context.MODE_PRIVATE);
        mPosition = pref.getInt(Constantes.OPORTUNIDADE_INTERESSE_CLIENTE_POSICAO,RecyclerView.NO_POSITION);
    }
	*/
    ...
    public final void onLoadFinished(Loader<Cursor> loader, Cursor data) {
    	List<OportunidadeInteresseCliente> lista = converteLista(data);
    	DCLog.d(DCLog.OPERACAO_DB_TELA,this,"Lista OportunidadeInteresseCliente " + lista.size() + " itens");
    	DCLog.d(DCLog.TRACE_LISTA,this,"List<OportunidadeInteresseCliente> : " + lista.size() + " itens");
	...
	protected MontadorDaoI getMontador() {
        return OportunidadeInteresseClienteContract.getMontador();
    }

    protected final List<OportunidadeInteresseCliente> converteLista(Cursor data) {
