...
public abstract class PrecoDiarioClienteListFragmentBase extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>{

    private RecyclerView mRecyclerView;
    private PrecoDiarioClienteListAdapterBase mAdapter;

    private int mPosition = RecyclerView.NO_POSITION;
    private int mChoiceMode;
    private static final String SELECTED_KEY = "selected_position";
    private static final int FORECAST_LOADER = 864;
	...
	public PrecoDiarioClienteListFragmentBase() {
    }


	private final void onItemSelected(int idItemLista, PrecoDiarioClienteListViewHolderBase vh) {
        ...
        intent.putExtra(Constantes.PRECO_DIARIO_CLIENTE_ID,idItemLista);
        if (idItemLista==0) {
    ...
    protected abstract void montaAminacao(PrecoDiarioClienteListViewHolderBase vh, ArrayList<Pair<View,String>> lista);
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = getListAdapter(this.getActivity(), new PrecoDiarioClienteListAdapterBase.PrecoDiarioClienteListAdapterOnClickHandler() {
            @Override
            public void onClick(int idItemLista, PrecoDiarioClienteListViewHolderBase vh) {
    ...
    protected abstract PrecoDiarioClienteListAdapterBase getListAdapter(FragmentActivity activity, PrecoDiarioClienteListAdapterBase.PrecoDiarioClienteListAdapterOnClickHandler onClickHandler, View emptyView, int mChoiceMode);

	/*
 	public void registraPosicao(PrecoDiarioClienteListViewHolderBase vh) {
        SharedPreferences pref = getActivity().getSharedPreferences("br.com.lojadigicom.coletorprecocliente", Context.MODE_PRIVATE);
        SharedPreferences.Editor edt = pref.edit();
        edt.putInt(Constantes.PRECO_DIARIO_CLIENTE_POSICAO, vh.getAdapterPosition());
        edt.commit();
    }
    private void recuperaPosicao() {
        SharedPreferences pref = getActivity().getSharedPreferences("br.com.lojadigicom.coletorprecocliente", Context.MODE_PRIVATE);
        mPosition = pref.getInt(Constantes.PRECO_DIARIO_CLIENTE_POSICAO,RecyclerView.NO_POSITION);
    }
	*/
    ...
    public final void onLoadFinished(Loader<Cursor> loader, Cursor data) {
    	List<PrecoDiarioCliente> lista = converteLista(data);
    	DCLog.d(DCLog.OPERACAO_DB_TELA,this,"Lista PrecoDiarioCliente " + lista.size() + " itens");
    	DCLog.d(DCLog.TRACE_LISTA,this,"List<PrecoDiarioCliente> : " + lista.size() + " itens");
	...
	protected MontadorDaoI getMontador() {
        return PrecoDiarioClienteContract.getMontador();
    }

    protected final List<PrecoDiarioCliente> converteLista(Cursor data) {
	...
	protected long mIdProdutoCliente;
	public final void setIdProdutoCliente(long id) {
		mIdProdutoCliente = id;
	}
