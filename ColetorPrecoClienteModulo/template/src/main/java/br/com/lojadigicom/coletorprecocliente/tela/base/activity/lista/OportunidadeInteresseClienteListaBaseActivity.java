...
public abstract class OportunidadeInteresseClienteListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (910 * 10) + 1;
    ...
    protected abstract void trataLista(List<OportunidadeInteresseCliente> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<OportunidadeInteresseCliente> converteLista(Cursor data) {
