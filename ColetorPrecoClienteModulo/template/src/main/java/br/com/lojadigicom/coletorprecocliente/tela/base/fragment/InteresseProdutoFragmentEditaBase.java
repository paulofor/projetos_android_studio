...
public abstract class InteresseProdutoFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private InteresseProduto item = null;
	
	protected InteresseProdutoServico srv = FabricaServico.getInstancia().getInteresseProdutoServico();
    ...
    protected abstract void copiaTelaParaVo(InteresseProduto item);
