...
public abstract class ProdutoClienteListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (882 * 10) + 1;
    ...
    protected abstract void trataLista(List<ProdutoCliente> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<ProdutoCliente> converteLista(Cursor data) {
