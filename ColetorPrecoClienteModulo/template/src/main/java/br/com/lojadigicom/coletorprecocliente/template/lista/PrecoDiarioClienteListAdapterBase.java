 ...
 */
public abstract class PrecoDiarioClienteListAdapterBase extends RecyclerView.Adapter<PrecoDiarioClienteListViewHolderBase>{

    //protected Cursor mCursor;
    protected List<PrecoDiarioCliente> mLista;
    private Context mContext;
    private PrecoDiarioClienteListAdapterOnClickHandler mClickHandler;
    private View mEmptyView;
    private ItemChoiceManager mICM = null;
    protected ResourceObj resourceObj = getLayoutItemResource();

    public PrecoDiarioClienteListAdapterBase(Context context, PrecoDiarioClienteListAdapterOnClickHandler dh, View emptyView, int choiceMode) {
        mContext = context;
        mClickHandler = dh;
    ...
    @Override
    public final PrecoDiarioClienteListViewHolderBase onCreateViewHolder(ViewGroup parent, int viewType) {
        if ( parent instanceof RecyclerView ) {
            ...
            PrecoDiarioClienteListViewHolderBase saida = getViewHolder(view);
    ...
    protected abstract PrecoDiarioClienteListViewHolderBase getViewHolder(View v);
    ...
    public final void swapCursor(List<PrecoDiarioCliente> novaLista) {
        //mCursor = newCursor;
        mLista = novaLista;
    ...
    public static interface PrecoDiarioClienteListAdapterOnClickHandler {
        void onClick(int id, PrecoDiarioClienteListViewHolderBase vh);
    }
    
    
    @Override
    public void onBindViewHolder(PrecoDiarioClienteListViewHolderBase holder, int position) {
        PrecoDiarioCliente obj = mLista.get(position);
        holder.setItem(obj);
        onBindViewHolderDC(obj,holder,position);
    }

    protected abstract void onBindViewHolderDC(PrecoDiarioCliente item,PrecoDiarioClienteListViewHolderBase holder, int position);
