 ...
 */
public abstract class CompartilhamentoProdutoListViewHolderBase extends RecyclerView.ViewHolder implements View.OnClickListener{

    //protected Cursor mCursor;
    protected List mLista;
    protected CompartilhamentoProdutoListAdapterBase.CompartilhamentoProdutoListAdapterOnClickHandler mClickHandler;
    protected ItemChoiceManager mICM = null;


	private CompartilhamentoProduto item;
	public void setItem(CompartilhamentoProduto dado) {
		item = dado;
	}
	public CompartilhamentoProduto getItem() {
		return item;
	}
    ...
    public void setOnClickHandler(CompartilhamentoProdutoListAdapterBase.CompartilhamentoProdutoListAdapterOnClickHandler valor){
        mClickHandler = valor;
    }

    public CompartilhamentoProdutoListViewHolderBase(View itemView) {
        super(itemView);
