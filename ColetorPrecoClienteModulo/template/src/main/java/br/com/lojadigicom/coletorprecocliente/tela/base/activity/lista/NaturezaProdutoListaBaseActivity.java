...
public abstract class NaturezaProdutoListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (862 * 10) + 1;
    ...
    protected abstract void trataLista(List<NaturezaProduto> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<NaturezaProduto> converteLista(Cursor data) {
