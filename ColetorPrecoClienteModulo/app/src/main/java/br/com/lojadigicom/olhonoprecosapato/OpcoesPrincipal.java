...
import br.com.lojadigicom.olhonoprecogames.TesteToggleButton;
...
public class OpcoesPrincipal extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        btnTestes = (View) v.findViewById(R.id.btnTestes);
    ...
    private void chamaTestes() {
        Intent vitrine = new Intent(this.getActivity(), TesteToggleButton.class);
    ...
    public void chamaOportunidade(View v) {
        Intent mIntent = new Intent(this.getActivity(),NaturezaProdutoDetalheImagemActivity.class);
        mIntent.putExtra(Constantes.CHAVE_TOOLBAR,"Oportunidades");
