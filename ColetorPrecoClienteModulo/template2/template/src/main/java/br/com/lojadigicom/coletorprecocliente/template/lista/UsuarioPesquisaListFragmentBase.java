...
public abstract class UsuarioPesquisaListFragmentBase extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    public interface Callback {
        ...
        public void onItemSelected(int idItemLista, UsuarioPesquisaListViewHolderBase vh);
    }
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = getListAdapter(getActivity(), new UsuarioPesquisaListAdapterBase.UsuarioPesquisaListAdapterOnClickHandler() {
            @Override
