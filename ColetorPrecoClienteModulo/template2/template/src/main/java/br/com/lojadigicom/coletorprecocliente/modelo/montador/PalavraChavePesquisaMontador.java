...
public class PalavraChavePesquisaMontador implements MontadorDaoI {
	...
	private PalavraChavePesquisa principal = new PalavraChavePesquisaVo();
	
	private boolean sinc = false;
	public PalavraChavePesquisaMontador(boolean sinc) {
		this.sinc = sinc;
	}
	public PalavraChavePesquisaMontador() {
		this.sinc = false;
	}
	...
	public DCIObjetoDominio getItem(Cursor c) {
		...
		objeto = new PalavraChavePesquisaVo();
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		PalavraChavePesquisa item = null;
		item = (PalavraChavePesquisa) entrada;
		item.setIdPalavraChavePesquisa(getInt(c,pos++));
		item.setTextoBusca(getString(c,pos++));
