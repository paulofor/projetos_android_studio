...
public abstract class PalavraChavePesquisaListFragmentBase extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    public interface Callback {
        ...
        public void onItemSelected(int idItemLista, PalavraChavePesquisaListViewHolderBase vh);
    }
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = getListAdapter(getActivity(), new PalavraChavePesquisaListAdapterBase.PalavraChavePesquisaListAdapterOnClickHandler() {
            @Override
