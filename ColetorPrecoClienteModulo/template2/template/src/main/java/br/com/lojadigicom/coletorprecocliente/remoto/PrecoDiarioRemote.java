...
public class PrecoDiarioRemote {
    ...
    public int listaSincronizadaDao(Context contexto, boolean delete) throws JSONException {
        ...
        try {
            ...
            if (delete) {
                contexto.getContentResolver().delete(PrecoDiarioContract.buildDeleteAllRecreate(), null, null);
            }
            contexto.getContentResolver().bulkInsert(PrecoDiarioContract.getContentUri(), vetor);
    ...
    private JSONObject JSonAtributos(Cursor c) throws JSONException {
        ...
        JSONObject json = new JSONObject();
        	json.put("IdPrecoDiario",c.getString(PrecoDiarioContract.COL_ID_PRECO_DIARIO));
		
        return json;
    }
     private JSONObject JSonAtributosSinc(Cursor c) throws JSONException {
        JSONObject json = JSonAtributos(c);
        json.put("OperacaoSinc",c.getString(PrecoDiarioContract.COL_OPERACAO_SINC));
        return json;
    }
    ...
    private ContentValues ContentValuesAtributos(JSONObject obj) throws JSONException {
		...
		valores.put(PrecoDiarioContract.COLUNA_ID_PRECO_DIARIO, obj.getString("IdPrecoDiario"));
