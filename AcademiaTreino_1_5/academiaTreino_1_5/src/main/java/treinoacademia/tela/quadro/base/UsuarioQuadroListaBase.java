...
import treinoacademia.view.adapter.UsuarioListAdapter;
...
public abstract class UsuarioQuadroListaBase extends BaseListFragment implements IQuadroListaEdicao {

	public final static String ITEM_CLICK = "UsuarioItemClick";

	UsuarioListAdapter adapt = null;
	private Button btnCriaItem = null;
	
	UsuarioServico servico = null;
	...
	protected IFragmentEdicao criaQuadroTrata() {
		throw new UnsupportedOperationException("Fazer override de criaQuadroTrata em UsuarioQuadroLista retornando new UsuarioQuadroTrata ou verificar se nao esta sendo chamada via super");
	}
	...
	protected UsuarioListAdapter getAdapter(List<Usuario> lista,DigicomContexto dContexto) {
		return new UsuarioListAdapter(lista,dContexto.getContext());
	}
