...
public abstract class SerieTreinoQuadroListaBase extends BaseListFragment implements IQuadroListaEdicao {

	public final static String ITEM_CLICK = "SerieTreinoItemClick";

	SerieTreinoListAdapter adapt = null;
	private Button btnCriaItem = null;
	
	SerieTreinoServico servico = null;
	...
	protected IFragmentEdicao criaQuadroTrata() {
		throw new UnsupportedOperationException("Fazer override de criaQuadroTrata em SerieTreinoQuadroLista retornando new SerieTreinoQuadroTrata ou verificar se nao esta sendo chamada via super");
	}
	...
	protected SerieTreinoListAdapter getAdapter(List<SerieTreino> lista,DigicomContexto dContexto) {
		return new SerieTreinoListAdapter(lista,dContexto.getContext());
	}
