...
public abstract class CargaPlanejadaQuadroListaBase extends BaseListFragment implements IQuadroListaEdicao {

	public final static String ITEM_CLICK = "CargaPlanejadaItemClick";

	CargaPlanejadaListAdapter adapt = null;
	private Button btnCriaItem = null;
	
	CargaPlanejadaServico servico = null;
	...
	protected IFragmentEdicao criaQuadroTrata() {
		throw new UnsupportedOperationException("Fazer override de criaQuadroTrata em CargaPlanejadaQuadroLista retornando new CargaPlanejadaQuadroTrata ou verificar se nao esta sendo chamada via super");
	}
	...
	protected CargaPlanejadaListAdapter getAdapter(List<CargaPlanejada> lista,DigicomContexto dContexto) {
		return new CargaPlanejadaListAdapter(lista,dContexto.getContext());
	}
