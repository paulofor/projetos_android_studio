...
public abstract class ItemSerieQuadroListaBase extends BaseListFragment implements IQuadroListaEdicao {

	public final static String ITEM_CLICK = "ItemSerieItemClick";

	ItemSerieListAdapter adapt = null;
	private Button btnCriaItem = null;
	
	ItemSerieServico servico = null;
	...
	protected IFragmentEdicao criaQuadroTrata() {
		throw new UnsupportedOperationException("Fazer override de criaQuadroTrata em ItemSerieQuadroLista retornando new ItemSerieQuadroTrata ou verificar se nao esta sendo chamada via super");
	}
	...
	protected ItemSerieListAdapter getAdapter(List<ItemSerie> lista,DigicomContexto dContexto) {
		return new ItemSerieListAdapter(lista,dContexto.getContext());
	}
