...
import treinoacademia.view.adapter.listauso.DiaTreinoListUsoAdapter;
...
public abstract class DiaTreinoListaUsoBase extends BaseListFragment implements IQuadroLista {

	public final static String ITEM_CLICK = "DiaTreinoItemClick";

	private DiaTreinoListUsoAdapterBase adapt = null;
	...
	protected void atualizaLista(List<DiaTreino> listaNova) {
	...
	*/
	...
	private void preencheLista() {
        ...
        DCLog.d(DCLog.SERVICO_QUADRO_LISTA, this, "getListaCorrente : List<DiaTreino> -> " + lista.size() + " itens (Adapter:" + adapt.getClass().getName() + ")");
        adapt.setRaiz(this);
        setListAdapter(adapt);
	}
	
	protected DiaTreinoListUsoAdapterBase getAdapter(List<DiaTreino> lista,DigicomContexto dContexto) {
		return new DiaTreinoListUsoAdapter(lista,dContexto);
	}
