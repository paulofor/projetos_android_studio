...
import treinoacademia.view.adapter.listaedicao.UsuarioListEdicaoAdapter;
...
public abstract class UsuarioListaEdicaoBase extends BaseListFragment implements IQuadroListaEdicao  
	...
	public void onToqueLongoTela(DCIObjetoDominio obj) {
		...
		bundle.setObjeto(Constantes.CHAVE_USUARIO, obj);
	...
	public final void chamaCriaItem() {
		...
		BundleFragment bundle = new BundleFragment();
		bundle.setObjeto(Constantes.CHAVE_USUARIO, nova);
