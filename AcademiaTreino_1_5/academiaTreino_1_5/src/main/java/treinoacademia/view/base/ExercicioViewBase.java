...
// classes de UI
public abstract class ExercicioViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public ExercicioViewBase(Context context, Exercicio item) {
		throw new UnsupportedOperationException("Usar o construtor novo de ExercicioView");
	}
	@Override
	...
	public ExercicioViewBase(Exercicio item) {
		super();
		this.item = item;
	...
	protected ResourceObj getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_exercicio ou similar");
	}
	...
	public final void extraiBundle() {
		item = (Exercicio) this.getBundle().getObjeto(Constantes.CHAVE_EXERCICIO);
	}
}