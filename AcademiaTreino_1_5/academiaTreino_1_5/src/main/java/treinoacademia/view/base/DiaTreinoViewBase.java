...
// classes de UI
public abstract class DiaTreinoViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public DiaTreinoViewBase(Context context, DiaTreino item) {
		throw new UnsupportedOperationException("Usar o construtor novo de DiaTreinoView");
	}
	@Override
	...
	public DiaTreinoViewBase(DiaTreino item) {
		super();
		this.item = item;
	...
	protected ResourceObj getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_dia_treino ou similar");
	}
