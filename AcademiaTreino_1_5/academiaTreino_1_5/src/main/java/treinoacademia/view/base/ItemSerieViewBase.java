...
// classes de UI
public abstract class ItemSerieViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public ItemSerieViewBase(Context context, ItemSerie item) {
		throw new UnsupportedOperationException("Usar o construtor novo de ItemSerieView");
	}
	@Override
	...
	private ItemSerie item;
	
	protected ItemSerie getItem() {
	...
	public ItemSerieViewBase(ItemSerie item) {
		super();
		this.item = item;
	...
	protected ResourceObj getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_item_serie ou similar");
	}
	...
	public final void extraiBundle() {
		item = (ItemSerie) this.getBundle().getObjeto(Constantes.CHAVE_ITEM_SERIE);
	}
}