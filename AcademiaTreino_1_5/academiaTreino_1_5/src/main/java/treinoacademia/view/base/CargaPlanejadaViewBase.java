...
// classes de UI
public abstract class CargaPlanejadaViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public CargaPlanejadaViewBase(Context context, CargaPlanejada item) {
		throw new UnsupportedOperationException("Usar o construtor novo de CargaPlanejadaView");
	}
	@Override
	...
	private CargaPlanejada item;
	
	protected CargaPlanejada getItem() {
	...
	public CargaPlanejadaViewBase(CargaPlanejada item) {
		super();
		this.item = item;
	...
	protected ResourceObj getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_carga_planejada ou similar");
	}
	...
	public final void extraiBundle() {
		item = (CargaPlanejada) this.getBundle().getObjeto(Constantes.CHAVE_CARGA_PLANEJADA);
	}
}