...
// classes de UI
public abstract class UsuarioViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public UsuarioViewBase(Context context, Usuario item) {
		throw new UnsupportedOperationException("Usar o construtor novo de UsuarioView");
	}
	@Override
	...
	public UsuarioViewBase(Usuario item) {
		super();
		this.item = item;
	...
	protected ResourceObj getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_usuario ou similar");
	}
	...
	public final void extraiBundle() {
		item = (Usuario) this.getBundle().getObjeto(Constantes.CHAVE_USUARIO);
	}
}