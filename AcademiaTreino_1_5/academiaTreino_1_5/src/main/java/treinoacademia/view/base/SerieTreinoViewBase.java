...
// classes de UI
public abstract class SerieTreinoViewBase extends BaseFragment{
	
	
	//Construtor antigo
	public SerieTreinoViewBase(Context context, SerieTreino item) {
		throw new UnsupportedOperationException("Usar o construtor novo de SerieTreinoView");
	}
	@Override
	...
	public SerieTreinoViewBase(SerieTreino item) {
		super();
		this.item = item;
	...
	protected ResourceObj getLayoutTela() {
		throw new UnsupportedOperationException("Fazer override de getLayoutTela em " + this.getClass().getSimpleName() + " retornando view_serie_treino ou similar");
	}
	...
	public final void extraiBundle() {
		item = (SerieTreino) this.getBundle().getObjeto(Constantes.CHAVE_SERIE_TREINO);
	}
}