...
public abstract class DiaTreinoListEdicaoAdapterBase extends DCBaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public DiaTreinoListEdicaoAdapterBase(List<DiaTreino> lista, IQuadroListaEdicao origem, Context context ) {
	...
	protected int getLayout() {
		return R.layout.item_dia_treino;
	}
