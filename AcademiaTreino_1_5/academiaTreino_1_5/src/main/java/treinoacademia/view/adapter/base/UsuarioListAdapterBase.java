...
import treinoacademia.tela.quadro.base.UsuarioQuadroListaBase;

public abstract class UsuarioListAdapterBase extends DCBaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (!(saida instanceof ItemLista))
			throw new RuntimeException("Alterar layout raiz de R.layout.item_usuario para br.com.digicom.layout.IItemLista");
