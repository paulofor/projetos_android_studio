...
public abstract class SerieTreinoListAdapterBase extends DCBaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public SerieTreinoListAdapterBase(List<SerieTreino> lista, Context context ) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View saida = LayoutInflater.from(context).inflate(R.layout.item_serie_treino, null);
