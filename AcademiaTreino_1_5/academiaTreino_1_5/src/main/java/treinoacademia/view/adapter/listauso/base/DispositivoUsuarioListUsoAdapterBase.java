...
public abstract class DispositivoUsuarioListUsoAdapterBase extends DCBaseAdapter {
	...
	protected void montaItemLista(int position, DispositivoUsuario item, View saida) {
		throw new UnsupportedOperationException("Fazer override de montaIItemLista em "  + this.getClass().getSimpleName() + " ou verificar se nao esta sendo chamada via super. Arquivo de visao padrao eh: R.layout.item_dispositivo_usuario");
	}
