...
public abstract class CargaPlanejadaListUsoAdapterBase extends DCBaseAdapter {
	...
	public CargaPlanejadaListUsoAdapterBase(List<CargaPlanejada> lista, DigicomContexto context ) {
		this.context = context;
		this.lista = lista;
		setEdicao(); // Forcando para fazer edicao - alterar se for necessario depois.
	}
	
	public void setListaNova(List<CargaPlanejada> listaNova) {
	...
	protected void montaItemLista(int position, CargaPlanejada item, View saida) {
		throw new UnsupportedOperationException("Fazer override de montaIItemLista em "  + this.getClass().getSimpleName() + " ou verificar se nao esta sendo chamada via super. Arquivo de visao padrao eh: R.layout.item_carga_planejada");
	}
	protected ResourceObj getLayoutItem() {
		return new ResourceObj(R.layout.item_carga_planejada,"R.layout.item_carga_planejada");
	}
