...
public abstract class ItemSerieListUsoAdapterBase extends DCBaseAdapter {
	...
	public ItemSerieListUsoAdapterBase(List<ItemSerie> lista, DigicomContexto context ) {
		this.context = context;
		this.lista = lista;
		setEdicao(); // Forcando para fazer edicao - alterar se for necessario depois.
	}
	
	public void setListaNova(List<ItemSerie> listaNova) {
	...
	protected void montaItemLista(int position, ItemSerie item, View saida) {
		throw new UnsupportedOperationException("Fazer override de montaIItemLista em "  + this.getClass().getSimpleName() + " ou verificar se nao esta sendo chamada via super. Arquivo de visao padrao eh: R.layout.item_item_serie");
	}
	protected ResourceObj getLayoutItem() {
		return new ResourceObj(R.layout.item_item_serie,"R.layout.item_item_serie");
	}
