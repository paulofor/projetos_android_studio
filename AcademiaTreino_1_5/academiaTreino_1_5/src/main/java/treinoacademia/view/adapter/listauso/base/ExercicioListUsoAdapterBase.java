...
public abstract class ExercicioListUsoAdapterBase extends DCBaseAdapter {
	...
	public ExercicioListUsoAdapterBase(List<Exercicio> lista, DigicomContexto context ) {
		this.context = context;
		this.lista = lista;
		setEdicao(); // Forcando para fazer edicao - alterar se for necessario depois.
	}
	
	public void setListaNova(List<Exercicio> listaNova) {
	...
	protected void montaItemLista(int position, Exercicio item, View saida) {
		throw new UnsupportedOperationException("Fazer override de montaIItemLista em "  + this.getClass().getSimpleName() + " ou verificar se nao esta sendo chamada via super. Arquivo de visao padrao eh: R.layout.item_exercicio");
	}
	protected ResourceObj getLayoutItem() {
		return new ResourceObj(R.layout.item_exercicio,"R.layout.item_exercicio");
	}
