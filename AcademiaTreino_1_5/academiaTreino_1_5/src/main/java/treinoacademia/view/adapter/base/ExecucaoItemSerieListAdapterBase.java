...
public abstract class ExecucaoItemSerieListAdapterBase extends DCBaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public ExecucaoItemSerieListAdapterBase(List<ExecucaoItemSerie> lista, Context context ) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View saida = LayoutInflater.from(context).inflate(R.layout.item_execucao_item_serie, null);
