...
public abstract class UsuarioListUsoAdapterBase extends DCBaseAdapter {
	...
	protected void montaItemLista(int position, Usuario item, View saida) {
		throw new UnsupportedOperationException("Fazer override de montaIItemLista em "  + this.getClass().getSimpleName() + " ou verificar se nao esta sendo chamada via super. Arquivo de visao padrao eh: R.layout.item_usuario");
	}
