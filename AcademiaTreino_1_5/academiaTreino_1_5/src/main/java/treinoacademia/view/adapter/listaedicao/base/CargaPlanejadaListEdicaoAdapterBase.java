...
public abstract class CargaPlanejadaListEdicaoAdapterBase extends DCBaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public CargaPlanejadaListEdicaoAdapterBase(List<CargaPlanejada> lista, IQuadroListaEdicao origem, Context context ) {
	...
	protected int getLayout() {
		return R.layout.item_carga_planejada;
	}
	
	protected void montaItemLista(int position, CargaPlanejada item, View saida) {
