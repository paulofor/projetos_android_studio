...
public abstract class ItemSerieListEdicaoAdapterBase extends DCBaseAdapter implements OnTouchListener, OnLongClickListener{
	...
	public ItemSerieListEdicaoAdapterBase(List<ItemSerie> lista, IQuadroListaEdicao origem, Context context ) {
	...
	protected int getLayout() {
		return R.layout.item_item_serie;
	}
