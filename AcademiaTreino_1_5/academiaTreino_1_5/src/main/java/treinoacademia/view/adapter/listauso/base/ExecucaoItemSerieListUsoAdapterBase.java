...
public abstract class ExecucaoItemSerieListUsoAdapterBase extends DCBaseAdapter {
	...
	public ExecucaoItemSerieListUsoAdapterBase(List<ExecucaoItemSerie> lista, DigicomContexto context ) {
		this.context = context;
		this.lista = lista;
		setEdicao(); // Forcando para fazer edicao - alterar se for necessario depois.
	}
	
	public void setListaNova(List<ExecucaoItemSerie> listaNova) {
	...
	protected void montaItemLista(int position, ExecucaoItemSerie item, View saida) {
		throw new UnsupportedOperationException("Fazer override de montaIItemLista em "  + this.getClass().getSimpleName() + " ou verificar se nao esta sendo chamada via super. Arquivo de visao padrao eh: R.layout.item_execucao_item_serie");
	}
	protected ResourceObj getLayoutItem() {
		return new ResourceObj(R.layout.item_execucao_item_serie,"R.layout.item_execucao_item_serie");
	}
