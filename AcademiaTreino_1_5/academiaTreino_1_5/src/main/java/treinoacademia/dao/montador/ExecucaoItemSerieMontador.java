...
public class ExecucaoItemSerieMontador extends MontadorDaoBase implements MontadorDaoI{
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		...
		item = (ExecucaoItemSerie) entrada;item.setIdExecucaoItemSerie(getInt(c,pos++));
