...
//import treinoacademia.dao.base.UsuarioDBHelper;
...
*/
	...
	public abstract void excluiParaSincronizacao(Usuario item);
	public abstract void criaTabelaSincronizacao();
	
	
	
	public abstract Usuario ObtemNoAparelho(DigicomContexto contexto );
