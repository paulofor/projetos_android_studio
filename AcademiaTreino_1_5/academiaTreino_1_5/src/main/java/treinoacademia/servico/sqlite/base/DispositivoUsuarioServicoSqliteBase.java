...
import treinoacademia.dao.DispositivoUsuarioDBHelper;
...
public abstract class DispositivoUsuarioServicoSqliteBase extends  DispositivoUsuarioServico 
	...
	public void excluiParaSincronizacao(DispositivoUsuario item) {
	...
	public List<DispositivoUsuario> getPorReferenteAUsuario(long id) {
		...
		try {
			...
			DCLog.dStack(DCLog.SERVICO_OPERACAO_PADRAO, this, "getPorReferenteAUsuario : " +  saida.size() + " itens (id_dispositivo_usuario=" + id + ")" );
		} catch (DaoException e) {
			DCLog.e(DCLog.DATABASE_ERRO, this, e);
			TrataErro.getInstancia().setErro(e);
		}
