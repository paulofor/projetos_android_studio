...
public abstract class UsuarioServicoSqliteBase extends  UsuarioServico 
	...
	//public List<Usuario> ObtemNoAparelho(Context contexto){}
	...
	public void excluiParaSincronizacao(Usuario item) {
	...
	public final Usuario ObtemNoAparelho(DigicomContexto contexto ) {
		Usuario saida = null;
		try {
			saida =  ObtemNoAparelhoImpl(contexto);
			DCLog.dStack(DCLog.SERVICO_OPERACAO, this, "ObtemNoAparelho : " +  (saida!=null?saida.toString():"null") );
		} catch (Exception e) {
			TrataErro.getInstancia().setErro(e);
		}
		return saida;
	}
	protected abstract Usuario ObtemNoAparelhoImpl(DigicomContexto contexto ) throws DaoException;
	@Override
