...
public abstract class ExecucaoItemSerieListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (747 * 10) + 1;
    ...
    protected abstract void trataLista(List<ExecucaoItemSerie> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<ExecucaoItemSerie> converteLista(Cursor data) {
