...
public abstract class CargaPlanejadaListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (746 * 10) + 1;
    ...
    protected abstract void trataLista(List<CargaPlanejada> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<CargaPlanejada> converteLista(Cursor data) {
