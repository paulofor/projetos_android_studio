...
import br.com.lojadigicom.treinoacademia.servico.base.GrupoMuscularServico;
import br.com.lojadigicom.treinoacademia.servico.base.FabricaServico;
import br.com.lojadigicom.treinoacademia.modelo.GrupoMuscularVo;
import br.com.lojadigicom.treinoacademia.framework.log.DCLog;

public abstract class GrupoMuscularFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private GrupoMuscular item = null;
	
	protected GrupoMuscularServico srv = FabricaServico.getInstancia().getGrupoMuscularServico();
	
	protected GrupoMuscular getItem() {
		return item;
	}
	public void setItem(GrupoMuscular valor) {
		item = valor;
	}
    ...
    protected abstract void copiaTelaParaVo(GrupoMuscular item);
