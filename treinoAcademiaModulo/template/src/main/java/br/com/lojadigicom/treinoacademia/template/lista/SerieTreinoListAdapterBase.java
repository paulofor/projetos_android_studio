 ...
 */
public abstract class SerieTreinoListAdapterBase extends RecyclerView.Adapter<SerieTreinoListViewHolderBase>{

    //protected Cursor mCursor;
    protected List<SerieTreino> mLista;
    private Context mContext;
    private SerieTreinoListAdapterOnClickHandler mClickHandler;
    private View mEmptyView;
    private ItemChoiceManager mICM = null;
    protected ResourceObj resourceObj = getLayoutItemResource();

    public SerieTreinoListAdapterBase(Context context, SerieTreinoListAdapterOnClickHandler dh, View emptyView, int choiceMode) {
        mContext = context;
        mClickHandler = dh;
    ...
    @Override
    public final SerieTreinoListViewHolderBase onCreateViewHolder(ViewGroup parent, int viewType) {
        if ( parent instanceof RecyclerView ) {
            ...
            SerieTreinoListViewHolderBase saida = getViewHolder(view);
    ...
    protected abstract SerieTreinoListViewHolderBase getViewHolder(View v);
    ...
    public final void swapCursor(List<SerieTreino> novaLista) {
        //mCursor = newCursor;
        mLista = novaLista;
    ...
    public static interface SerieTreinoListAdapterOnClickHandler {
        void onClick(int id, SerieTreinoListViewHolderBase vh);
    }
    
    
    @Override
    public void onBindViewHolder(SerieTreinoListViewHolderBase holder, int position) {
        SerieTreino obj = mLista.get(position);
        holder.setItem(obj);
        onBindViewHolderDC(obj,holder,position);
    }

    protected abstract void onBindViewHolderDC(SerieTreino item,SerieTreinoListViewHolderBase holder, int position);
