...
public abstract class ItemSerieListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (745 * 10) + 1;
    ...
    protected abstract void trataLista(List<ItemSerie> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<ItemSerie> converteLista(Cursor data) {
