...
import br.com.lojadigicom.treinoacademia.servico.base.ErroExceptionServico;
...
public abstract class ErroExceptionFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private ErroException item = null;
	
	protected ErroExceptionServico srv = FabricaServico.getInstancia().getErroExceptionServico();
    ...
    protected abstract void copiaTelaParaVo(ErroException item);
