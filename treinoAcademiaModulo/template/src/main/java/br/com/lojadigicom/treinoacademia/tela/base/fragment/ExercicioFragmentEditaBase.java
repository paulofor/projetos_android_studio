...
import br.com.lojadigicom.treinoacademia.servico.base.ExercicioServico;
...
public abstract class ExercicioFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private Exercicio item = null;
	
	protected ExercicioServico srv = FabricaServico.getInstancia().getExercicioServico();
	
	protected Exercicio getItem() {
		return item;
	}
	public void setItem(Exercicio valor) {
		item = valor;
	}
    ...
    protected abstract void copiaTelaParaVo(Exercicio item);
