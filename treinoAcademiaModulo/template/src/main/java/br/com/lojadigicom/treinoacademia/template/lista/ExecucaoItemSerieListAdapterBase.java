 ...
 */
public abstract class ExecucaoItemSerieListAdapterBase extends RecyclerView.Adapter<ExecucaoItemSerieListViewHolderBase>{

    //protected Cursor mCursor;
    protected List<ExecucaoItemSerie> mLista;
    private Context mContext;
    private ExecucaoItemSerieListAdapterOnClickHandler mClickHandler;
    private View mEmptyView;
    private ItemChoiceManager mICM = null;
    protected ResourceObj resourceObj = getLayoutItemResource();

    public ExecucaoItemSerieListAdapterBase(Context context, ExecucaoItemSerieListAdapterOnClickHandler dh, View emptyView, int choiceMode) {
        mContext = context;
        mClickHandler = dh;
    ...
    @Override
    public final ExecucaoItemSerieListViewHolderBase onCreateViewHolder(ViewGroup parent, int viewType) {
        if ( parent instanceof RecyclerView ) {
            ...
            ExecucaoItemSerieListViewHolderBase saida = getViewHolder(view);
    ...
    protected abstract ExecucaoItemSerieListViewHolderBase getViewHolder(View v);
    ...
    public final void swapCursor(List<ExecucaoItemSerie> novaLista) {
        //mCursor = newCursor;
        mLista = novaLista;
    ...
    public static interface ExecucaoItemSerieListAdapterOnClickHandler {
        void onClick(int id, ExecucaoItemSerieListViewHolderBase vh);
    }
    
    
    @Override
    public void onBindViewHolder(ExecucaoItemSerieListViewHolderBase holder, int position) {
        ExecucaoItemSerie obj = mLista.get(position);
        holder.setItem(obj);
        onBindViewHolderDC(obj,holder,position);
    }

    protected abstract void onBindViewHolderDC(ExecucaoItemSerie item,ExecucaoItemSerieListViewHolderBase holder, int position);
