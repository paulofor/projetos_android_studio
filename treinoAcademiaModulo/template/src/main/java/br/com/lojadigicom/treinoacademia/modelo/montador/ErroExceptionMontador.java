...
import br.com.lojadigicom.treinoacademia.modelo.ErroExceptionVo;
...
public class ErroExceptionMontador implements MontadorDaoI {

	private ErroException principal = new ErroExceptionVo();
	
	private boolean sinc = false;
	public ErroExceptionMontador(boolean sinc) {
		this.sinc = sinc;
	}
	public ErroExceptionMontador() {
		this.sinc = false;
	}
	...
	public DCIObjetoDominio getItem(Cursor c) {
		...
		//objeto = FabricaVo.criaErroException();
		objeto = new ErroExceptionVo();
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		ErroException item = null;
		item = (ErroException) entrada;
		item.setIdErroException(getInt(c,pos++));
		item.setStack(getString(c,pos++));
		item.setAplicacao(getString(c,pos++));
