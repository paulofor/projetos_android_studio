 ...
 */
public abstract class GrupoMuscularListViewHolderBase extends RecyclerView.ViewHolder implements View.OnClickListener{

    //protected Cursor mCursor;
    protected List mLista;
    protected GrupoMuscularListAdapterBase.GrupoMuscularListAdapterOnClickHandler mClickHandler;
    protected ItemChoiceManager mICM = null;


	private GrupoMuscular item;
	public void setItem(GrupoMuscular dado) {
		item = dado;
	}
	public GrupoMuscular getItem() {
		return item;
	}
    ...
    public void setOnClickHandler(GrupoMuscularListAdapterBase.GrupoMuscularListAdapterOnClickHandler valor){
        mClickHandler = valor;
    }

    public GrupoMuscularListViewHolderBase(View itemView) {
        super(itemView);
