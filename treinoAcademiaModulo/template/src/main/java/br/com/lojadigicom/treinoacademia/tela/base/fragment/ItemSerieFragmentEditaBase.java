...
import br.com.lojadigicom.treinoacademia.servico.base.ItemSerieServico;
import br.com.lojadigicom.treinoacademia.servico.base.FabricaServico;
import br.com.lojadigicom.treinoacademia.modelo.ItemSerieVo;
import br.com.lojadigicom.treinoacademia.framework.log.DCLog;

public abstract class ItemSerieFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private ItemSerie item = null;
	
	protected ItemSerieServico srv = FabricaServico.getInstancia().getItemSerieServico();
	
	protected ItemSerie getItem() {
		return item;
	}
	public void setItem(ItemSerie valor) {
		item = valor;
	}
    ...
    protected abstract void copiaTelaParaVo(ItemSerie item);
