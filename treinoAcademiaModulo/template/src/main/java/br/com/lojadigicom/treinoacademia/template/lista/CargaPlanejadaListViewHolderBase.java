 ...
 */
public abstract class CargaPlanejadaListViewHolderBase extends RecyclerView.ViewHolder implements View.OnClickListener{

    //protected Cursor mCursor;
    protected List mLista;
    protected CargaPlanejadaListAdapterBase.CargaPlanejadaListAdapterOnClickHandler mClickHandler;
    protected ItemChoiceManager mICM = null;


	private CargaPlanejada item;
	public void setItem(CargaPlanejada dado) {
		item = dado;
	}
	public CargaPlanejada getItem() {
		return item;
	}
    ...
    public void setOnClickHandler(CargaPlanejadaListAdapterBase.CargaPlanejadaListAdapterOnClickHandler valor){
        mClickHandler = valor;
    }

    public CargaPlanejadaListViewHolderBase(View itemView) {
        super(itemView);
