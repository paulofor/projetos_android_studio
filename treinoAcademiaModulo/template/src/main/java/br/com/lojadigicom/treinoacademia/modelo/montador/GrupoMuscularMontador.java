...
public class GrupoMuscularMontador implements MontadorDaoI {

	private GrupoMuscular principal = new GrupoMuscularVo();
	
	private boolean sinc = false;
	public GrupoMuscularMontador(boolean sinc) {
		this.sinc = sinc;
	}
	public GrupoMuscularMontador() {
		this.sinc = false;
	}
	...
	public DCIObjetoDominio getItem(Cursor c) {
		...
		//objeto = FabricaVo.criaGrupoMuscular();
		objeto = new GrupoMuscularVo();
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		GrupoMuscular item = null;
		item = (GrupoMuscular) entrada;
		item.setIdGrupoMuscular(getInt(c,pos++));
		item.setNomeGrupo(getString(c,pos++));
		item.setImagemGrupo(getString(c,pos++));
