...
public abstract class DiaTreinoListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (748 * 10) + 1;
    ...
    protected abstract void trataLista(List<DiaTreino> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<DiaTreino> converteLista(Cursor data) {
