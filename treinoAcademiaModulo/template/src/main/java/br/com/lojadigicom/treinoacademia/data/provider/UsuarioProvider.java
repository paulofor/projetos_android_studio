...
public abstract class UsuarioProvider {
	...
	public static final int USUARIO = 74200;
	public static final int USUARIO_ID = 74201;
	public static final int USUARIO_SINC = 74203;
	public static final int USUARIO_E_COMPLEMENTO = 74204;
	public static final int USUARIO_ID_E_COMPLEMENTO = 74205;
	//public static final int USUARIO_OPERACAO = 74202;
	
	// deletes
	public static final int USUARIO_DELETE_ALL_SINC = 74206;
	public static final int USUARIO_DELETE_RECREATE = 74207;
	public static final int USUARIO_DELETE_SINC = 74208;
	public static final int USUARIO_E_RETIRADA = 74209;
	...
	private static final String sPorChaveSel = UsuarioContract.TABLE_NAME + "." + UsuarioContract.COLUNA_CHAVE + " = ? ";
 	...
 	public static final int OBTEMNOAPARELHO = 74220;
	...
	public static void buildUriMatcher(UriMatcher matcher) {
		...
		matcher.addURI(UsuarioContract.getContentAuthority(), UsuarioContract.PATH + "/ObtemNoAparelho/*", OBTEMNOAPARELHO);
	...
	public Cursor query(UriMatcher sUriMatcher, Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
		...
		switch (sUriMatcher.match(uri)) {
			...
			case USUARIO_E_RETIRADA:
			{
	 		...
	 		case OBTEMNOAPARELHO:
			{
				DCLog.d(DCLog.OPERACAO_DB_TELA,this,"Match Provider: OBTEMNOAPARELHO");
				DCLog.d(DCLog.TRACE_LISTA,this,"chamar queryObtemNoAparelho()");
				//retCursor = queryObtemNoAparelho(uri,projection,sortOrder);
				String param = uri.getQuery();
				String sql = queryObtemNoAparelho(param) + (sortOrder!=null?" order by " + sortOrder:"");
	...
	protected abstract String queryObtemNoAparelho(String param);
	...
	private void notificaUriOperacoes() {
		...
		mProvider.getContext().getContentResolver().notifyChange(UsuarioContract.buildObtemNoAparelho(), null);
