 ...
 */
public abstract class ItemSerieListViewHolderBase extends RecyclerView.ViewHolder implements View.OnClickListener{

    //protected Cursor mCursor;
    protected List mLista;
    protected ItemSerieListAdapterBase.ItemSerieListAdapterOnClickHandler mClickHandler;
    protected ItemChoiceManager mICM = null;


	private ItemSerie item;
	public void setItem(ItemSerie dado) {
		item = dado;
	}
    ...
    public void setOnClickHandler(ItemSerieListAdapterBase.ItemSerieListAdapterOnClickHandler valor){
        mClickHandler = valor;
    }

    public ItemSerieListViewHolderBase(View itemView) {
        super(itemView);
