...
import br.com.lojadigicom.treinoacademia.modelo.montador.UsuarioMontador;
...
public final class UsuarioContract implements BaseColumns {
    ...
    public static final int COL_NUMERO_CELULAR = 2;
    public static final String COLUNA_MELHOR_PATH = "melhor_path";
    public static final int COL_MELHOR_PATH = 3;
    ...
    private static UsuarioOperacao operacao = new UsuarioOperacao();
 	public static Uri buildObtemNoAparelho() {
		return operacao.buildObtemNoAparelho(getFiltro());
    }
    private static MontadorDaoI _montadorObtemNoAparelho = null;
    public static MontadorDaoI getMontadorObtemNoAparelho() {
    	return _montadorObtemNoAparelho;
    }
    public static void setMontadorObtemNoAparelho(MontadorDaoI montador) {
    	_montadorObtemNoAparelho = montador;
    }
