...
public abstract class GrupoMuscularListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (848 * 10) + 1;
    ...
    protected abstract void trataLista(List<GrupoMuscular> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<GrupoMuscular> converteLista(Cursor data) {
