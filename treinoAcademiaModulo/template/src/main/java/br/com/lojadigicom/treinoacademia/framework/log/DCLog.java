...
package  br.com.lojadigicom.treinoacademia.framework.log;
...
/*
Displayed (do Android) -> mostra activity com o tempo para montagem.

TraceLista -> Para resolver problemas de fragment list.
QuerySql -> Mostra as consultas em sql aao banco.
TraceDisplay -> Mostra as activitys e fragments da navegacao.

 */

public class DCLog {

	public static final String BILLING = "BillingLog";
	public static final String TRACE_LISTA = "TraceLista";
	public static final String QUERY_SQL = "QuerySql";
	public static final String TRACE_DISPLAY = "TraceDisplay";
	public static final String TRACE_CRUD = "TraceCrud";
	public static final String TRACE_SINC = "TraceSinc";
	public static final String IMAGEM_CACHE = "ImagemCache";
	...
	public static final String SERVICO_DATABASE = "ServicoDatabase";
	...
	public static final String SINCRONIZACAO_GCM = "GcmSinc";
