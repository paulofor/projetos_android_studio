...
public abstract class SerieTreinoListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (744 * 10) + 1;
    ...
    protected abstract void trataLista(List<SerieTreino> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<SerieTreino> converteLista(Cursor data) {
