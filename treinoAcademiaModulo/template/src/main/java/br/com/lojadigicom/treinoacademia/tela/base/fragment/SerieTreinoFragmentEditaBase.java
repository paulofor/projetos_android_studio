...
import br.com.lojadigicom.treinoacademia.servico.base.SerieTreinoServico;
...
public abstract class SerieTreinoFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private SerieTreino item = null;
	
	protected SerieTreinoServico srv = FabricaServico.getInstancia().getSerieTreinoServico();
	
	protected SerieTreino getItem() {
		return item;
	}
	public void setItem(SerieTreino valor) {
		item = valor;
	}
    ...
    protected abstract void copiaTelaParaVo(SerieTreino item);
