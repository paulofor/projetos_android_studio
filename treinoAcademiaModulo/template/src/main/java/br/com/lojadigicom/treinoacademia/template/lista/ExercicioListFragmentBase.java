...
public abstract class ExercicioListFragmentBase extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>{

    private RecyclerView mRecyclerView;
    private ExercicioListAdapterBase mAdapter;

    private int mPosition = RecyclerView.NO_POSITION;
    private int mChoiceMode;
    private static final String SELECTED_KEY = "selected_position";
    private static final int FORECAST_LOADER = 743;
	...
	public ExercicioListFragmentBase() {
    }


	private final void onItemSelected(int idItemLista, ExercicioListViewHolderBase vh) {
        ...
        intent.putExtra(Constantes.EXERCICIO_ID,idItemLista);
        if (idItemLista==0) {
    ...
    protected abstract void montaAminacao(ExercicioListViewHolderBase vh, ArrayList<Pair<View,String>> lista);
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = getListAdapter(this.getActivity(), new ExercicioListAdapterBase.ExercicioListAdapterOnClickHandler() {
            @Override
            public void onClick(int idItemLista, ExercicioListViewHolderBase vh) {
    ...
    protected abstract ExercicioListAdapterBase getListAdapter(FragmentActivity activity, ExercicioListAdapterBase.ExercicioListAdapterOnClickHandler onClickHandler, View emptyView, int mChoiceMode);

	/*
 	public void registraPosicao(ExercicioListViewHolderBase vh) {
        SharedPreferences pref = getActivity().getSharedPreferences("br.com.lojadigicom.treinoacademia", Context.MODE_PRIVATE);
        SharedPreferences.Editor edt = pref.edit();
        edt.putInt(Constantes.EXERCICIO_POSICAO, vh.getAdapterPosition());
        edt.commit();
    }
    private void recuperaPosicao() {
        SharedPreferences pref = getActivity().getSharedPreferences("br.com.lojadigicom.treinoacademia", Context.MODE_PRIVATE);
        mPosition = pref.getInt(Constantes.EXERCICIO_POSICAO,RecyclerView.NO_POSITION);
    }
	*/
    ...
    public final void onLoadFinished(Loader<Cursor> loader, Cursor data) {
    	...
    	DCLog.d(DCLog.OPERACAO_DB_TELA,this,"Lista Exercicio " + lista.size() + " itens");
	...
	protected MontadorDaoI getMontador() {
        return ExercicioContract.getMontador();
    }

    protected final List<Exercicio> converteLista(Cursor data) {
	...
	protected long mIdGrupoMuscular;
	public final void setIdGrupoMuscular(long id) {
		mIdGrupoMuscular = id;
	}
