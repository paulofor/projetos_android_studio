...
public class DiaTreinoMontador implements MontadorDaoI {

	private DiaTreino principal = new DiaTreinoVo();
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		DiaTreino item = null;
		item = (DiaTreino) entrada;
		item.setIdDiaTreino(getInt(c,pos++));
