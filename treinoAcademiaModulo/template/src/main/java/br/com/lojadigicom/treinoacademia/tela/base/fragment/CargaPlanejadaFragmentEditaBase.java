...
import br.com.lojadigicom.treinoacademia.servico.base.CargaPlanejadaServico;
import br.com.lojadigicom.treinoacademia.servico.base.FabricaServico;
import br.com.lojadigicom.treinoacademia.modelo.CargaPlanejadaVo;
import br.com.lojadigicom.treinoacademia.framework.log.DCLog;

public abstract class CargaPlanejadaFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private CargaPlanejada item = null;
	
	protected CargaPlanejadaServico srv = FabricaServico.getInstancia().getCargaPlanejadaServico();
	
	protected CargaPlanejada getItem() {
		return item;
	}
	public void setItem(CargaPlanejada valor) {
		item = valor;
	}
    ...
    protected abstract void copiaTelaParaVo(CargaPlanejada item);
