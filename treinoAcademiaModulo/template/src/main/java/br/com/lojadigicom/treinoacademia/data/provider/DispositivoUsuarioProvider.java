...
public abstract class DispositivoUsuarioProvider {
	...
	public static final int DISPOSITIVO_USUARIO = 77600;
	public static final int DISPOSITIVO_USUARIO_ID = 77601;
	public static final int DISPOSITIVO_USUARIO_SINC = 77603;
	public static final int DISPOSITIVO_USUARIO_E_COMPLEMENTO = 77604;
	public static final int DISPOSITIVO_USUARIO_ID_E_COMPLEMENTO = 77605;
	//public static final int DISPOSITIVO_USUARIO_OPERACAO = 77602;
	
	// deletes
	public static final int DISPOSITIVO_USUARIO_DELETE_ALL_SINC = 77606;
	public static final int DISPOSITIVO_USUARIO_DELETE_RECREATE = 77607;
	public static final int DISPOSITIVO_USUARIO_DELETE_SINC = 77608;
	public static final int DISPOSITIVO_USUARIO_E_RETIRADA = 77609;
	
	private static final String sPorChaveSel = DispositivoUsuarioContract.TABLE_NAME + "." + DispositivoUsuarioContract.COLUNA_CHAVE + " = ? ";
	
	
	
	public static final int DISPOSITIVO_USUARIO_POR_USUARIO_REFERENTEA = 77620;
	public static final int COM_USUARIO = 77621;
