...
public class UsuarioRemote {
    ...
    private JSONObject JSonAtributos(Cursor c) throws JSONException {
		...
		json.put("NumeroCelular",c.getString(UsuarioContract.COL_NUMERO_CELULAR));
		
			
		
		json.put("MelhorPath",c.getString(UsuarioContract.COL_MELHOR_PATH));
    ...
    private ContentValues ContentValuesAtributos(JSONObject obj) throws JSONException {
		...
		valores.put(UsuarioContract.COLUNA_NUMERO_CELULAR, obj.getString("NumeroCelular"));
		
		valores.put(UsuarioContract.COLUNA_MELHOR_PATH, obj.getString("MelhorPath"));
