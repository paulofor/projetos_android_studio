...
import br.com.lojadigicom.treinoacademia.servico.base.ExecucaoItemSerieServico;
...
public abstract class ExecucaoItemSerieFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private ExecucaoItemSerie item = null;
	
	protected ExecucaoItemSerieServico srv = FabricaServico.getInstancia().getExecucaoItemSerieServico();
	
	protected ExecucaoItemSerie getItem() {
		return item;
	}
	public void setItem(ExecucaoItemSerie valor) {
		item = valor;
	}
    ...
    protected abstract void copiaTelaParaVo(ExecucaoItemSerie item);
