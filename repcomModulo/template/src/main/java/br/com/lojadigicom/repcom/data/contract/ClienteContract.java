...
public final class ClienteContract implements BaseColumns {
	...
	public static MontadorDaoI adicionaMontadorContatoClienteEstabeleceLista (MontadorDaoI montador) {
		((MontadorDaoComposite)montador).adicionaMontador(ContatoClienteContract.getMontador(), "ContatoCliente_Estabelece");
		return montador;
	}
	...
	public static MontadorDaoI adicionaMontadorVendaComprouLista (MontadorDaoI montador) {
		((MontadorDaoComposite)montador).adicionaMontador(VendaContract.getMontador(), "Venda_Comprou");
		return montador;
	}
