...
public abstract class VendaListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (400 * 10) + 1;
    ...
    protected abstract void trataLista(List<Venda> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<Venda> converteLista(Cursor data) {
