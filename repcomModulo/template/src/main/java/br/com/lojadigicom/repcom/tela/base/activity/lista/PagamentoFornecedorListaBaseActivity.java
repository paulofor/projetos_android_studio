...
public abstract class PagamentoFornecedorListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (405 * 10) + 1;
    ...
    protected abstract void trataLista(List<PagamentoFornecedor> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<PagamentoFornecedor> converteLista(Cursor data) {
