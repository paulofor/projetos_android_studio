...
import br.com.lojadigicom.repcom.servico.base.ParcelaVendaServico;
...
public abstract class ParcelaVendaFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private ParcelaVenda item = null;
	
	protected ParcelaVendaServico srv = FabricaServico.getInstancia().getParcelaVendaServico();
    ...
    protected abstract void copiaTelaParaVo(ParcelaVenda item);
