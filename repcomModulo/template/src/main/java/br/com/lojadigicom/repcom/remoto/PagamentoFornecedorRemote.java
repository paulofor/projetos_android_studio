...
public class PagamentoFornecedorRemote {
    ...
    public int listaSincronizadaDao(Context contexto, boolean delete) throws JSONException {
        ...
        try {
            ...
            if (delete) {
                contexto.getContentResolver().delete(PagamentoFornecedorContract.buildDeleteAllRecreate(), null, null);
            }
            contexto.getContentResolver().bulkInsert(PagamentoFornecedorContract.getContentUri(), vetor);
  	...
  	public int listaSincronizadaDaoAtualizaPorId(Context contexto, boolean delete, String codigoAplicacao) throws JSONException {
        ...
        try {
            ...
            for (int x = 0 ; x < lista.length() ; x++) {
                ...
                ContentValues valor = this.ContentValuesAtributos(item);
                //vetor[x] = valor;
                String where = "id_pagamento_fornecedor=" + valor.getAsString("id_pagamento_fornecedor");
                contexto.getContentResolver().update(PagamentoFornecedorContract.buildAtualiza(),valor,where,null);
            }
    ...
    private JSONObject JSonAtributos(Cursor c) throws JSONException {
		...
		json.put("IdPagamentoFornecedor",c.getString(PagamentoFornecedorContract.COL_ID_PAGAMENTO_FORNECEDOR));
     ...
     private JSONObject JSonAtributosSinc(Cursor c) throws JSONException {
        ...
        json.put("OperacaoSinc",c.getString(PagamentoFornecedorContract.COL_OPERACAO_SINC));
        return json;
    }
    ...
    private ContentValues ContentValuesAtributos(JSONObject obj) throws JSONException {
		...
		valores.put(PagamentoFornecedorContract.COLUNA_ID_PAGAMENTO_FORNECEDOR, obj.getString("IdPagamentoFornecedor"));
