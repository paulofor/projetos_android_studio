...
public abstract class PedidoFornecedorListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (399 * 10) + 1;
    ...
    protected abstract void trataLista(List<PedidoFornecedor> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<PedidoFornecedor> converteLista(Cursor data) {
