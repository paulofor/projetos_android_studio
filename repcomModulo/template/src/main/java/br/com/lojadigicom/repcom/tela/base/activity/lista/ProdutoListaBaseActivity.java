...
public abstract class ProdutoListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (397 * 10) + 1;
    ...
    protected abstract void trataLista(List<Produto> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<Produto> converteLista(Cursor data) {
