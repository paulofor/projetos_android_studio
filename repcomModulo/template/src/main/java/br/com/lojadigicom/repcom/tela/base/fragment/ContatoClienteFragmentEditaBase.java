...
import br.com.lojadigicom.repcom.servico.base.ContatoClienteServico;
...
public abstract class ContatoClienteFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private ContatoCliente item = null;
	
	protected ContatoClienteServico srv = FabricaServico.getInstancia().getContatoClienteServico();
    ...
    protected abstract void copiaTelaParaVo(ContatoCliente item);
