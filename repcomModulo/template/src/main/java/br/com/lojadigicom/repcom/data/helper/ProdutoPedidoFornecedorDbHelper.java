...
public class ProdutoPedidoFornecedorDbHelper {
	...
	protected static String getSqlChavesEstrangeiras() {
		...
		" ADD FOREIGN KEY (" + ProdutoPedidoFornecedorContract.COLUNA_ID_PEDIDO_FORNECEDOR_A + ") REFERENCES " + PedidoFornecedorContract.TABLE_NAME + " (" + PedidoFornecedorContract.COLUNA_CHAVE + ")  " + 
		" ADD FOREIGN KEY (" + ProdutoPedidoFornecedorContract.COLUNA_ID_PRODUTO_A + ") REFERENCES " + ProdutoContract.TABLE_NAME + " (" + ProdutoContract.COLUNA_CHAVE + ")  " + 
        ";";
	}
	...
	private static String getSqlChaveEstrangeira() {
		String saida = "";
		saida += " , FOREIGN KEY (" + ProdutoPedidoFornecedorContract.COLUNA_ID_PEDIDO_FORNECEDOR_A + ") REFERENCES " + PedidoFornecedorContract.TABLE_NAME + " (" + PedidoFornecedorContract.COLUNA_CHAVE + ") ";
		saida += " , FOREIGN KEY (" + ProdutoPedidoFornecedorContract.COLUNA_ID_PRODUTO_A + ") REFERENCES " + ProdutoContract.TABLE_NAME + " (" + ProdutoContract.COLUNA_CHAVE + ") ";
		return saida;
	}
