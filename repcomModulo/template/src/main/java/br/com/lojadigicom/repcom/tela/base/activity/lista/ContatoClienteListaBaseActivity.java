...
public abstract class ContatoClienteListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (401 * 10) + 1;
    ...
    protected abstract void trataLista(List<ContatoCliente> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<ContatoCliente> converteLista(Cursor data) {
