...
public abstract class ProdutoVendaListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (404 * 10) + 1;
    ...
    protected abstract void trataLista(List<ProdutoVenda> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<ProdutoVenda> converteLista(Cursor data) {
