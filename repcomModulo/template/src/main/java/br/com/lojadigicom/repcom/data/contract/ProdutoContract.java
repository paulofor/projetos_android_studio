...
public final class ProdutoContract implements BaseColumns {
	...
	public static MontadorDaoI adicionaMontadorPrecoProdutoPossuiLista (MontadorDaoI montador) {
		((MontadorDaoComposite)montador).adicionaMontador(PrecoProdutoContract.getMontador(), "PrecoProduto_Possui");
		return montador;
	}
