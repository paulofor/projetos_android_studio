...
public abstract class VendaListFragmentBase extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>{

    private RecyclerView mRecyclerView;
    private VendaListAdapterBase mAdapter;

    private int mPosition = RecyclerView.NO_POSITION;
    private int mChoiceMode;
    private static final String SELECTED_KEY = "selected_position";
    private static final int FORECAST_LOADER = 400;
	...
	public VendaListFragmentBase() {
    }


	private final void onItemSelected(int idItemLista, VendaListViewHolderBase vh) {
        ...
        intent.putExtra(Constantes.VENDA_ID,idItemLista);
        if (idItemLista==0) {
    ...
    protected abstract void montaAminacao(VendaListViewHolderBase vh, ArrayList<Pair<View,String>> lista);
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = getListAdapter(this.getActivity(), new VendaListAdapterBase.VendaListAdapterOnClickHandler() {
            @Override
            public void onClick(int idItemLista, VendaListViewHolderBase vh) {
    ...
    protected abstract VendaListAdapterBase getListAdapter(FragmentActivity activity, VendaListAdapterBase.VendaListAdapterOnClickHandler onClickHandler, View emptyView, int mChoiceMode);

	/*
 	public void registraPosicao(VendaListViewHolderBase vh) {
        SharedPreferences pref = getActivity().getSharedPreferences("br.com.lojadigicom.repcom", Context.MODE_PRIVATE);
        SharedPreferences.Editor edt = pref.edit();
        edt.putInt(Constantes.VENDA_POSICAO, vh.getAdapterPosition());
        edt.commit();
    }
    private void recuperaPosicao() {
        SharedPreferences pref = getActivity().getSharedPreferences("br.com.lojadigicom.repcom", Context.MODE_PRIVATE);
        mPosition = pref.getInt(Constantes.VENDA_POSICAO,RecyclerView.NO_POSITION);
    }
	*/
    ...
    public final void onLoadFinished(Loader<Cursor> loader, Cursor data) {
    	List<Venda> lista = converteLista(data);
    	DCLog.d(DCLog.OPERACAO_DB_TELA,this,"Lista Venda " + lista.size() + " itens");
    	DCLog.d(DCLog.TRACE_LISTA,this,"List<Venda> : " + lista.size() + " itens");
	...
	protected MontadorDaoI getMontador() {
        return VendaContract.getMontador();
    }

    protected final List<Venda> converteLista(Cursor data) {
