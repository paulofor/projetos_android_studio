...
import br.com.lojadigicom.repcom.servico.base.EstoqueServico;
import br.com.lojadigicom.repcom.servico.base.FabricaServico;
import br.com.lojadigicom.repcom.modelo.EstoqueVo;
import br.com.lojadigicom.repcom.framework.log.DCLog;

public abstract class EstoqueFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private Estoque item = null;
	
	protected EstoqueServico srv = FabricaServico.getInstancia().getEstoqueServico();
    ...
    protected abstract void copiaTelaParaVo(Estoque item);
