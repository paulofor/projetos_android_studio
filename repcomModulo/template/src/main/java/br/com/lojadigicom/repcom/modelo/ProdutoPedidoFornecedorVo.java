...
public class ProdutoPedidoFornecedorVo implements ProdutoPedidoFornecedor  {
	...
	public long getIdPedidoFornecedorA() {
		...
		// metodo.
		//if (this.getPedidoFornecedor_Associada()!=null) 
		//	return getPedidoFornecedor_Associada().getIdObj();
		//else
	...
	public long getIdProdutoA() {
		// relacionamento - Nao adianta pq na hora de gravar no banco pega o valor da variavel e nao desse 
		// metodo.
		//if (this.getProduto_Associada()!=null) 
		//	return getProduto_Associada().getIdObj();
		//else
			return idProdutoA;
	}
	...
	// ------ AGREGADOS 2-------------------
  	// ComChaveEstrangeira
		...
		public void setPedidoFornecedor_Associada(PedidoFornecedor item) {
			...
			idPedidoFornecedorA = item.getIdObj();
