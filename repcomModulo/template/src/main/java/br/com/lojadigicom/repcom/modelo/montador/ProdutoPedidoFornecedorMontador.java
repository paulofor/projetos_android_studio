...
public class ProdutoPedidoFornecedorMontador implements MontadorDaoI {

	private ProdutoPedidoFornecedor principal = new ProdutoPedidoFornecedorVo();
	...
	public DCIObjetoDominio getItem(Cursor c) {
		...
		objeto = new ProdutoPedidoFornecedorVo();
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		...
		item = (ProdutoPedidoFornecedor) entrada;
		item.setIdProdutoPedidoFornecedor(getInt(c,pos++));
