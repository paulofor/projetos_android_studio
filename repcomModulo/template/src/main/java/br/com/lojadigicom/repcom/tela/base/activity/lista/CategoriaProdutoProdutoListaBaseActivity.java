...
public abstract class CategoriaProdutoProdutoListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (678 * 10) + 1;
    ...
    protected abstract void trataLista(List<CategoriaProdutoProduto> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<CategoriaProdutoProduto> converteLista(Cursor data) {
