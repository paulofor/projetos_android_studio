...
public abstract class ClienteListFragmentBase extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>{

    private RecyclerView mRecyclerView;
    private ClienteListAdapterBase mAdapter;

    private int mPosition = RecyclerView.NO_POSITION;
    private int mChoiceMode;
    private static final String SELECTED_KEY = "selected_position";
    private static final int FORECAST_LOADER = 396;
	...
	public ClienteListFragmentBase() {
    }


	private final void onItemSelected(int idItemLista, ClienteListViewHolderBase vh) {
        ...
        intent.putExtra(Constantes.CLIENTE_ID,idItemLista);
        if (idItemLista==0) {
    ...
    protected abstract void montaAminacao(ClienteListViewHolderBase vh, ArrayList<Pair<View,String>> lista);
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = getListAdapter(this.getActivity(), new ClienteListAdapterBase.ClienteListAdapterOnClickHandler() {
            @Override
    ...
    protected abstract ClienteListAdapterBase getListAdapter(FragmentActivity activity, ClienteListAdapterBase.ClienteListAdapterOnClickHandler onClickHandler, View emptyView, int mChoiceMode);

	/*
 	public void registraPosicao(ClienteListViewHolderBase vh) {
        SharedPreferences pref = getActivity().getSharedPreferences("br.com.lojadigicom.repcom", Context.MODE_PRIVATE);
        SharedPreferences.Editor edt = pref.edit();
        edt.putInt(Constantes.CLIENTE_POSICAO, vh.getAdapterPosition());
        edt.commit();
    }
    private void recuperaPosicao() {
        SharedPreferences pref = getActivity().getSharedPreferences("br.com.lojadigicom.repcom", Context.MODE_PRIVATE);
        mPosition = pref.getInt(Constantes.CLIENTE_POSICAO,RecyclerView.NO_POSITION);
    }
	*/
    ...
    public final void onLoadFinished(Loader<Cursor> loader, Cursor data) {
    	...
    	DCLog.d(DCLog.OPERACAO_DB_TELA,this,"Lista Cliente " + lista.size() + " itens");
	...
	protected MontadorDaoI getMontador() {
        return ClienteContract.getMontador();
    }

    protected final List<Cliente> converteLista(Cursor data) {
