...
public abstract class DispositivoUsuarioListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (779 * 10) + 1;
    ...
    protected abstract void trataLista(List<DispositivoUsuario> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<DispositivoUsuario> converteLista(Cursor data) {
