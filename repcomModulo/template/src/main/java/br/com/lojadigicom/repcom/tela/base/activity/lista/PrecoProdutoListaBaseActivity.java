...
public abstract class PrecoProdutoListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (677 * 10) + 1;
    ...
    protected abstract void trataLista(List<PrecoProduto> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<PrecoProduto> converteLista(Cursor data) {
