...
import br.com.lojadigicom.repcom.servico.base.ClienteInteresseCategoriaServico;
...
public abstract class ClienteInteresseCategoriaFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private ClienteInteresseCategoria item = null;
	
	protected ClienteInteresseCategoriaServico srv = FabricaServico.getInstancia().getClienteInteresseCategoriaServico();
	...
	private void enviaDados() {
		...
		if (item==null) {
            // Insercao
            item = new ClienteInteresseCategoriaVo();
    ...
    protected abstract void copiaTelaParaVo(ClienteInteresseCategoria item);
