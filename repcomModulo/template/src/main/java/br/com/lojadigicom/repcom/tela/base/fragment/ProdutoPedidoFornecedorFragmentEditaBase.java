...
import br.com.lojadigicom.repcom.servico.base.ProdutoPedidoFornecedorServico;
import br.com.lojadigicom.repcom.servico.base.FabricaServico;
import br.com.lojadigicom.repcom.modelo.ProdutoPedidoFornecedorVo;
import br.com.lojadigicom.repcom.framework.log.DCLog;

public abstract class ProdutoPedidoFornecedorFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private ProdutoPedidoFornecedor item = null;
	
	protected ProdutoPedidoFornecedorServico srv = FabricaServico.getInstancia().getProdutoPedidoFornecedorServico();
	...
	private void enviaDados() {
		...
		if (item==null) {
            // Insercao
            item = new ProdutoPedidoFornecedorVo();
    ...
    protected abstract void copiaTelaParaVo(ProdutoPedidoFornecedor item);
