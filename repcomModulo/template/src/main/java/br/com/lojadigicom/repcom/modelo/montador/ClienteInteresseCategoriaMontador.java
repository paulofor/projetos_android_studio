...
import br.com.lojadigicom.repcom.modelo.ClienteInteresseCategoriaVo;
...
public class ClienteInteresseCategoriaMontador implements MontadorDaoI {

	private ClienteInteresseCategoria principal = new ClienteInteresseCategoriaVo();
	
	private boolean sinc = false;
	public ClienteInteresseCategoriaMontador(boolean sinc) {
		this.sinc = sinc;
	}
	public ClienteInteresseCategoriaMontador() {
		this.sinc = false;
	}
	...
	public DCIObjetoDominio getItem(Cursor c) {
		...
		//objeto = FabricaVo.criaClienteInteresseCategoria();
		objeto = new ClienteInteresseCategoriaVo();
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		...
		item = (ClienteInteresseCategoria) entrada;
		item.setIdClienteInteresseCategoria(getInt(c,pos++));
		item.setIdClienteA(getInt(c,pos++));
		item.setIdCategoriaProdutoA(getInt(c,pos++));
