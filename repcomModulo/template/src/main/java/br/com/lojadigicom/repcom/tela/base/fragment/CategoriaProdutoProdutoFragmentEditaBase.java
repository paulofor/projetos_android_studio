...
import br.com.lojadigicom.repcom.servico.base.CategoriaProdutoProdutoServico;
...
public abstract class CategoriaProdutoProdutoFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private CategoriaProdutoProduto item = null;
	
	protected CategoriaProdutoProdutoServico srv = FabricaServico.getInstancia().getCategoriaProdutoProdutoServico();
	...
	private void enviaDados() {
		...
		if (item==null) {
            // Insercao
            item = new CategoriaProdutoProdutoVo();
    ...
    protected abstract void copiaTelaParaVo(CategoriaProdutoProduto item);
