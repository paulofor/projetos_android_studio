...
public abstract class ParcelaVendaListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (406 * 10) + 1;
    ...
    protected abstract void trataLista(List<ParcelaVenda> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<ParcelaVenda> converteLista(Cursor data) {
