...
import br.com.lojadigicom.repcom.servico.base.ClienteServico;
import br.com.lojadigicom.repcom.servico.base.FabricaServico;
import br.com.lojadigicom.repcom.modelo.ClienteVo;
import br.com.lojadigicom.repcom.framework.log.DCLog;

public abstract class ClienteFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private Cliente item = null;
	
	protected ClienteServico srv = FabricaServico.getInstancia().getClienteServico();
    ...
    protected abstract void copiaTelaParaVo(Cliente item);
