...
public abstract class ProdutoPedidoFornecedorListFragmentBase extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    private static final int FORECAST_LOADER = 403;
	...
	private final void onItemSelected(int idItemLista, ProdutoPedidoFornecedorListViewHolderBase vh) {
        ...
        intent.putExtra(Constantes.PRODUTO_PEDIDO_FORNECEDOR_ID,idItemLista);
        if (idItemLista==0) {
    ...
    protected abstract void montaAminacao(ProdutoPedidoFornecedorListViewHolderBase vh, ArrayList<Pair<View,String>> lista);
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = getListAdapter(this.getActivity(), new ProdutoPedidoFornecedorListAdapterBase.ProdutoPedidoFornecedorListAdapterOnClickHandler() {
            @Override
	...
	*/
    ...
    public final void onLoadFinished(Loader<Cursor> loader, Cursor data) {
    	...
    	DCLog.d(DCLog.TRACE_LISTA,this,"List<ProdutoPedidoFornecedor> : " + lista.size() + " itens");
	...
	protected long mIdPedidoFornecedor;
	public final void setIdPedidoFornecedor(long id) {
		mIdPedidoFornecedor = id;
	}
