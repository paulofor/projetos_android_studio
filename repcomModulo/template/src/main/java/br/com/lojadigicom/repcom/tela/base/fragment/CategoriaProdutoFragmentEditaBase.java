...
import br.com.lojadigicom.repcom.servico.base.CategoriaProdutoServico;
...
public abstract class CategoriaProdutoFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private CategoriaProduto item = null;
	
	protected CategoriaProdutoServico srv = FabricaServico.getInstancia().getCategoriaProdutoServico();
    ...
    protected abstract void copiaTelaParaVo(CategoriaProduto item);
