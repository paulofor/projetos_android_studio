...
public class ContatoClienteDbHelper {
	...
	protected static String getSqlChavesEstrangeiras() {
		...
		" ADD FOREIGN KEY (" + ContatoClienteContract.COLUNA_ID_CLIENTE_RA + ") REFERENCES " + ClienteContract.TABLE_NAME + " (" + ClienteContract.COLUNA_CHAVE + ")  " + 
        ";";
	}
	...
	private static String getSqlChaveEstrangeira() {
		String saida = "";
		saida += " , FOREIGN KEY (" + ContatoClienteContract.COLUNA_ID_CLIENTE_RA + ") REFERENCES " + ClienteContract.TABLE_NAME + " (" + ClienteContract.COLUNA_CHAVE + ") ";
		return saida;
	}
