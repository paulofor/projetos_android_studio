...
public abstract class LinhaProdutoListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (402 * 10) + 1;
    ...
    protected abstract void trataLista(List<LinhaProduto> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<LinhaProduto> converteLista(Cursor data) {
