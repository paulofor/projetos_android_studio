...
import br.com.lojadigicom.repcom.servico.base.ProdutoVendaServico;
...
public abstract class ProdutoVendaFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private ProdutoVenda item = null;
	
	protected ProdutoVendaServico srv = FabricaServico.getInstancia().getProdutoVendaServico();
    ...
    protected abstract void copiaTelaParaVo(ProdutoVenda item);
