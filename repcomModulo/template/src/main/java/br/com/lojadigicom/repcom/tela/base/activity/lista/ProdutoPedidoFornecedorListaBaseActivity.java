...
public abstract class ProdutoPedidoFornecedorListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (403 * 10) + 1;
    ...
    protected abstract void trataLista(List<ProdutoPedidoFornecedor> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<ProdutoPedidoFornecedor> converteLista(Cursor data) {
