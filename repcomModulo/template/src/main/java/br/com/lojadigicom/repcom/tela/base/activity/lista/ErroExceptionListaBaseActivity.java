...
public abstract class ErroExceptionListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (854 * 10) + 1;
    ...
    protected abstract void trataLista(List<ErroException> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<ErroException> converteLista(Cursor data) {
