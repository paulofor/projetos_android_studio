...
public abstract class DispositivoUsuarioProvider {
	...
	public static final int DISPOSITIVO_USUARIO = 77900;
	public static final int DISPOSITIVO_USUARIO_ID = 77901;
	public static final int DISPOSITIVO_USUARIO_SINC = 77903;
	public static final int DISPOSITIVO_USUARIO_E_COMPLEMENTO = 77904;
	public static final int DISPOSITIVO_USUARIO_ID_E_COMPLEMENTO = 77905;
	//public static final int DISPOSITIVO_USUARIO_OPERACAO = 77902;
	
	// deletes
	public static final int DISPOSITIVO_USUARIO_DELETE_ALL_SINC = 77906;
	public static final int DISPOSITIVO_USUARIO_DELETE_RECREATE = 77907;
	public static final int DISPOSITIVO_USUARIO_DELETE_SINC = 77908;
	public static final int DISPOSITIVO_USUARIO_E_RETIRADA = 77909;
	
	private static final String sPorChaveSel = DispositivoUsuarioContract.TABLE_NAME + "." + DispositivoUsuarioContract.COLUNA_CHAVE + " = ? ";
	
	
	
	public static final int DISPOSITIVO_USUARIO_POR_USUARIO_REFERENTEA = 77920;
	public static final int COM_USUARIO = 77921;
