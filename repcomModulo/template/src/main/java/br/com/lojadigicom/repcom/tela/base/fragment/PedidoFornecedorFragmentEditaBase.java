...
import br.com.lojadigicom.repcom.servico.base.PedidoFornecedorServico;
import br.com.lojadigicom.repcom.servico.base.FabricaServico;
import br.com.lojadigicom.repcom.modelo.PedidoFornecedorVo;
import br.com.lojadigicom.repcom.framework.log.DCLog;

public abstract class PedidoFornecedorFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private PedidoFornecedor item = null;
	
	protected PedidoFornecedorServico srv = FabricaServico.getInstancia().getPedidoFornecedorServico();
    ...
    protected abstract void copiaTelaParaVo(PedidoFornecedor item);
