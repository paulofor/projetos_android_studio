...
public abstract class EstoqueListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (470 * 10) + 1;
    ...
    protected abstract void trataLista(List<Estoque> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<Estoque> converteLista(Cursor data) {
