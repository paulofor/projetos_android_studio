...
public class ClienteInteresseCategoriaDbHelper {
	...
	protected static String getSqlChavesEstrangeiras() {
		...
		" ADD FOREIGN KEY (" + ClienteInteresseCategoriaContract.COLUNA_ID_CLIENTE_A + ") REFERENCES " + ClienteContract.TABLE_NAME + " (" + ClienteContract.COLUNA_CHAVE + ")  " + 
		" ADD FOREIGN KEY (" + ClienteInteresseCategoriaContract.COLUNA_ID_CATEGORIA_PRODUTO_A + ") REFERENCES " + CategoriaProdutoContract.TABLE_NAME + " (" + CategoriaProdutoContract.COLUNA_CHAVE + ")  " + 
        ";";
	}
	...
	private static String getSqlChaveEstrangeira() {
		String saida = "";
		saida += " , FOREIGN KEY (" + ClienteInteresseCategoriaContract.COLUNA_ID_CLIENTE_A + ") REFERENCES " + ClienteContract.TABLE_NAME + " (" + ClienteContract.COLUNA_CHAVE + ") ";
		saida += " , FOREIGN KEY (" + ClienteInteresseCategoriaContract.COLUNA_ID_CATEGORIA_PRODUTO_A + ") REFERENCES " + CategoriaProdutoContract.TABLE_NAME + " (" + CategoriaProdutoContract.COLUNA_CHAVE + ") ";
		return saida;
	}
