...
public abstract class VendaProvider {
	...
	public Cursor query(UriMatcher sUriMatcher, Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
		...
		switch (sUriMatcher.match(uri)) {
	 		...
	 		case ATUALIZATOTAL:
			{
				...
				DCLog.d(DCLog.TRACE_LISTA,this,"chamar queryAtualizaTotal()");
				//retCursor = queryAtualizaTotal(uri,projection,sortOrder);
				String param = uri.getQuery();
				String sql = queryAtualizaTotal(param) + (sortOrder!=null?" order by " + sortOrder:"");
	 		...
	 		case CRIAPARCELAMENTO:
			{
				...
				DCLog.d(DCLog.TRACE_LISTA,this,"chamar queryCriaParcelamento()");
				//retCursor = queryCriaParcelamento(uri,projection,sortOrder);
				String param = uri.getQuery();
				String sql = queryCriaParcelamento(param) + (sortOrder!=null?" order by " + sortOrder:"");
				DCLog.d(DCLog.TRACE_LISTA,this,"SQL: " + sql);
				retCursor = this.queryRaw(sql);
				DCLog.d(DCLog.TRACE_LISTA,this,"Cursor: " + retCursor.getCount() + " linhas");
				break;
	...
	protected abstract String queryAtualizaTotal(String param);
	
	protected abstract String queryCriaParcelamento(String param);
