...
public abstract class MesAnoListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (773 * 10) + 1;
    ...
    protected abstract void trataLista(List<MesAno> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<MesAno> converteLista(Cursor data) {
