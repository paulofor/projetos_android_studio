...
import br.com.lojadigicom.repcom.servico.base.PrecoProdutoServico;
import br.com.lojadigicom.repcom.servico.base.FabricaServico;
import br.com.lojadigicom.repcom.modelo.PrecoProdutoVo;
import br.com.lojadigicom.repcom.framework.log.DCLog;

public abstract class PrecoProdutoFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private PrecoProduto item = null;
	
	protected PrecoProdutoServico srv = FabricaServico.getInstancia().getPrecoProdutoServico();
    ...
    protected abstract void copiaTelaParaVo(PrecoProduto item);
