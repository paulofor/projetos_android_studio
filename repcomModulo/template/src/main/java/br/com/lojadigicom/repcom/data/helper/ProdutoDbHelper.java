...
public class ProdutoDbHelper {
	...
	protected static String getSqlChavesEstrangeiras() {
		...
		" ADD FOREIGN KEY (" + ProdutoContract.COLUNA_ID_LINHA_PRODUTO_EE + ") REFERENCES " + LinhaProdutoContract.TABLE_NAME + " (" + LinhaProdutoContract.COLUNA_CHAVE + ")  " + 
        ";";
	}
	...
	private static String getSqlChaveEstrangeira() {
		String saida = "";
		saida += " , FOREIGN KEY (" + ProdutoContract.COLUNA_ID_LINHA_PRODUTO_EE + ") REFERENCES " + LinhaProdutoContract.TABLE_NAME + " (" + LinhaProdutoContract.COLUNA_CHAVE + ") ";
		return saida;
	}
