...
import br.com.lojadigicom.repcom.modelo.CategoriaProdutoProdutoVo;
...
public class CategoriaProdutoProdutoMontador implements MontadorDaoI {
	...
	private CategoriaProdutoProduto principal = new CategoriaProdutoProdutoVo();
	
	private boolean sinc = false;
	public CategoriaProdutoProdutoMontador(boolean sinc) {
		this.sinc = sinc;
	}
	public CategoriaProdutoProdutoMontador() {
		this.sinc = false;
	}
	...
	public DCIObjetoDominio getItem(Cursor c) {
		...
		objeto = new CategoriaProdutoProdutoVo();
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		...
		item = (CategoriaProdutoProduto) entrada;
		item.setIdCategoriaProdutoProduto(getInt(c,pos++));
		item.setDataInclusao(this.getTimestampData(c,pos++));
		item.setIdCategoriaProdutoRa(getInt(c,pos++));
