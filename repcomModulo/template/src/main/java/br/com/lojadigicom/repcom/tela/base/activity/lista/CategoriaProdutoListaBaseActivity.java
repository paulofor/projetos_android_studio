...
public abstract class CategoriaProdutoListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (398 * 10) + 1;
    ...
    protected abstract void trataLista(List<CategoriaProduto> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<CategoriaProduto> converteLista(Cursor data) {
