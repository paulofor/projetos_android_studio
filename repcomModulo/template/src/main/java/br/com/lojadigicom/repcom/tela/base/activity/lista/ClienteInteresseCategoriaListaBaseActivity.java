...
public abstract class ClienteInteresseCategoriaListaBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	
	private static final int DETAIL_LOADER = (408 * 10) + 1;
    ...
    protected abstract void trataLista(List<ClienteInteresseCategoria> lista);

    @Override
    public final void onLoaderReset(Loader<Cursor> loader) {

    }
    private final List<ClienteInteresseCategoria> converteLista(Cursor data) {
