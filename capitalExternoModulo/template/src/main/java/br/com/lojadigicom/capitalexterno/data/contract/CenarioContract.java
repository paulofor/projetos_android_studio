...
import br.com.lojadigicom.capitalexterno.modelo.montador.CenarioMontador;


public final class CenarioContract implements BaseColumns {
	...
	public static final String PATH = "cenario";
    ...
    public static final String TABLE_NAME = "cenario";
    public static final String TABLE_NAME_SINC = "cenario_sinc";
	...
	public static Uri buildCenarioUri(long id) {
    ...
    public static final String COLUNA_ID_CENARIO = "id_cenario";
    public static final int COL_ID_CENARIO = 0;
    public static final String COLUNA_DESCRICAO_CENARIO = "descricao_cenario";
    public static final int COL_DESCRICAO_CENARIO = 1;
	
 	public static final String COLUNA_CHAVE = COLUNA_ID_CENARIO;
	...
	public static final String[] COLS = new String[] { 
        	...
        	, TABLE_NAME + "." +COLUNA_DESCRICAO_CENARIO
    };
    
    public static final String[] COLS_SINC = new String[] { 
			TABLE_NAME_SINC + "." + COLUNA_CHAVE
        	, TABLE_NAME_SINC + "." +COLUNA_DESCRICAO_CENARIO
			, TABLE_NAME_SINC + "." + COLUNA_OPERACAO_SINC
    };
    
    private static CenarioOperacao operacao = new CenarioOperacao();
    
	private static CenarioFiltro filtro = null;
	public static CenarioFiltro getFiltro() {
		if (filtro==null) {
			filtro = new CenarioFiltro();
		}
		return filtro;
	}
	...
	{
		return " " + TABLE_NAME + "." + COLUNA_ID_CENARIO  
		+ " , " + TABLE_NAME + "." + COLUNA_DESCRICAO_CENARIO 
	...
	{
		return " cenario_sinc.id_cenario " 
		+ " ,cenario_sinc.descricao_cenario " 
		
		
		+ " ,cenario_sinc.operacao_sinc "
		;
	}
	...
	public static List<Cenario> converteLista(Cursor data) {
		return converteLista(data, getMontador());
	}
	public static List<Cenario> converteLista(Cursor data, MontadorDaoI montador) {
