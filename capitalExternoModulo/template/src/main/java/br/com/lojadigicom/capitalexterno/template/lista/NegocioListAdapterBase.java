 ...
 */
public abstract class NegocioListAdapterBase extends RecyclerView.Adapter<NegocioListViewHolderBase>{

    //protected Cursor mCursor;
    protected List<Negocio> mLista;
    private Context mContext;
    private NegocioListAdapterOnClickHandler mClickHandler;
    private View mEmptyView;
    private ItemChoiceManager mICM = null;
    protected ResourceObj resourceObj = getLayoutItemResource();

    public NegocioListAdapterBase(Context context, NegocioListAdapterOnClickHandler dh, View emptyView, int choiceMode) {
        mContext = context;
        mClickHandler = dh;
    ...
    @Override
    public final NegocioListViewHolderBase onCreateViewHolder(ViewGroup parent, int viewType) {
        if ( parent instanceof RecyclerView ) {
            ...
            NegocioListViewHolderBase saida = getViewHolder(view);
    ...
    protected abstract NegocioListViewHolderBase getViewHolder(View v);
    ...
    public final void swapCursor(List<Negocio> novaLista) {
        //mCursor = newCursor;
        mLista = novaLista;
    ...
    public static interface NegocioListAdapterOnClickHandler {
        void onClick(int id, NegocioListViewHolderBase vh);
    }
    
    
    @Override
    public void onBindViewHolder(NegocioListViewHolderBase holder, int position) {
        Negocio obj = mLista.get(position);
        holder.setItem(obj);
        onBindViewHolderDC(obj,holder,position);
    }

    protected abstract void onBindViewHolderDC(Negocio item,NegocioListViewHolderBase holder, int position);
