...
import br.com.lojadigicom.capitalexterno.servico.base.ItemCustoProdutoServico;
...
public abstract class ItemCustoProdutoFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private ItemCustoProduto item = null;
	
	protected ItemCustoProdutoServico srv = FabricaServico.getInstancia().getItemCustoProdutoServico();
	
	protected ItemCustoProduto getItem() {
		return item;
	}
	public void setItem(ItemCustoProduto valor) {
		item = valor;
	}
    ...
    protected abstract void copiaTelaParaVo(ItemCustoProduto item);
