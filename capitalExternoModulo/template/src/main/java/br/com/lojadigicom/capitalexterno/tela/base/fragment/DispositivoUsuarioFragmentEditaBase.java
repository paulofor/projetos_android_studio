...
import br.com.lojadigicom.capitalexterno.servico.base.DispositivoUsuarioServico;
...
public abstract class DispositivoUsuarioFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private DispositivoUsuario item = null;
	
	protected DispositivoUsuarioServico srv = FabricaServico.getInstancia().getDispositivoUsuarioServico();
    ...
    protected abstract void copiaTelaParaVo(DispositivoUsuario item);
