...
public class MesAnoRemote {
    ...
    private JSONObject JSonAtributos(Cursor c) throws JSONException {
		...
		json.put("DataMesAno",c.getString(MesAnoContract.COL_DATA_MES_ANO));
		
			
		
		json.put("Descricao",c.getString(MesAnoContract.COL_DESCRICAO));
    ...
    private ContentValues ContentValuesAtributos(JSONObject obj) throws JSONException {
		...
		valores.put(MesAnoContract.COLUNA_DATA_MES_ANO, obj.getLong("DataMesAno"));
		
		valores.put(MesAnoContract.COLUNA_DESCRICAO, obj.getString("Descricao"));
