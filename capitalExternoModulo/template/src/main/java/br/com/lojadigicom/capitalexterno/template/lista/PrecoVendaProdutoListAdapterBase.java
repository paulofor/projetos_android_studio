 ...
 */
public abstract class PrecoVendaProdutoListAdapterBase extends RecyclerView.Adapter<PrecoVendaProdutoListViewHolderBase>{

    //protected Cursor mCursor;
    protected List<PrecoVendaProduto> mLista;
    private Context mContext;
    private PrecoVendaProdutoListAdapterOnClickHandler mClickHandler;
    private View mEmptyView;
    private ItemChoiceManager mICM = null;
    protected ResourceObj resourceObj = getLayoutItemResource();

    public PrecoVendaProdutoListAdapterBase(Context context, PrecoVendaProdutoListAdapterOnClickHandler dh, View emptyView, int choiceMode) {
        mContext = context;
        mClickHandler = dh;
    ...
    @Override
    public final PrecoVendaProdutoListViewHolderBase onCreateViewHolder(ViewGroup parent, int viewType) {
        if ( parent instanceof RecyclerView ) {
            ...
            PrecoVendaProdutoListViewHolderBase saida = getViewHolder(view);
    ...
    protected abstract PrecoVendaProdutoListViewHolderBase getViewHolder(View v);
    ...
    public final void swapCursor(List<PrecoVendaProduto> novaLista) {
        //mCursor = newCursor;
        mLista = novaLista;
    ...
    public static interface PrecoVendaProdutoListAdapterOnClickHandler {
        void onClick(int id, PrecoVendaProdutoListViewHolderBase vh);
    }
    
    
    @Override
    public void onBindViewHolder(PrecoVendaProdutoListViewHolderBase holder, int position) {
        PrecoVendaProduto obj = mLista.get(position);
        holder.setItem(obj);
        onBindViewHolderDC(obj,holder,position);
    }

    protected abstract void onBindViewHolderDC(PrecoVendaProduto item,PrecoVendaProdutoListViewHolderBase holder, int position);
