...
public abstract class DispositivoUsuarioProvider {
	...
	public static final int DISPOSITIVO_USUARIO = 90800;
	public static final int DISPOSITIVO_USUARIO_ID = 90801;
	public static final int DISPOSITIVO_USUARIO_SINC = 90803;
	public static final int DISPOSITIVO_USUARIO_E_COMPLEMENTO = 90804;
	public static final int DISPOSITIVO_USUARIO_ID_E_COMPLEMENTO = 90805;
	//public static final int DISPOSITIVO_USUARIO_OPERACAO = 90802;
	
	// deletes
	public static final int DISPOSITIVO_USUARIO_DELETE_ALL_SINC = 90806;
	public static final int DISPOSITIVO_USUARIO_DELETE_RECREATE = 90807;
	public static final int DISPOSITIVO_USUARIO_DELETE_SINC = 90808;
	public static final int DISPOSITIVO_USUARIO_E_RETIRADA = 90809;
	
	private static final String sPorChaveSel = DispositivoUsuarioContract.TABLE_NAME + "." + DispositivoUsuarioContract.COLUNA_CHAVE + " = ? ";
	
	
	
	public static final int DISPOSITIVO_USUARIO_POR_USUARIO_REFERENTEA = 90820;
	public static final int COM_USUARIO = 90821;
