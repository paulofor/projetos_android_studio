...
import br.com.lojadigicom.capitalexterno.servico.base.PrecoVendaProdutoServico;
import br.com.lojadigicom.capitalexterno.servico.base.FabricaServico;
import br.com.lojadigicom.capitalexterno.modelo.PrecoVendaProdutoVo;
import br.com.lojadigicom.capitalexterno.framework.log.DCLog;

public abstract class PrecoVendaProdutoFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private PrecoVendaProduto item = null;
	
	protected PrecoVendaProdutoServico srv = FabricaServico.getInstancia().getPrecoVendaProdutoServico();
	
	protected PrecoVendaProduto getItem() {
		return item;
	}
	public void setItem(PrecoVendaProduto valor) {
		item = valor;
	}
    ...
    protected abstract void copiaTelaParaVo(PrecoVendaProduto item);
