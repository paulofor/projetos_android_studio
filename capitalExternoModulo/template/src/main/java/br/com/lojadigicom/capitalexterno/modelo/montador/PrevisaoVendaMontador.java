...
import br.com.lojadigicom.capitalexterno.modelo.PrevisaoVendaVo;
...
public class PrevisaoVendaMontador implements MontadorDaoI {

	private PrevisaoVenda principal = new PrevisaoVendaVo();
	
	private boolean sinc = false;
	public PrevisaoVendaMontador(boolean sinc) {
		this.sinc = sinc;
	}
	public PrevisaoVendaMontador() {
		this.sinc = false;
	}
	...
	public DCIObjetoDominio getItem(Cursor c) {
		...
		//objeto = FabricaVo.criaPrevisaoVenda();
		objeto = new PrevisaoVendaVo();
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		PrevisaoVenda item = null;
		item = (PrevisaoVenda) entrada;
		item.setIdPrevisaoVenda(getInt(c,pos++));
