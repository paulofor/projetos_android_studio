...
import br.com.lojadigicom.capitalexterno.modelo.LinhaProdutoVo;
...
public class LinhaProdutoMontador implements MontadorDaoI {

	private LinhaProduto principal = new LinhaProdutoVo();
	
	private boolean sinc = false;
	public LinhaProdutoMontador(boolean sinc) {
		this.sinc = sinc;
	}
	public LinhaProdutoMontador() {
		this.sinc = false;
	}
	...
	public DCIObjetoDominio getItem(Cursor c) {
		...
		//objeto = FabricaVo.criaLinhaProduto();
		objeto = new LinhaProdutoVo();
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		...
		item = (LinhaProduto) entrada;
		item.setIdLinhaProduto(getInt(c,pos++));
