 ...
 */
public abstract class CenarioListAdapterBase extends RecyclerView.Adapter<CenarioListViewHolderBase>{

    //protected Cursor mCursor;
    protected List<Cenario> mLista;
    private Context mContext;
    private CenarioListAdapterOnClickHandler mClickHandler;
    private View mEmptyView;
    private ItemChoiceManager mICM = null;
    protected ResourceObj resourceObj = getLayoutItemResource();

    public CenarioListAdapterBase(Context context, CenarioListAdapterOnClickHandler dh, View emptyView, int choiceMode) {
        mContext = context;
        mClickHandler = dh;
    ...
    @Override
    public final CenarioListViewHolderBase onCreateViewHolder(ViewGroup parent, int viewType) {
        if ( parent instanceof RecyclerView ) {
            ...
            CenarioListViewHolderBase saida = getViewHolder(view);
    ...
    protected abstract CenarioListViewHolderBase getViewHolder(View v);
    ...
    public final void swapCursor(List<Cenario> novaLista) {
        //mCursor = newCursor;
        mLista = novaLista;
    ...
    public static interface CenarioListAdapterOnClickHandler {
        void onClick(int id, CenarioListViewHolderBase vh);
    }
    
    
    @Override
    public void onBindViewHolder(CenarioListViewHolderBase holder, int position) {
        Cenario obj = mLista.get(position);
        holder.setItem(obj);
        onBindViewHolderDC(obj,holder,position);
    }

    protected abstract void onBindViewHolderDC(Cenario item,CenarioListViewHolderBase holder, int position);
