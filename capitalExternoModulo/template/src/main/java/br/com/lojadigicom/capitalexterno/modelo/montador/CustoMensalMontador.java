...
public class CustoMensalMontador implements MontadorDaoI {

	private CustoMensal principal = new CustoMensalVo();
	
	private boolean sinc = false;
	public CustoMensalMontador(boolean sinc) {
		this.sinc = sinc;
	}
	public CustoMensalMontador() {
		this.sinc = false;
	}
	...
	public DCIObjetoDominio getItem(Cursor c) {
		...
		//objeto = FabricaVo.criaCustoMensal();
		objeto = new CustoMensalVo();
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		CustoMensal item = null;
		item = (CustoMensal) entrada;
		item.setIdCustoMensal(getInt(c,pos++));
		item.setDescricao(getString(c,pos++));
		item.setValorMedio(getFloat(c,pos++));
