...
import br.com.lojadigicom.capitalexterno.modelo.montador.CustoMensalMontador;


public final class CustoMensalContract implements BaseColumns {
	...
	public static final String PATH = "custo_mensal";
    ...
    public static final String TABLE_NAME = "custo_mensal";
    public static final String TABLE_NAME_SINC = "custo_mensal_sinc";
	...
	public static Uri buildCustoMensalUri(long id) {
    ...
    public static final String COLUNA_ID_CUSTO_MENSAL = "id_custo_mensal";
    public static final int COL_ID_CUSTO_MENSAL = 0;
    public static final String COLUNA_DESCRICAO = "descricao";
    public static final int COL_DESCRICAO = 1;
    public static final String COLUNA_VALOR_MEDIO = "valor_medio";
    public static final int COL_VALOR_MEDIO = 2;
	
 	public static final String COLUNA_CHAVE = COLUNA_ID_CUSTO_MENSAL;
	...
	public static final String[] COLS = new String[] { 
        	...
        	, TABLE_NAME + "." +COLUNA_VALOR_MEDIO
    };
    
    public static final String[] COLS_SINC = new String[] { 
			TABLE_NAME_SINC + "." + COLUNA_CHAVE
        	, TABLE_NAME_SINC + "." +COLUNA_DESCRICAO
        	, TABLE_NAME_SINC + "." +COLUNA_VALOR_MEDIO
			, TABLE_NAME_SINC + "." + COLUNA_OPERACAO_SINC
    };
    
    private static CustoMensalOperacao operacao = new CustoMensalOperacao();
    
	private static CustoMensalFiltro filtro = null;
	public static CustoMensalFiltro getFiltro() {
		if (filtro==null) {
			filtro = new CustoMensalFiltro();
		}
		return filtro;
	}
	...
	{
		return " " + TABLE_NAME + "." + COLUNA_ID_CUSTO_MENSAL  
		+ " , " + TABLE_NAME + "." + COLUNA_DESCRICAO 
		+ " , " + TABLE_NAME + "." + COLUNA_VALOR_MEDIO 
	...
	{
		return " custo_mensal_sinc.id_custo_mensal " 
		+ " ,custo_mensal_sinc.descricao " 
		+ " ,custo_mensal_sinc.valor_medio " 
		
		
		+ " ,custo_mensal_sinc.operacao_sinc "
		;
	}
	...
	public static MontadorDaoI getMontador() {
		return new CustoMensalMontador();
	}
	...
	public static List<CustoMensal> converteLista(Cursor data) {
		return converteLista(data, getMontador());
	}
	public static List<CustoMensal> converteLista(Cursor data, MontadorDaoI montador) {
