...
import br.com.lojadigicom.capitalexterno.servico.base.PrevisaoVendaServico;
...
public abstract class PrevisaoVendaFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private PrevisaoVenda item = null;
	
	protected PrevisaoVendaServico srv = FabricaServico.getInstancia().getPrevisaoVendaServico();
	
	protected PrevisaoVenda getItem() {
		return item;
	}
	public void setItem(PrevisaoVenda valor) {
		item = valor;
	}
    ...
    protected abstract void copiaTelaParaVo(PrevisaoVenda item);
