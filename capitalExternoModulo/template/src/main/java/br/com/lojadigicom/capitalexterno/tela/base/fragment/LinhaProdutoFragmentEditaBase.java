...
import br.com.lojadigicom.capitalexterno.servico.base.LinhaProdutoServico;
...
public abstract class LinhaProdutoFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private LinhaProduto item = null;
	
	protected LinhaProdutoServico srv = FabricaServico.getInstancia().getLinhaProdutoServico();
    ...
    protected abstract void copiaTelaParaVo(LinhaProduto item);
