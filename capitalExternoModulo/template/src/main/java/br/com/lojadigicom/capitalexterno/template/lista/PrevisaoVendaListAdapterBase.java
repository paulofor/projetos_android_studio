 ...
 */
public abstract class PrevisaoVendaListAdapterBase extends RecyclerView.Adapter<PrevisaoVendaListViewHolderBase>{

    //protected Cursor mCursor;
    protected List<PrevisaoVenda> mLista;
    private Context mContext;
    private PrevisaoVendaListAdapterOnClickHandler mClickHandler;
    private View mEmptyView;
    private ItemChoiceManager mICM = null;
    protected ResourceObj resourceObj = getLayoutItemResource();

    public PrevisaoVendaListAdapterBase(Context context, PrevisaoVendaListAdapterOnClickHandler dh, View emptyView, int choiceMode) {
        mContext = context;
        mClickHandler = dh;
    ...
    @Override
    public final PrevisaoVendaListViewHolderBase onCreateViewHolder(ViewGroup parent, int viewType) {
        if ( parent instanceof RecyclerView ) {
            ...
            PrevisaoVendaListViewHolderBase saida = getViewHolder(view);
    ...
    protected abstract PrevisaoVendaListViewHolderBase getViewHolder(View v);
    ...
    public final void swapCursor(List<PrevisaoVenda> novaLista) {
        //mCursor = newCursor;
        mLista = novaLista;
    ...
    public static interface PrevisaoVendaListAdapterOnClickHandler {
        void onClick(int id, PrevisaoVendaListViewHolderBase vh);
    }
    
    
    @Override
    public void onBindViewHolder(PrevisaoVendaListViewHolderBase holder, int position) {
        PrevisaoVenda obj = mLista.get(position);
        holder.setItem(obj);
        onBindViewHolderDC(obj,holder,position);
    }

    protected abstract void onBindViewHolderDC(PrevisaoVenda item,PrevisaoVendaListViewHolderBase holder, int position);
