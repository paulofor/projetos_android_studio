 ...
 */
public abstract class ItemCustoProdutoListAdapterBase extends RecyclerView.Adapter<ItemCustoProdutoListViewHolderBase>{

    //protected Cursor mCursor;
    protected List<ItemCustoProduto> mLista;
    private Context mContext;
    private ItemCustoProdutoListAdapterOnClickHandler mClickHandler;
    private View mEmptyView;
    private ItemChoiceManager mICM = null;
    protected ResourceObj resourceObj = getLayoutItemResource();

    public ItemCustoProdutoListAdapterBase(Context context, ItemCustoProdutoListAdapterOnClickHandler dh, View emptyView, int choiceMode) {
        mContext = context;
        mClickHandler = dh;
    ...
    @Override
    public final ItemCustoProdutoListViewHolderBase onCreateViewHolder(ViewGroup parent, int viewType) {
        if ( parent instanceof RecyclerView ) {
            ...
            ItemCustoProdutoListViewHolderBase saida = getViewHolder(view);
    ...
    protected abstract ItemCustoProdutoListViewHolderBase getViewHolder(View v);
    ...
    public final void swapCursor(List<ItemCustoProduto> novaLista) {
        //mCursor = newCursor;
        mLista = novaLista;
    ...
    public static interface ItemCustoProdutoListAdapterOnClickHandler {
        void onClick(int id, ItemCustoProdutoListViewHolderBase vh);
    }
    
    
    @Override
    public void onBindViewHolder(ItemCustoProdutoListViewHolderBase holder, int position) {
        ItemCustoProduto obj = mLista.get(position);
        holder.setItem(obj);
        onBindViewHolderDC(obj,holder,position);
    }

    protected abstract void onBindViewHolderDC(ItemCustoProduto item,ItemCustoProdutoListViewHolderBase holder, int position);
