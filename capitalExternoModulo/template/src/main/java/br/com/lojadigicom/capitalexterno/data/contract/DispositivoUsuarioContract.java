...
public final class DispositivoUsuarioContract implements BaseColumns {
    ...
    public static final String COLUNA_ID_DISPOSTIVO_USUARIO = "id_dispostivo_usuario";
    public static final int COL_ID_DISPOSTIVO_USUARIO = 0;
    ...
    public static final int COL_DATA_CRIACAO = 7;
    public static final String COLUNA_DATA_ULTIMO_ACESSO = "data_ultimo_acesso";
    public static final int COL_DATA_ULTIMO_ACESSO = 8;
    public static final String COLUNA_ID_USUARIO_RA = "id_usuario_ra";
    public static final int COL_ID_USUARIO_RA = 9;
	
	
 	public static final String COLUNA_CHAVE = COLUNA_ID_DISPOSTIVO_USUARIO;
 	public static final String COLUNA_OPERACAO_SINC = "operacao_sinc";
 	public static final int COL_OPERACAO_SINC = 10;
	...
	{
		return " " + TABLE_NAME + "." + COLUNA_ID_DISPOSTIVO_USUARIO  
		+ " , " + TABLE_NAME + "." + COLUNA_NUMERO_CELULAR 
		+ " , " + TABLE_NAME + "." + COLUNA_CODIGO_DISPOSITIVO 
		+ " , " + TABLE_NAME + "." + COLUNA_TIPO_ACESSO 
		+ " , " + TABLE_NAME + "." + COLUNA_MELHOR_PATH 
	...
	{
		return " dispositivo_usuario_sinc.id_dispostivo_usuario " 
