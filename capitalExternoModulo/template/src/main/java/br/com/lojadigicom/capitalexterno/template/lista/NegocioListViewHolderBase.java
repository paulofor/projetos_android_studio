 ...
 */
public abstract class NegocioListViewHolderBase extends RecyclerView.ViewHolder implements View.OnClickListener{

    //protected Cursor mCursor;
    protected List mLista;
    protected NegocioListAdapterBase.NegocioListAdapterOnClickHandler mClickHandler;
    protected ItemChoiceManager mICM = null;


	private Negocio item;
	public void setItem(Negocio dado) {
		item = dado;
	}
	public Negocio getItem() {
		return item;
	}
    ...
    public void setOnClickHandler(NegocioListAdapterBase.NegocioListAdapterOnClickHandler valor){
        mClickHandler = valor;
    }

    public NegocioListViewHolderBase(View itemView) {
        super(itemView);
