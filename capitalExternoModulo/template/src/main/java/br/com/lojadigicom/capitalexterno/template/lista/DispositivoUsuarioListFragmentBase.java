...
import br.com.lojadigicom.capitalexterno.framework.dao.DBHelperBase;
...
import br.com.lojadigicom.capitalexterno.framework.tela.SimpleDividerItemDecoration;

public abstract class DispositivoUsuarioListFragmentBase extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>{

    private RecyclerView mRecyclerView;
    private DispositivoUsuarioListAdapterBase mAdapter;

    private int mPosition = RecyclerView.NO_POSITION;
    private int mChoiceMode;
    private static final String SELECTED_KEY = "selected_position";
    private static final int FORECAST_LOADER = 908;
	...
	public DispositivoUsuarioListFragmentBase() {
    }


	private final void onItemSelected(int idItemLista, DispositivoUsuarioListViewHolderBase vh) {
        ...
        intent.putExtra(Constantes.DISPOSITIVO_USUARIO_ID,idItemLista);
        if (idItemLista==0) {
    ...
    protected abstract void montaAminacao(DispositivoUsuarioListViewHolderBase vh, ArrayList<Pair<View,String>> lista);
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = getListAdapter(this.getActivity(), new DispositivoUsuarioListAdapterBase.DispositivoUsuarioListAdapterOnClickHandler() {
            @Override
            public void onClick(int idItemLista, DispositivoUsuarioListViewHolderBase vh) {
		...
		SharedPreferences pref = getActivity().getSharedPreferences("br.com.lojadigicom.capitalexterno", Context.MODE_PRIVATE);
    ...
    protected abstract DispositivoUsuarioListAdapterBase getListAdapter(FragmentActivity activity, DispositivoUsuarioListAdapterBase.DispositivoUsuarioListAdapterOnClickHandler onClickHandler, View emptyView, int mChoiceMode);

	/*
 	public void registraPosicao(DispositivoUsuarioListViewHolderBase vh) {
        SharedPreferences pref = getActivity().getSharedPreferences("br.com.lojadigicom.capitalexterno", Context.MODE_PRIVATE);
        SharedPreferences.Editor edt = pref.edit();
        edt.putInt(Constantes.DISPOSITIVO_USUARIO_POSICAO, vh.getAdapterPosition());
        edt.commit();
    }
    private void recuperaPosicao() {
        SharedPreferences pref = getActivity().getSharedPreferences("br.com.lojadigicom.capitalexterno", Context.MODE_PRIVATE);
        mPosition = pref.getInt(Constantes.DISPOSITIVO_USUARIO_POSICAO,RecyclerView.NO_POSITION);
    }
	*/
    ...
    public final void onLoadFinished(Loader<Cursor> loader, Cursor data) {
    	List<DispositivoUsuario> lista = converteLista(data);
    	DCLog.d(DCLog.OPERACAO_DB_TELA,this,"Lista DispositivoUsuario " + lista.size() + " itens");
    	DCLog.d(DCLog.TRACE_LISTA,this,"List<DispositivoUsuario> : " + lista.size() + " itens");
	...
	protected MontadorDaoI getMontador() {
        return DispositivoUsuarioContract.getMontador();
    }

    protected final List<DispositivoUsuario> converteLista(Cursor data) {
