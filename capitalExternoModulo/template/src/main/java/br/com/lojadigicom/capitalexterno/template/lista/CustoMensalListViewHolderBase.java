 ...
 */
public abstract class CustoMensalListViewHolderBase extends RecyclerView.ViewHolder implements View.OnClickListener{

    //protected Cursor mCursor;
    protected List mLista;
    protected CustoMensalListAdapterBase.CustoMensalListAdapterOnClickHandler mClickHandler;
    protected ItemChoiceManager mICM = null;


	private CustoMensal item;
	public void setItem(CustoMensal dado) {
		item = dado;
	}
	public CustoMensal getItem() {
		return item;
	}
    ...
    public void setOnClickHandler(CustoMensalListAdapterBase.CustoMensalListAdapterOnClickHandler valor){
        mClickHandler = valor;
    }

    public CustoMensalListViewHolderBase(View itemView) {
        super(itemView);
