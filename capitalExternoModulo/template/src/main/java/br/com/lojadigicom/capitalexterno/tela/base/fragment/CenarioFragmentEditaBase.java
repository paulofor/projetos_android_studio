...
import br.com.lojadigicom.capitalexterno.servico.base.CenarioServico;
...
public abstract class CenarioFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private Cenario item = null;
	
	protected CenarioServico srv = FabricaServico.getInstancia().getCenarioServico();
	
	protected Cenario getItem() {
		return item;
	}
	public void setItem(Cenario valor) {
		item = valor;
	}
    ...
    protected abstract void copiaTelaParaVo(Cenario item);
