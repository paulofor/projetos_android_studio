package br.com.lojadigicom.capitalexterno.modelo.montador;
...
import br.com.lojadigicom.capitalexterno.modelo.ItemCustoProdutoVo;
//import br.com.lojadigicom.capitalexterno.modelo.vo.FabricaVo;
import android.database.Cursor;
//import br.com.digicom.dao.MontadorDaoBase;
//import br.com.digicom.dao.MontadorDaoI;
//import br.com.digicom.modelo.DCIObjetoDominio;
//import br.com.digicom.modelo.ObjetoSinc;
import br.com.lojadigicom.capitalexterno.framework.modelo.ObjetoSinc;
...
public class ItemCustoProdutoMontador implements MontadorDaoI {

	private ItemCustoProduto principal = new ItemCustoProdutoVo();
	
	private boolean sinc = false;
	public ItemCustoProdutoMontador(boolean sinc) {
		this.sinc = sinc;
	}
	public ItemCustoProdutoMontador() {
		this.sinc = false;
	}
	...
	public DCIObjetoDominio getItem(Cursor c) {
		...
		//objeto = FabricaVo.criaItemCustoProduto();
		objeto = new ItemCustoProdutoVo();
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		ItemCustoProduto item = null;
		item = (ItemCustoProduto) entrada;
		item.setIdItemCustoProduto(getInt(c,pos++));
		item.setValor(getFloat(c,pos++));
		item.setDescricao(getString(c,pos++));
