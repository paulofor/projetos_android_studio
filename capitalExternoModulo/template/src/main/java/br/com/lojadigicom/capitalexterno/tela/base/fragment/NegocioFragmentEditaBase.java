...
import br.com.lojadigicom.capitalexterno.servico.base.NegocioServico;
...
public abstract class NegocioFragmentEditaBase extends Fragment{

	private Button btnOk = null;

	private Negocio item = null;
	
	protected NegocioServico srv = FabricaServico.getInstancia().getNegocioServico();
	
	protected Negocio getItem() {
		return item;
	}
	public void setItem(Negocio valor) {
		item = valor;
	}
    ...
    protected abstract void copiaTelaParaVo(Negocio item);
