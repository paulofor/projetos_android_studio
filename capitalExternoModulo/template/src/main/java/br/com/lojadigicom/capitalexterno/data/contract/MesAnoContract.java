...
import br.com.lojadigicom.capitalexterno.modelo.montador.MesAnoMontador;
...
public final class MesAnoContract implements BaseColumns {
	...
	public static final String PATH = "mes_ano";
    ...
    public static final String TABLE_NAME = "mes_ano";
    public static final String TABLE_NAME_SINC = "mes_ano_sinc";
    ...
    public static final String COLUNA_DATA_MES_ANO = "data_mes_ano";
    public static final int COL_DATA_MES_ANO = 1;
	...
	{
		return " mes_ano_sinc.id_mes_ano " 
		+ " ,mes_ano_sinc.data_mes_ano " 
		+ " ,mes_ano_sinc.descricao " 
		
		
		+ " ,mes_ano_sinc.operacao_sinc "
		;
	}
