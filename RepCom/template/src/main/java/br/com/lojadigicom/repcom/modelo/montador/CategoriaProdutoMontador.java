...
import br.com.lojadigicom.repcom.modelo.CategoriaProdutoVo;
...
public class CategoriaProdutoMontador implements MontadorDaoI {
	...
	private CategoriaProduto principal = new CategoriaProdutoVo();
	
	private boolean sinc = false;
	public CategoriaProdutoMontador(boolean sinc) {
		this.sinc = sinc;
	}
	public CategoriaProdutoMontador() {
		this.sinc = false;
	}
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		...
		item = (CategoriaProduto) entrada;
		item.setIdCategoriaProduto(getInt(c,pos++));
		...
		item.setIdCategoriaProdutoP(getInt(c,pos++));
