...
public class PagamentoFornecedorMontador implements MontadorDaoI {

	private PagamentoFornecedor principal = new PagamentoFornecedorVo();
	
	private boolean sinc = false;
	public PagamentoFornecedorMontador(boolean sinc) {
		this.sinc = sinc;
	}
	public PagamentoFornecedorMontador() {
		this.sinc = false;
	}
	...
	public DCIObjetoDominio getItem(Cursor c) {
		...
		//objeto = FabricaVo.criaPagamentoFornecedor();
		objeto = new PagamentoFornecedorVo();
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		...
		item = (PagamentoFornecedor) entrada;
		item.setIdPagamentoFornecedor(getInt(c,pos++));
