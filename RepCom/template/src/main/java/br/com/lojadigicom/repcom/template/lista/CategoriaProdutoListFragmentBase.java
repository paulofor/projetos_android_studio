...
public abstract class CategoriaProdutoListFragmentBase extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    public interface Callback {
        ...
        public void onItemSelected(int idItemLista, CategoriaProdutoListViewHolderBase vh);
    }
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = getListAdapter(getActivity(), new CategoriaProdutoListAdapterBase.CategoriaProdutoListAdapterOnClickHandler() {
            @Override
