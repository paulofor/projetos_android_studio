...
public class EstoqueMontador implements MontadorDaoI {

	private Estoque principal = new EstoqueVo();
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		Estoque item = null;
		item = (Estoque) entrada;
		item.setIdEstoque(getInt(c,pos++));
