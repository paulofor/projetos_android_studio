...
public class PedidoFornecedorMontador implements MontadorDaoI {

	private PedidoFornecedor principal = new PedidoFornecedorVo();
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		...
		item = (PedidoFornecedor) entrada;
		item.setIdPedidoFornecedor(getInt(c,pos++));
