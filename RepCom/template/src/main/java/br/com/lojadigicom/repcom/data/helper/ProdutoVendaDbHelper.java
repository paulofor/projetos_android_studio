...
public class ProdutoVendaDbHelper {
	...
	private static String getSqlChaveEstrangeira() {
		String saida = "";
		saida += " , FOREIGN KEY (" + ProdutoVendaContract.COLUNA_ID_PRODUTO_A + ") REFERENCES " + ProdutoVendaContract.TABLE_NAME + " (" + ProdutoContract.COLUNA_CHAVE + ") ";
		saida += " , FOREIGN KEY (" + ProdutoVendaContract.COLUNA_ID_VENDA_A + ") REFERENCES " + ProdutoVendaContract.TABLE_NAME + " (" + VendaContract.COLUNA_CHAVE + ") ";
		return saida;
	}
