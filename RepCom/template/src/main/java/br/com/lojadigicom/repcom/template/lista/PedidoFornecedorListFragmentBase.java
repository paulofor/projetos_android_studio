...
public abstract class PedidoFornecedorListFragmentBase extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    public interface Callback {
        ...
        public void onItemSelected(int idItemLista, PedidoFornecedorListViewHolderBase vh);
    }
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = getListAdapter(getActivity(), new PedidoFornecedorListAdapterBase.PedidoFornecedorListAdapterOnClickHandler() {
            @Override
