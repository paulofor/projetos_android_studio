...
public abstract class LinhaProdutoProvider {
	...
	public static final int LINHA_PRODUTO = 40200;
	public static final int LINHA_PRODUTO_ID = 40201;
	public static final int LINHA_PRODUTO_SINC = 40203;
	public static final int LINHA_PRODUTO_E_COMPLEMENTO = 40204;
	public static final int LINHA_PRODUTO_ID_E_COMPLEMENTO = 40205;
	//public static final int LINHA_PRODUTO_OPERACAO = 40202;
	
	// deletes
	public static final int LINHA_PRODUTO_DELETE_ALL_SINC = 40206;
	public static final int LINHA_PRODUTO_DELETE_RECREATE = 40207;
	public static final int LINHA_PRODUTO_DELETE_SINC = 40208;
	public static final int LINHA_PRODUTO_E_RETIRADA = 40209;
	...
	private String sqlWhere(Uri uri) {
		...
		if (existeItem("SemProdutoPossui",uri.getPathSegments())) {
			sql += LinhaProdutoContract.COLUNA_CHAVE + " not in (select " + 
					ProdutoContract.COLUNA_ID_LINHA_PRODUTO_EE + " from " +
