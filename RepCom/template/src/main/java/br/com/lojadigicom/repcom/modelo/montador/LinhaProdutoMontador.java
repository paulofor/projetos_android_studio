...
import br.com.lojadigicom.repcom.modelo.LinhaProdutoVo;
...
public class LinhaProdutoMontador implements MontadorDaoI {
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		...
		item.setCodigoLineId(getInt(c,pos++));
		item.setDataInclusao(this.getTimestampData(c,pos++));
