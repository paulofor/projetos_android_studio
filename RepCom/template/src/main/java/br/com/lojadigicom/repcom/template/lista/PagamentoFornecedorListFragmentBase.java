...
public abstract class PagamentoFornecedorListFragmentBase extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    public interface Callback {
        ...
        public void onItemSelected(int idItemLista, PagamentoFornecedorListViewHolderBase vh);
    }
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = getListAdapter(getActivity(), new PagamentoFornecedorListAdapterBase.PagamentoFornecedorListAdapterOnClickHandler() {
            @Override
