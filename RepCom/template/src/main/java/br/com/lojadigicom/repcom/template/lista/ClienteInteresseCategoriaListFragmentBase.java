...
public abstract class ClienteInteresseCategoriaListFragmentBase extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    public interface Callback {
        ...
        public void onItemSelected(int idItemLista, ClienteInteresseCategoriaListViewHolderBase vh);
    }
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = getListAdapter(getActivity(), new ClienteInteresseCategoriaListAdapterBase.ClienteInteresseCategoriaListAdapterOnClickHandler() {
            @Override
