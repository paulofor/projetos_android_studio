...
public class PrecoProdutoRemote {
    ...
    private ContentValues ContentValuesAtributos(JSONObject obj) throws JSONException {
		...
		valores.put(PrecoProdutoContract.COLUNA_DATA_INCLUSAO, UtilDatas.getDataLong(obj.getString("DataInclusao")));
		...
		valores.put(PrecoProdutoContract.COLUNA_DATA_EXCLUSAO, UtilDatas.getDataLong(obj.getString("DataExclusao")));
