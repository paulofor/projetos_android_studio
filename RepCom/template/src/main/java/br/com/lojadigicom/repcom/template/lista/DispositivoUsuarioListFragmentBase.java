...
public abstract class DispositivoUsuarioListFragmentBase extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    public interface Callback {
        ...
        public void onItemSelected(int idItemLista, DispositivoUsuarioListViewHolderBase vh);
    }
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = getListAdapter(getActivity(), new DispositivoUsuarioListAdapterBase.DispositivoUsuarioListAdapterOnClickHandler() {
            @Override
