...
public class CategoriaProdutoProdutoDbHelper {
	...
	private static String getSqlChaveEstrangeira() {
		String saida = "";
		saida += " , FOREIGN KEY (" + CategoriaProdutoProdutoContract.COLUNA_ID_CATEGORIA_PRODUTO_RA + ") REFERENCES " + CategoriaProdutoProdutoContract.TABLE_NAME + " (" + CategoriaProdutoContract.COLUNA_CHAVE + ") ";
		saida += " , FOREIGN KEY (" + CategoriaProdutoProdutoContract.COLUNA_ID_PRODUTO_RA + ") REFERENCES " + CategoriaProdutoProdutoContract.TABLE_NAME + " (" + ProdutoContract.COLUNA_CHAVE + ") ";
		return saida;
	}
