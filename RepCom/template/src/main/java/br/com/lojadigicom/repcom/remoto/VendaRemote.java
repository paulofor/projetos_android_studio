...
public class VendaRemote {
    ...
    private JSONObject JSonAtributos(Cursor c) throws JSONException {
        ...
        JSONObject json = new JSONObject();
			...
			json.put("VendaFechada",c.getString(VendaContract.COL_VENDA_FECHADA));
    ...
    private ContentValues ContentValuesAtributos(JSONObject obj) throws JSONException {
		...
		valores.put(VendaContract.COLUNA_DATA, UtilDatas.getDataLong(obj.getString("Data")));
		...
		valores.put(VendaContract.COLUNA_VENDA_FECHADA, valVenda);
