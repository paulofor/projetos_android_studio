...
public abstract class CategoriaProdutoProdutoListFragmentBase extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    public interface Callback {
        ...
        public void onItemSelected(int idItemLista, CategoriaProdutoProdutoListViewHolderBase vh);
    }
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = getListAdapter(getActivity(), new CategoriaProdutoProdutoListAdapterBase.CategoriaProdutoProdutoListAdapterOnClickHandler() {
            @Override
