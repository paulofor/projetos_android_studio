...
import br.com.lojadigicom.repcom.modelo.ContatoClienteVo;
...
public class ContatoClienteMontador implements MontadorDaoI {

	private ContatoCliente principal = new ContatoClienteVo();
	
	private boolean sinc = false;
	public ContatoClienteMontador(boolean sinc) {
		this.sinc = sinc;
	}
	public ContatoClienteMontador() {
		this.sinc = false;
	}
	...
	public DCIObjetoDominio getItem(Cursor c) {
		...
		//objeto = FabricaVo.criaContatoCliente();
		objeto = new ContatoClienteVo();
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		...
		item = (ContatoCliente) entrada;
		item.setIdContatoCliente(getInt(c,pos++));
		item.setDataContato(this.getTimestampData(c,pos++));
		item.setIdClienteRa(getInt(c,pos++));
