...
public abstract class ModeloProdutoProdutoListFragmentBase extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>{

    private RecyclerView mRecyclerView;
    private ModeloProdutoProdutoListAdapterBase mAdapter;
	...
	public abstract void onItemSelected(int idItemLista, ModeloProdutoProdutoListViewHolderBase vh);
	

    public ModeloProdutoProdutoListFragmentBase() {
    }
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = getListAdapter(this.getActivity(), new ModeloProdutoProdutoListAdapterBase.ModeloProdutoProdutoListAdapterOnClickHandler() {
            @Override
            public void onClick(int idItemLista, ModeloProdutoProdutoListViewHolderBase vh) {
    ...
    protected abstract ModeloProdutoProdutoListAdapterBase getListAdapter(FragmentActivity activity, ModeloProdutoProdutoListAdapterBase.ModeloProdutoProdutoListAdapterOnClickHandler onClickHandler, View emptyView, int mChoiceMode);

	/*
 	public void registraPosicao(ModeloProdutoProdutoListViewHolderBase vh) {
        SharedPreferences pref = getActivity().getSharedPreferences("br.com.lojadigicom.precomed", Context.MODE_PRIVATE);
        SharedPreferences.Editor edt = pref.edit();
        edt.putInt(Constantes.MODELO_PRODUTO_PRODUTO_POSICAO, vh.getAdapterPosition());
        edt.commit();
    }
    private void recuperaPosicao() {
        SharedPreferences pref = getActivity().getSharedPreferences("br.com.lojadigicom.precomed", Context.MODE_PRIVATE);
        mPosition = pref.getInt(Constantes.MODELO_PRODUTO_PRODUTO_POSICAO,RecyclerView.NO_POSITION);
    }
	*/
    ...
    public final void onLoadFinished(Loader<Cursor> loader, Cursor data) {
    	List<ModeloProdutoProduto> lista = converteLista(data);
    	DCLog.d(DCLog.OPERACAO_DB_TELA,this,"Lista ModeloProdutoProduto " + lista.size() + " itens");
	...
	protected MontadorDaoI getMontador() {
        return ModeloProdutoProdutoContract.getMontador();
    }

    protected final List<ModeloProdutoProduto> converteLista(Cursor data) {
	...
	protected long mIdModeloProduto;
	public final void setIdModeloProduto(long id) {
		mIdModeloProduto = id;
	}
