...
import br.com.lojadigicom.precomed.modelo.ModeloProdutoVo;
...
public class ModeloProdutoMontador implements MontadorDaoI {
	...
	private ModeloProduto principal = new ModeloProdutoVo();
	...
	public DCIObjetoDominio getItem(Cursor c, DCIObjetoDominio entrada, int pos) {
		...
		item = (ModeloProduto) entrada;
		item.setIdModeloProduto(getInt(c,pos++));
