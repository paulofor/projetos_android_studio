...
package  br.com.lojadigicom.precomed.sync;
...
import br.com.lojadigicom.precomed.template.*;
import br.com.lojadigicom.precomed.remoto.*;
...
public abstract class AplicacaoSyncAdapter extends AbstractThreadedSyncAdapter{
	...
	protected void sincronizaProdutoPesquisa(Context contexto, boolean forcaAtualizacao, boolean delete) {
		ProdutoPesquisaSincronismo sincSrv = new ProdutoPesquisaSincronismo();
		
    	sincSrv.sincroniza(getContext(),true, delete);
    	
	}
	
	protected void sincronizaModeloProduto(Context contexto, boolean forcaAtualizacao, boolean delete) {
		ModeloProdutoSincronismo sincSrv = new ModeloProdutoSincronismo();
		
    	sincSrv.sincroniza(getContext(),true, delete);
    	
	}
	
	protected void sincronizaModeloProdutoProduto(Context contexto, boolean forcaAtualizacao, boolean delete) {
		ModeloProdutoProdutoSincronismo sincSrv = new ModeloProdutoProdutoSincronismo();
		
    	sincSrv.sincroniza(getContext(),true, delete);
    	
	}
	
	protected void sincronizaMarca(Context contexto, boolean forcaAtualizacao, boolean delete) {
		MarcaSincronismo sincSrv = new MarcaSincronismo();
		
    	sincSrv.sincroniza(getContext(),true, delete);
    	
	}
	
	protected void sincronizaLojaVirtual(Context contexto, boolean forcaAtualizacao, boolean delete) {
		LojaVirtualSincronismo sincSrv = new LojaVirtualSincronismo();
