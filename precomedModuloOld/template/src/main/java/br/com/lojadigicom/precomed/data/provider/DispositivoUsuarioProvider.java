...
public abstract class DispositivoUsuarioProvider {
	...
	public static final int DISPOSITIVO_USUARIO = 78500;
	public static final int DISPOSITIVO_USUARIO_ID = 78501;
	public static final int DISPOSITIVO_USUARIO_SINC = 78503;
	public static final int DISPOSITIVO_USUARIO_E_COMPLEMENTO = 78504;
	public static final int DISPOSITIVO_USUARIO_ID_E_COMPLEMENTO = 78505;
	//public static final int DISPOSITIVO_USUARIO_OPERACAO = 78502;
	
	// deletes
	public static final int DISPOSITIVO_USUARIO_DELETE_ALL_SINC = 78506;
	public static final int DISPOSITIVO_USUARIO_DELETE_RECREATE = 78507;
	public static final int DISPOSITIVO_USUARIO_DELETE_SINC = 78508;
	public static final int DISPOSITIVO_USUARIO_E_RETIRADA = 78509;
	
	private static final String sPorChaveSel = DispositivoUsuarioContract.TABLE_NAME + "." + DispositivoUsuarioContract.COLUNA_CHAVE + " = ? ";
	
	
	
	public static final int DISPOSITIVO_USUARIO_POR_USUARIO_REFERENTEA = 78520;
	public static final int COM_USUARIO = 78521;
