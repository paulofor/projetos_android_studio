...
public class ModeloProdutoProdutoRemote {
    ...
    public int listaSincronizadaDao(Context contexto, boolean delete) throws JSONException {
        ...
        try {
            ...
            if (delete) {
                contexto.getContentResolver().delete(ModeloProdutoProdutoContract.buildDeleteAllRecreate(), null, null);
            }
            contexto.getContentResolver().bulkInsert(ModeloProdutoProdutoContract.getContentUri(), vetor);
    ...
    private JSONObject JSonAtributos(Cursor c) throws JSONException {
        ...
        JSONObject json = new JSONObject();
        	json.put("IdModeloProdutoProduto",c.getString(ModeloProdutoProdutoContract.COL_ID_MODELO_PRODUTO_PRODUTO));
			json.put("IdModeloProdutoRa",c.getString(ModeloProdutoProdutoContract.COL_ID_MODELO_PRODUTO_RA));
			json.put("IdProdutoRa",c.getString(ModeloProdutoProdutoContract.COL_ID_PRODUTO_RA));
		
        return json;
    }
     private JSONObject JSonAtributosSinc(Cursor c) throws JSONException {
        JSONObject json = JSonAtributos(c);
        json.put("OperacaoSinc",c.getString(ModeloProdutoProdutoContract.COL_OPERACAO_SINC));
        return json;
    }
    ...
    private ContentValues ContentValuesAtributos(JSONObject obj) throws JSONException {
		...
		valores.put(ModeloProdutoProdutoContract.COLUNA_ID_MODELO_PRODUTO_PRODUTO, obj.getString("IdModeloProdutoProduto"));
		
		valores.put(ModeloProdutoProdutoContract.COLUNA_ID_MODELO_PRODUTO_RA, obj.getString("IdModeloProdutoRa"));
		
		valores.put(ModeloProdutoProdutoContract.COLUNA_ID_PRODUTO_RA, obj.getString("IdProdutoRa"));
