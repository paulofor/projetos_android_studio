...
public class DispositivoUsuarioRemote {
    ...
    private ContentValues ContentValuesAtributos(JSONObject obj) throws JSONException {
		...
		valores.put(DispositivoUsuarioContract.COLUNA_DATA_CRIACAO, UtilDatas.getDataHoraLong(obj.getString("DataCriacao")));
		
		valores.put(DispositivoUsuarioContract.COLUNA_DATA_ULTIMO_ACESSO, UtilDatas.getDataHoraLong(obj.getString("DataUltimoAcesso")));
