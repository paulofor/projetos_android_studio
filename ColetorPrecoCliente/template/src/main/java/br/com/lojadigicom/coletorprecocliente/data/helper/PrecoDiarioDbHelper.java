...
public class PrecoDiarioDbHelper {

	protected static String getSqlChavesEstrangeiras() {
		return  "ALTER TABLE " +
        PrecoDiarioContract.TABLE_NAME + " " +
        ";";
	}
	...
	protected static String getSqlCreate(){
        ...
        + PrecoDiarioContract.TABLE_NAME + " (" +
        PrecoDiarioContract.COLUNA_CHAVE + " INTEGER PRIMARY KEY " 
	...
	protected static String getSqlCreateSinc(){
		return  "CREATE TABLE IF NOT EXISTS "
        + PrecoDiarioContract.TABLE_NAME_SINC + " (" +
        PrecoDiarioContract.COLUNA_CHAVE + " INTEGER " 
        + ", operacao_sinc TEXT);";
	}
	...
	public static String getSqlDrop() {
		return "DROP TABLE IF EXISTS " + PrecoDiarioContract.TABLE_NAME;
	}
	public static String getSqlDropSinc() {
		return "DROP TABLE IF EXISTS " + PrecoDiarioContract.TABLE_NAME_SINC;
	}
