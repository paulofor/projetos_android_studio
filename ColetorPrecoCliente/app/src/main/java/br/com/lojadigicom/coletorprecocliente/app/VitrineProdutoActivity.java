...
import br.com.lojadigicom.coletorprecocliente.wrapper.CardViewWrapper;

public class VitrineProdutoActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected ResourceObj getLayoutDetalheResource() {
        return new ResourceObj(R.layout.activity_vitrine_produto,"R.layout.activity_vitrine_produto");
    }
    @Override
...
/**/
 ...
 /*       Glide.with(this)
    ...
    protected void complementaOnCreate() {
        ...
        imgProduto1 = (ImageView) this.findViewById(R.id.imgProduto1);
        rtbInteresse1 = (RatingBar) this.findViewById(R.id.rtbInteresse1);
        txtNomeProdutoVitrine1 = (TextView) this.findViewById(R.id.txtNomeProdutoVitrine1);
        txtPrecoProdutoVitrine1 = (TextView) this.findViewById(R.id.txtPrecoProdutoVitrine1);
        txtDescricaoNota1 = (TextView) this.findViewById(R.id.txtDescricaoNota1);
        btnOk1 = (FloatingActionButton) this.findViewById(R.id.btnOk1);
        ...
        txtDescNota1_1 = (TextView) this.findViewById(R.id.txtDescNota1_1);
        txtDescNota1_2 = (TextView) this.findViewById(R.id.txtDescNota1_2);
        txtDescNota1_3 = (TextView) this.findViewById(R.id.txtDescNota1_3);
        txtDescNota1_4 = (TextView) this.findViewById(R.id.txtDescNota1_4);
        txtDescNota1_5 = (TextView) this.findViewById(R.id.txtDescNota1_5);

        // Card 2
        card_view2 = (CardView) this.findViewById(R.id.card_view2) ;
        imgProduto2 = (ImageView) this.findViewById(R.id.imgProduto2);
        rtbInteresse2 = (RatingBar) this.findViewById(R.id.rtbInteresse2);
        txtNomeProdutoVitrine2 = (TextView) this.findViewById(R.id.txtNomeProdutoVitrine2);
        txtPrecoProdutoVitrine2 = (TextView) this.findViewById(R.id.txtPrecoProdutoVitrine2);
        txtDescricaoNota2 = (TextView) this.findViewById(R.id.txtDescricaoNota2);
        btnOk2 = (FloatingActionButton) this.findViewById(R.id.btnOk2);
        ...
        txtDescNota2_1 = (TextView) this.findViewById(R.id.txtDescNota2_1);
        txtDescNota2_2 = (TextView) this.findViewById(R.id.txtDescNota2_2);
        txtDescNota2_3 = (TextView) this.findViewById(R.id.txtDescNota2_3);
        txtDescNota2_4 = (TextView) this.findViewById(R.id.txtDescNota2_4);
        txtDescNota2_5 = (TextView) this.findViewById(R.id.txtDescNota2_5);
